<form action="<?php bp_messages_form_action('compose'); ?>" method="post" id="send_message_form" class="standard-form" role="main" enctype="multipart/form-data">
	...
	<?php if ( bp_current_user_can( 'bp_moderate' ) ) : ?>
		<input type="checkbox" id="send-notice" name="send-notice" value="1" /> <?php _e( "This is a notice to all users.", "buddyboss" ); ?>
	<?php endif; ?>
	...
	<div class="submit">
		<input type="submit" value="<?php esc_attr_e( "Send Message", 'buddyboss' ); ?>" name="send" id="send" />
	</div>
