...
get_header( 'buddypress' ); ?>
	...
	<div id="content">
		...
		<form action="" method="post" id="blogs-directory-form" class="dir-form">
			...
			<h3><?php _e( 'Site Directory', 'buddyboss' ); ?><?php if ( is_user_logged_in() && bp_blog_signup_enabled() ) : ?> &nbsp;<a class="button" href="<?php echo bp_get_root_domain() . '/' . bp_get_blogs_root_slug() . '/create/' ?>"><?php _e( 'Create a Site', 'buddyboss' ); ?></a><?php endif; ?></h3>
