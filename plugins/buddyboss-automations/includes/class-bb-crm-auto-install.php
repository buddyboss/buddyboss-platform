...
class BB_CRM_Auto_Install {
	...
	/**
	 * Rename legacy bp_crm_ automation tables to bb_crm_ naming convention.
	 *
	 * @since 1.3.0
	 */
	private static function migrate_table_names() {
		...
		$renames = array(
			'bp_crm_automations'      => 'bb_crm_automations',
			'bp_crm_automation_log'   => 'bb_crm_automation_log',
			'bp_crm_automation_queue' => 'bb_crm_automation_queue',
			'bp_crm_email_opens'      => 'bb_crm_email_opens',
		);
	...
	public static function install() {
		...
		// Automations table.
		dbDelta( "CREATE TABLE {$bb_prefix}bb_crm_automations (
		...
		dbDelta( "CREATE TABLE {$bb_prefix}bb_crm_automation_log (
			id bigint(20) NOT NULL AUTO_INCREMENT,
		...
		dbDelta( "CREATE TABLE {$bb_prefix}bb_crm_automation_queue (
			id bigint(20) NOT NULL AUTO_INCREMENT,
			automation_id bigint(20) NOT NULL,
		...
		dbDelta( "CREATE TABLE {$bb_prefix}bb_crm_email_opens (
			id bigint(20) NOT NULL AUTO_INCREMENT,
			user_id bigint(20) NOT NULL,
