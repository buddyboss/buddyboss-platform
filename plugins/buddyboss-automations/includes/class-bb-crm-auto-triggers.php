...
class BB_CRM_Auto_Triggers {
	...
	public static function get_categories() {
		return array(
			'user'         => array(
				'label' => __( 'User & Member', 'buddyboss-automations' ),
				'icon'  => 'admin-users',
				'color' => '#2271b1',
				'desc'  => __( 'Registration, login, roles and profile activity.', 'buddyboss-automations' ),
			),
			'group'        => array(
				'label' => __( 'Groups', 'buddyboss-automations' ),
				'icon'  => 'networking',
				'color' => '#00a0d2',
				'desc'  => __( 'Joining, leaving, roles and group content.', 'buddyboss-automations' ),
			),
			'activity'     => array(
				'label' => __( 'Activity', 'buddyboss-automations' ),
				'icon'  => 'activity',
				'color' => '#f56e28',
				'desc'  => __( 'Posts, comments, likes, reactions and media.', 'buddyboss-automations' ),
			),
			'gamification' => array(
				'label' => __( 'Courses & Gamification', 'buddyboss-automations' ),
				'icon'  => 'awards',
				'color' => '#9b59b6',
				'desc'  => __( 'LearnDash courses, GamiPress points and memberships.', 'buddyboss-automations' ),
			),
			'profile'      => array(
				'label' => __( 'Profile & Social', 'buddyboss-automations' ),
				'icon'  => 'id-alt',
				'color' => '#27ae60',
				'desc'  => __( 'Profile fields, follows, friendships and moderation.', 'buddyboss-automations' ),
			),
			'tag'          => array(
				'label' => __( 'Tags, Lists & CRM', 'buddyboss-automations' ),
				'icon'  => 'tag',
				'color' => '#c0392b',
				'desc'  => __( 'CRM tags, lists, email invites and forum events.', 'buddyboss-automations' ),
			),
		);
	}
