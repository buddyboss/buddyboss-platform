...
class BB_CRM_Tag_Triggers {
	...
	public static function init() {
		...
		BB_CRM_Auto_Triggers::register( 'crm_tag_added', array(
			'label'    => __( 'Tag Added to User', 'buddyboss-automations' ),
			'category' => 'tag',
		) );
		BB_CRM_Auto_Triggers::register( 'crm_tag_added_specific', array(
			'label'    => __( 'Specific Tag Added to User', 'buddyboss-automations' ),
			'category' => 'tag',
			'fields'   => array( 'tag_id' => __( 'Tag', 'buddyboss-automations' ) ),
		) );
		BB_CRM_Auto_Triggers::register( 'crm_tag_removed', array(
			'label'    => __( 'Tag Removed from User', 'buddyboss-automations' ),
			'category' => 'tag',
		) );
		BB_CRM_Auto_Triggers::register( 'crm_tag_removed_specific', array(
			'label'    => __( 'Specific Tag Removed from User', 'buddyboss-automations' ),
			'category' => 'tag',
			'fields'   => array( 'tag_id' => __( 'Tag', 'buddyboss-automations' ) ),
		) );
		BB_CRM_Auto_Triggers::register( 'crm_tag_expired', array(
			'label'    => __( 'User Tag Expires', 'buddyboss-automations' ),
			'category' => 'tag',
		) );
		BB_CRM_Auto_Triggers::register( 'crm_list_added', array(
			'label'    => __( 'User Added to a List', 'buddyboss-automations' ),
			'category' => 'tag',
		) );
		BB_CRM_Auto_Triggers::register( 'crm_list_removed', array(
			'label'    => __( 'User Removed from a List', 'buddyboss-automations' ),
			'category' => 'tag',
		) );
		BB_CRM_Auto_Triggers::register( 'crm_multiple_tags', array(
			'label'    => __( 'User Has Multiple Specific Tags', 'buddyboss-automations' ),
			'category' => 'tag',
		) );
		BB_CRM_Auto_Triggers::register( 'crm_tag_count_reached', array(
			'label'    => __( 'User Reaches Tag Count', 'buddyboss-automations' ),
			'category' => 'tag',
			'fields'   => array( 'count' => __( 'Tag count', 'buddyboss-automations' ) ),
		) );
		BB_CRM_Auto_Triggers::register( 'crm_engagement_score', array(
			'label'    => __( 'User Engagement Score Changes', 'buddyboss-automations' ),
			'category' => 'tag',
		) );

		// ── Email Invite Triggers ───────────────────────────────────────────
		BB_CRM_Auto_Triggers::register( 'email_invite_sent', array(
			'label'    => __( 'User Sends an Email Invite', 'buddyboss-automations' ),
			'category' => 'tag',
		) );
		BB_CRM_Auto_Triggers::register( 'email_invite_accepted', array(
			'label'    => __( 'Email Invite is Accepted (Invitee Registers)', 'buddyboss-automations' ),
			'category' => 'tag',
		) );

		// ── Forum / bbPress Triggers ────────────────────────────────────────
		BB_CRM_Auto_Triggers::register( 'forum_topic_created', array(
			'label'    => __( 'User Creates a Forum Topic', 'buddyboss-automations' ),
			'category' => 'tag',
		) );
		BB_CRM_Auto_Triggers::register( 'forum_reply_posted', array(
			'label'    => __( 'User Replies to a Forum Topic', 'buddyboss-automations' ),
			'category' => 'tag',
		) );
		BB_CRM_Auto_Triggers::register( 'forum_topic_subscribed', array(
			'label'    => __( 'User Subscribes to a Forum Topic', 'buddyboss-automations' ),
			'category' => 'tag',
		) );
		BB_CRM_Auto_Triggers::register( 'forum_first_post', array(
			'label'    => __( 'User Makes Their First Forum Post', 'buddyboss-automations' ),
			'category' => 'tag',
		) );
		BB_CRM_Auto_Triggers::register( 'forum_topic_closed', array(
			'label'    => __( 'Forum Topic Closed', 'buddyboss-automations' ),
			'category' => 'tag',
		) );
		BB_CRM_Auto_Triggers::register( 'forum_topic_marked_solved', array(
			'label'    => __( 'Forum Topic Marked as Solved', 'buddyboss-automations' ),
			'category' => 'tag',
		) );
