...
class BB_CRM_Activity_Triggers {
	...
	public static function init() {
		BB_CRM_Auto_Triggers::register( 'activity_posted', array(
			'label'    => __( 'User Posts an Activity Update', 'buddyboss-automations' ),
			'category' => 'activity',
		) );
		BB_CRM_Auto_Triggers::register( 'activity_comment_posted', array(
			'label'    => __( 'User Comments on Activity', 'buddyboss-automations' ),
			'category' => 'activity',
		) );
		BB_CRM_Auto_Triggers::register( 'activity_liked', array(
			'label'    => __( 'User Likes an Activity', 'buddyboss-automations' ),
			'category' => 'activity',
		) );
		BB_CRM_Auto_Triggers::register( 'activity_mentioned', array(
			'label'    => __( 'User is Mentioned in Activity', 'buddyboss-automations' ),
			'category' => 'activity',
		) );
		BB_CRM_Auto_Triggers::register( 'activity_reaction_added', array(
			'label'    => __( 'User Reacts to Activity', 'buddyboss-automations' ),
			'category' => 'activity',
		) );
		BB_CRM_Auto_Triggers::register( 'activity_first_post', array(
			'label'    => __( 'User Creates Their First Post', 'buddyboss-automations' ),
			'category' => 'activity',
		) );
		BB_CRM_Auto_Triggers::register( 'activity_post_count', array(
			'label'    => __( 'User Reaches Post Milestone', 'buddyboss-automations' ),
			'category' => 'activity',
			'fields'   => array( 'count' => __( 'Number of posts', 'buddyboss-automations' ) ),
		) );
		BB_CRM_Auto_Triggers::register( 'activity_media_uploaded', array(
			'label'    => __( 'User Uploads Media', 'buddyboss-automations' ),
			'category' => 'activity',
		) );
		BB_CRM_Auto_Triggers::register( 'activity_video_uploaded', array(
			'label'    => __( 'User Uploads Video', 'buddyboss-automations' ),
			'category' => 'activity',
		) );
		BB_CRM_Auto_Triggers::register( 'activity_document_uploaded', array(
			'label'    => __( 'User Uploads Document', 'buddyboss-automations' ),
			'category' => 'activity',
		) );
		BB_CRM_Auto_Triggers::register( 'activity_deleted', array(
			'label'    => __( 'User Deletes an Activity Post', 'buddyboss-automations' ),
			'category' => 'activity',
		) );
		BB_CRM_Auto_Triggers::register( 'activity_pinned', array(
			'label'    => __( 'Activity is Pinned', 'buddyboss-automations' ),
			'category' => 'activity',
		) );
		BB_CRM_Auto_Triggers::register( 'activity_shared', array(
			'label'    => __( 'User Shares an Activity', 'buddyboss-automations' ),
			'category' => 'activity',
		) );
		BB_CRM_Auto_Triggers::register( 'activity_reported', array(
			'label'    => __( 'Activity is Reported', 'buddyboss-automations' ),
			'category' => 'activity',
		) );
		BB_CRM_Auto_Triggers::register( 'activity_poll_voted', array(
			'label'    => __( 'User Votes in a Poll', 'buddyboss-automations' ),
			'category' => 'activity',
		) );
