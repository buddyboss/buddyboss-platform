...
class BB_CRM_Gamification_Triggers {
	...
	public static function init() {
		...
		BB_CRM_Auto_Triggers::register( 'points_earned', array(
			'label'    => __( 'User Earns Points', 'buddyboss-automations' ),
			'category' => 'gamification',
			'fields'   => array( 'points_type' => __( 'Points Type', 'buddyboss-automations' ) ),
		) );
		BB_CRM_Auto_Triggers::register( 'points_threshold', array(
			'label'    => __( 'User Reaches Points Threshold', 'buddyboss-automations' ),
			'category' => 'gamification',
			'fields'   => array( 'threshold' => __( 'Points amount', 'buddyboss-automations' ) ),
		) );
		BB_CRM_Auto_Triggers::register( 'badge_awarded', array(
			'label'    => __( 'User Earns a Badge', 'buddyboss-automations' ),
			'category' => 'gamification',
		) );
		BB_CRM_Auto_Triggers::register( 'badge_awarded_specific', array(
			'label'    => __( 'User Earns a Specific Badge', 'buddyboss-automations' ),
			'category' => 'gamification',
			'fields'   => array( 'badge_id' => __( 'Badge', 'buddyboss-automations' ) ),
		) );
		BB_CRM_Auto_Triggers::register( 'rank_achieved', array(
			'label'    => __( 'User Achieves a Rank', 'buddyboss-automations' ),
			'category' => 'gamification',
		) );
		BB_CRM_Auto_Triggers::register( 'rank_achieved_specific', array(
			'label'    => __( 'User Achieves a Specific Rank', 'buddyboss-automations' ),
			'category' => 'gamification',
			'fields'   => array( 'rank_id' => __( 'Rank', 'buddyboss-automations' ) ),
		) );
		BB_CRM_Auto_Triggers::register( 'achievement_unlocked', array(
			'label'    => __( 'User Unlocks an Achievement', 'buddyboss-automations' ),
			'category' => 'gamification',
		) );

		// ── LearnDash / Courses ──────────────────────────────────────────────
		BB_CRM_Auto_Triggers::register( 'course_enrolled', array(
			'label'    => __( 'User Enrolls in a Course', 'buddyboss-automations' ),
			'category' => 'gamification',
		) );
		BB_CRM_Auto_Triggers::register( 'course_enrolled_specific', array(
			'label'    => __( 'User Enrolls in a Specific Course', 'buddyboss-automations' ),
			'category' => 'gamification',
			'fields'   => array( 'course_id' => __( 'Course', 'buddyboss-automations' ) ),
		) );
		BB_CRM_Auto_Triggers::register( 'course_completed', array(
			'label'    => __( 'User Completes a Course', 'buddyboss-automations' ),
			'category' => 'gamification',
		) );
		BB_CRM_Auto_Triggers::register( 'course_completed_specific', array(
			'label'    => __( 'User Completes a Specific Course', 'buddyboss-automations' ),
			'category' => 'gamification',
			'fields'   => array( 'course_id' => __( 'Course', 'buddyboss-automations' ) ),
		) );
		BB_CRM_Auto_Triggers::register( 'lesson_completed', array(
			'label'    => __( 'User Completes a Lesson', 'buddyboss-automations' ),
			'category' => 'gamification',
		) );
		BB_CRM_Auto_Triggers::register( 'quiz_passed', array(
			'label'    => __( 'User Passes a Quiz', 'buddyboss-automations' ),
			'category' => 'gamification',
		) );
		BB_CRM_Auto_Triggers::register( 'quiz_failed', array(
			'label'    => __( 'User Fails a Quiz', 'buddyboss-automations' ),
			'category' => 'gamification',
		) );
		BB_CRM_Auto_Triggers::register( 'assignment_submitted', array(
			'label'    => __( 'User Submits an Assignment', 'buddyboss-automations' ),
			'category' => 'gamification',
		) );
		BB_CRM_Auto_Triggers::register( 'certificate_earned', array(
			'label'    => __( 'User Earns a Certificate', 'buddyboss-automations' ),
			'category' => 'gamification',
		) );
		BB_CRM_Auto_Triggers::register( 'course_progress_percent', array(
			'label'    => __( 'User Reaches Course Progress %', 'buddyboss-automations' ),
			'category' => 'gamification',
			'fields'   => array( 'percent' => __( 'Progress %', 'buddyboss-automations' ) ),
		) );

		// ── Memberships ──────────────────────────────────────────────────────
		BB_CRM_Auto_Triggers::register( 'membership_started', array(
			'label'    => __( 'User Starts a Membership', 'buddyboss-automations' ),
			'category' => 'gamification',
		) );
		BB_CRM_Auto_Triggers::register( 'membership_started_specific', array(
			'label'    => __( 'User Starts a Specific Membership', 'buddyboss-automations' ),
			'category' => 'gamification',
			'fields'   => array( 'membership_id' => __( 'Membership', 'buddyboss-automations' ) ),
		) );
		BB_CRM_Auto_Triggers::register( 'membership_cancelled', array(
			'label'    => __( 'User Cancels Membership', 'buddyboss-automations' ),
			'category' => 'gamification',
		) );
		BB_CRM_Auto_Triggers::register( 'membership_expired', array(
			'label'    => __( 'Membership Expires', 'buddyboss-automations' ),
			'category' => 'gamification',
		) );
		BB_CRM_Auto_Triggers::register( 'membership_renewed', array(
			'label'    => __( 'User Renews Membership', 'buddyboss-automations' ),
			'category' => 'gamification',
		) );
		BB_CRM_Auto_Triggers::register( 'membership_upgraded', array(
			'label'    => __( 'User Upgrades Membership Level', 'buddyboss-automations' ),
			'category' => 'gamification',
		) );
		BB_CRM_Auto_Triggers::register( 'membership_downgraded', array(
			'label'    => __( 'User Downgrades Membership Level', 'buddyboss-automations' ),
			'category' => 'gamification',
		) );
