...
class BB_CRM_Group_Triggers {
	...
	public static function init() {
		BB_CRM_Auto_Triggers::register( 'group_joined', array(
			'label'    => __( 'User Joins a Group', 'buddyboss-crm-automations' ),
			'category' => 'group',
		) );
		BB_CRM_Auto_Triggers::register( 'group_joined_specific', array(
			'label'    => __( 'User Joins a Specific Group', 'buddyboss-crm-automations' ),
			'category' => 'group',
			'fields'   => array( 'group_id' => __( 'Group', 'buddyboss-crm-automations' ) ),
		) );
		BB_CRM_Auto_Triggers::register( 'group_left', array(
			'label'    => __( 'User Leaves a Group', 'buddyboss-crm-automations' ),
			'category' => 'group',
		) );
		BB_CRM_Auto_Triggers::register( 'group_left_specific', array(
			'label'    => __( 'User Leaves a Specific Group', 'buddyboss-crm-automations' ),
			'category' => 'group',
			'fields'   => array( 'group_id' => __( 'Group', 'buddyboss-crm-automations' ) ),
		) );
		BB_CRM_Auto_Triggers::register( 'group_invite_sent', array(
			'label'    => __( 'User Sends Group Invite', 'buddyboss-crm-automations' ),
			'category' => 'group',
		) );
		BB_CRM_Auto_Triggers::register( 'group_invite_accepted', array(
			'label'    => __( 'User Accepts Group Invite', 'buddyboss-crm-automations' ),
			'category' => 'group',
		) );
		BB_CRM_Auto_Triggers::register( 'group_invite_rejected', array(
			'label'    => __( 'User Rejects Group Invite', 'buddyboss-crm-automations' ),
			'category' => 'group',
		) );
		BB_CRM_Auto_Triggers::register( 'group_request_sent', array(
			'label'    => __( 'User Requests to Join Group', 'buddyboss-crm-automations' ),
			'category' => 'group',
		) );
		BB_CRM_Auto_Triggers::register( 'group_request_approved', array(
			'label'    => __( 'Join Request Approved', 'buddyboss-crm-automations' ),
			'category' => 'group',
		) );
		BB_CRM_Auto_Triggers::register( 'group_request_rejected', array(
			'label'    => __( 'Join Request Rejected', 'buddyboss-crm-automations' ),
			'category' => 'group',
		) );
		BB_CRM_Auto_Triggers::register( 'group_role_promoted', array(
			'label'    => __( 'User Promoted to Group Mod/Admin', 'buddyboss-crm-automations' ),
			'category' => 'group',
		) );
		BB_CRM_Auto_Triggers::register( 'group_role_demoted', array(
			'label'    => __( 'User Demoted in Group', 'buddyboss-crm-automations' ),
			'category' => 'group',
		) );
		BB_CRM_Auto_Triggers::register( 'group_banned', array(
			'label'    => __( 'User Banned from Group', 'buddyboss-crm-automations' ),
			'category' => 'group',
		) );
		BB_CRM_Auto_Triggers::register( 'group_unbanned', array(
			'label'    => __( 'User Unbanned from Group', 'buddyboss-crm-automations' ),
			'category' => 'group',
		) );
		BB_CRM_Auto_Triggers::register( 'group_created', array(
			'label'    => __( 'User Creates a Group', 'buddyboss-crm-automations' ),
			'category' => 'group',
		) );
		BB_CRM_Auto_Triggers::register( 'group_post_created', array(
			'label'    => __( 'User Posts in a Group', 'buddyboss-crm-automations' ),
			'category' => 'group',
		) );
		BB_CRM_Auto_Triggers::register( 'group_post_commented', array(
			'label'    => __( 'User Comments on Group Post', 'buddyboss-crm-automations' ),
			'category' => 'group',
		) );
		BB_CRM_Auto_Triggers::register( 'group_media_uploaded', array(
			'label'    => __( 'User Uploads Media to Group', 'buddyboss-crm-automations' ),
			'category' => 'group',
		) );
		BB_CRM_Auto_Triggers::register( 'group_document_uploaded', array(
			'label'    => __( 'User Uploads Document to Group', 'buddyboss-crm-automations' ),
			'category' => 'group',
		) );
		BB_CRM_Auto_Triggers::register( 'group_first_join', array(
			'label'    => __( 'User Joins Their First Group', 'buddyboss-crm-automations' ),
			'category' => 'group',
		) );
