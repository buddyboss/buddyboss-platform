...
class BB_CRM_Profile_Triggers {
	...
	public static function init() {
		BB_CRM_Auto_Triggers::register( 'profile_field_updated', array(
			'label'    => __( 'Profile Field Updated', 'buddyboss-crm-automations' ),
			'category' => 'profile',
			'fields'   => array( 'field_name' => __( 'Field Name', 'buddyboss-crm-automations' ) ),
		) );
		BB_CRM_Auto_Triggers::register( 'profile_type_changed', array(
			'label'    => __( 'Profile Type Changed', 'buddyboss-crm-automations' ),
			'category' => 'profile',
		) );
		BB_CRM_Auto_Triggers::register( 'profile_type_assigned', array(
			'label'    => __( 'User Assigned a Specific Profile Type', 'buddyboss-crm-automations' ),
			'category' => 'profile',
			'fields'   => array( 'profile_type' => __( 'Profile Type', 'buddyboss-crm-automations' ) ),
		) );
		BB_CRM_Auto_Triggers::register( 'friend_request_sent', array(
			'label'    => __( 'User Sends a Friend Request', 'buddyboss-crm-automations' ),
			'category' => 'profile',
		) );
		BB_CRM_Auto_Triggers::register( 'friend_request_accepted', array(
			'label'    => __( 'User Accepts a Friend Request', 'buddyboss-crm-automations' ),
			'category' => 'profile',
		) );
		BB_CRM_Auto_Triggers::register( 'friendship_removed', array(
			'label'    => __( 'User Removes a Friend', 'buddyboss-crm-automations' ),
			'category' => 'profile',
		) );
		BB_CRM_Auto_Triggers::register( 'message_sent', array(
			'label'    => __( 'User Sends a Private Message', 'buddyboss-crm-automations' ),
			'category' => 'profile',
		) );
		BB_CRM_Auto_Triggers::register( 'user_followed', array(
			'label'    => __( 'User Follows Another User', 'buddyboss-crm-automations' ),
			'category' => 'profile',
		) );
		BB_CRM_Auto_Triggers::register( 'user_unfollowed', array(
			'label'    => __( 'User Unfollows Another User', 'buddyboss-crm-automations' ),
			'category' => 'profile',
		) );
		BB_CRM_Auto_Triggers::register( 'notification_received', array(
			'label'    => __( 'User Receives a Notification', 'buddyboss-crm-automations' ),
			'category' => 'profile',
		) );
		BB_CRM_Auto_Triggers::register( 'profile_visibility_changed', array(
			'label'    => __( 'Profile Visibility Changed', 'buddyboss-crm-automations' ),
			'category' => 'profile',
		) );
		BB_CRM_Auto_Triggers::register( 'user_suspended', array(
			'label'    => __( 'User Account Suspended', 'buddyboss-crm-automations' ),
			'category' => 'profile',
		) );
