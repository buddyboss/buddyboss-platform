...
class BB_CRM_User_Triggers {
	...
	public static function init() {
		...
		BB_CRM_Auto_Triggers::register( 'user_registered', array(
			'label'       => __( 'User Registers', 'buddyboss-crm-automations' ),
			'category'    => 'user',
			'description' => __( 'Fires when a new user registers on the site.', 'buddyboss-crm-automations' ),
		) );
		BB_CRM_Auto_Triggers::register( 'user_login', array(
			'label'    => __( 'User Logs In', 'buddyboss-crm-automations' ),
			'category' => 'user',
		) );
		BB_CRM_Auto_Triggers::register( 'user_first_login', array(
			'label'    => __( 'User Logs In For First Time', 'buddyboss-crm-automations' ),
			'category' => 'user',
		) );
		BB_CRM_Auto_Triggers::register( 'user_role_changed', array(
			'label'    => __( 'User Role Changes', 'buddyboss-crm-automations' ),
			'category' => 'user',
		) );
		BB_CRM_Auto_Triggers::register( 'user_role_added', array(
			'label'    => __( 'User Assigned a Specific Role', 'buddyboss-crm-automations' ),
			'category' => 'user',
			'fields'   => array( 'role' => __( 'Role', 'buddyboss-crm-automations' ) ),
		) );
		BB_CRM_Auto_Triggers::register( 'user_deleted', array(
			'label'    => __( 'User Account Deleted', 'buddyboss-crm-automations' ),
			'category' => 'user',
		) );
		BB_CRM_Auto_Triggers::register( 'user_email_confirmed', array(
			'label'    => __( 'User Confirms Email Address', 'buddyboss-crm-automations' ),
			'category' => 'user',
		) );
		BB_CRM_Auto_Triggers::register( 'user_profile_completed', array(
			'label'    => __( 'User Completes Profile', 'buddyboss-crm-automations' ),
			'category' => 'user',
		) );
		BB_CRM_Auto_Triggers::register( 'user_membership_level_changed', array(
			'label'    => __( 'Membership Level Changes', 'buddyboss-crm-automations' ),
			'category' => 'user',
		) );
		BB_CRM_Auto_Triggers::register( 'user_subscription_started', array(
			'label'    => __( 'User Starts Subscription', 'buddyboss-crm-automations' ),
			'category' => 'user',
		) );
		BB_CRM_Auto_Triggers::register( 'user_subscription_cancelled', array(
			'label'    => __( 'User Cancels Subscription', 'buddyboss-crm-automations' ),
			'category' => 'user',
		) );
		BB_CRM_Auto_Triggers::register( 'user_inactive_days', array(
			'label'    => __( 'User Inactive for X Days', 'buddyboss-crm-automations' ),
			'category' => 'user',
			'fields'   => array( 'days' => __( 'Days of inactivity', 'buddyboss-crm-automations' ) ),
		) );
		BB_CRM_Auto_Triggers::register( 'user_password_reset', array(
			'label'    => __( 'User Requests Password Reset', 'buddyboss-crm-automations' ),
			'category' => 'user',
		) );
		BB_CRM_Auto_Triggers::register( 'user_avatar_uploaded', array(
			'label'    => __( 'User Uploads Avatar', 'buddyboss-crm-automations' ),
			'category' => 'user',
		) );
		BB_CRM_Auto_Triggers::register( 'user_cover_photo_uploaded', array(
			'label'    => __( 'User Uploads Cover Photo', 'buddyboss-crm-automations' ),
			'category' => 'user',
		) );
