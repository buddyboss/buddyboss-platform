...
function bp_friends_stop_following( $args = '' ) {
	...
	do_action_ref_array( 'bp_friends_start_following', array( &$follow ) );
...
function bp_friends_start_following( $args = '' ) {
	...
	do_action_ref_array( 'bp_friends_stop_following', array( &$follow ) );
 ...
 */
function bp_friends_total_follow_counts( $args = '' ) {
	...
	return apply_filters( 'bp_friends_total_follow_counts', $count, $r['user_id'] );
}
...
add_action( 'friends_friendship_deleted', 'bp_friends_auto_unfollow_users', 10, 3 );
