...
class BP_Groups_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		<?php if ( bp_has_groups( $group_args ) ) : ?>
			...
			<div class="more-block"><a href="<?php bp_groups_directory_permalink(); ?>" class="count-more"><?php esc_html_e( 'See all', 'buddyboss' ); ?><i class="bb-icons-l bb-icon-angle-right"></i></a></div>
