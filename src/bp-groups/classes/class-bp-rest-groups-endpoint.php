	...
	public function get_item_schema() {
		...
		if ( function_exists( 'bb_is_enabled_subscription' ) && bb_is_enabled_subscription( 'group' ) ) {
			$schema['properties']['is_subscribed'] = array(
				'context'     => array( 'embed', 'view', 'edit' ),
				'description' => __( 'The current user is subscribed of a group or not.', 'buddyboss-platform' ),
				'type'        => 'boolean',
				'readonly'    => true,
			);
			...
			$schema['properties']['subscribed_id'] = array(
				'context'     => array( 'embed', 'view', 'edit' ),
				'description' => __( 'The group subscription ID of current user.', 'buddyboss-platform' ),
				'type'        => 'integer',
				'readonly'    => true,
			);
		}
