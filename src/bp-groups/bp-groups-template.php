		...
		if ( ! empty( $group->is_member ) ) {
			...
			if ( groups_is_user_admin( bp_loggedin_user_id(), $group->id ) ) {
				if ( 'Organizer' === get_group_role_label( $group->id, 'organizer_singular_label_name' ) ) {
					$button_text = apply_filters( 'bp_group_organizer_label_text', sprintf( __( 'You\'re a %s', 'buddyboss' ), get_group_role_label( $group->id, 'organizer_singular_label_name' ) ), $group->id, get_group_role_label( $group->id, 'organizer_singular_label_name' ) );
				} else {
					$button_text = apply_filters( 'bp_group_organizer_label_text', sprintf( __( 'You\'re a %s', 'buddyboss' ), get_group_role_label( $group->id, 'organizer_singular_label_name' ) ), $group->id, get_group_role_label( $group->id, 'organizer_singular_label_name' ) );
				}
