 ...
 */
function media_screen_group_single_document_folder() {
...
add_action( 'bp_screens', 'media_screen_group_single_document_folder' );

function bp_media_documents_single_folder_screen() {
	bp_get_template_part( 'group/single/folder' );
}
