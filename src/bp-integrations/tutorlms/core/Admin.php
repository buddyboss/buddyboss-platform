...
class Admin {
	...
	public function __construct() {
		add_action( 'bb_tutorlms/depencencies_failed', array( $this, 'registerDependencyNotices' ) );
		add_action( 'bb_tutorlms/requirements_failed', array( $this, 'registerRequirementNotices' ) );
	}
	...
	public function printDependencyAdminNotice() {
		$missingDepencencies = bb_tutorlms()->dependencies->getMissingDepencencies();
	...
	public function printRequirementAdminNotice() {
		foreach ( bb_tutorlms()->requirements->getMissingRequirements() as $requirement ) {
