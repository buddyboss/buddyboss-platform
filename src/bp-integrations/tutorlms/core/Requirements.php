<?php
/**
 * BuddyBoss TutorLMS integration Requirements class.
 *
...
class Requirements
{
	...
	public function __construct()
	{
		...
		add_action('bb_tutorlms/depencencies_loaded', [$this, 'checkForRequirements']);
	}
	...
	public function checkForRequirements()
	{
		...
		do_action($success? 'bb_tutorlms/requirements_checked' : 'bb_tutorlms/requirements_failed', $this);
	}
