...
global $courses_new;
$count 		 = count( bb_tutorlms( 'buddypress' )->courses->getGroupCourses() );
$courses_new = bb_tutorlms( 'buddypress' )->courses->getGroupCourses();

if ( $count > 1 ) {
	$view              = get_option( 'bb_theme_tutorlms_grid_list', 'grid' );
    ...
    <div class="item-body-inner">
        <div id="bb-tutorlms_profile">
            <div id="tutorlms-content" class="tutorlms-course-list">
                    ...
                    <div class="grid-view bb-grid">
                        <div id="course-dir-list" class="course-dir-list bs-dir-list">
                            <ul id="courses-list" class="bb-course-items <?php echo esc_attr( $class_grid_show . $class_list_show ); ?>">
								<?php
								foreach ( bb_tutorlms( 'buddypress' )->courses->getGroupCourses() as $post ) :
									setup_postdata( $post );
