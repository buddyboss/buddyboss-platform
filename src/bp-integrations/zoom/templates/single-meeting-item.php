		...
		<div class="single-meeting-item last-col">
			<div class="meeting-item-col meeting-action last-col full">
				...
				<div class="pull-right">
					...
					<?php endif; ?>
					<a href="#" data-meeting-id="<?php echo bp_get_zoom_meeting_zoom_meeting_id(); ?>"
					   data-meeting-pwd="<?php echo bp_get_zoom_meeting_password(); ?>"
					   data-is-host="<?php echo bp_zoom_can_current_user_start_meeting( bp_get_zoom_meeting_id() ) ? '1' : '0'; ?>"
					   class="button small outline join-meeting-in-browser">
						<?php _e( 'Join meeting in browser', 'buddyboss' ); ?>
					</a>
					<a type="button" class="button small outline"
					   href="<?php echo bp_zoom_can_current_user_start_meeting( bp_get_zoom_meeting_id() ) ? bp_get_zoom_meeting_zoom_start_url() : bp_get_zoom_meeting_zoom_join_url(); ?>"><?php _e( 'Join this Meeting in app', 'buddyboss' ); ?></a>
