...
add_action( 'enqueue_block_editor_assets', 'bp_zoom_meeting_block_enqueue_editor_assets' );
function bp_zoom_meeting_block_enqueue_editor_assets() {
	wp_enqueue_script(
...
add_action( 'init', 'bp_zoom_register_meeting_block' );
function bp_zoom_register_meeting_block() {
	register_block_type(
			'bp-zoom-meeting/meeting',
			[
					'editor_script'   => 'bp-zoom-meeting-block-js',
					'render_callback' => 'bp_zoom_render_meeting_block',
			]
	);
}
