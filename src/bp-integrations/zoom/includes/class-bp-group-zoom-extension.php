		...
		function display( $group_id = null ) {
			...
			if ( bp_has_zoom_meetings() ) {
				while( bp_zoom_meeting() ) {
					...
					?>
					<div>
						title:<?php bp_zoom_meeting_title(); ?><br/>
						start date:<?php bp_zoom_meeting_start_date(); ?><br/>
						timezone:<?php bp_zoom_meeting_timezone(); ?><br/>
						duration:<?php bp_zoom_meeting_duration(); ?><br/>
						meeting id:<?php bp_zoom_meeting_zoom_meeting_id(); ?><br/>
						start url:<?php bp_zoom_meeting_zoom_start_url(); ?><br/>
						join_url: <?php bp_zoom_meeting_zoom_join_url(); ?><br/>
					</div>
					<br/>
					<?php
				}
			...
			<table class="form-table">
				...
				<tr>
					...
					<td>
						<select name="userId" id="user-id" required="">
							...
							<option value="aSi5h7bRRMeN7UljFkDNAA" selected="selected">Mehul ( mehul@buddyboss.com )</option>
						</select>
				...
				<tr>
					...
					<td>
						<input type="text" name="start_date" id="start_date" data-existingdate="2020-04-02 18:00" required="" class="regular-text" value="2020-04-05 18:00">
						<p class="description" id="start_date-description">Starting Date and Time of the Meeting (Required).</p>
					</td>
				</tr>
				<tr>
					<th scope="row"><label for="timezone">Timezone</label></th>
					<td>
						<select id="timezone" name="timezone" id="timezone" class="zvc-hacking-select select2-hidden-accessible" data-select2-id="timezone" tabindex="-1" aria-hidden="true">
							...
							<option value="Asia/Calcutta" selected="selected" data-select2-id="5">(GMT+5:30) India </option>
						...
						</select><span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="4" style="width: 390px;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-timezone-container"><span class="select2-selection__rendered" id="select2-timezone-container" role="textbox" aria-readonly="true" title="(GMT+5:30) India ">(GMT+5:30) India </span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
				...
				<tr>
					...
					<td>
						<p class="description" id="join_before_host-description"><input type="checkbox" name="join_before_host" id="join_before_host" value="1" checked="checked" class="regular-text">Join meeting before host start the meeting. Only for scheduled or recurring meetings.</p>
					</td>
				</tr>
				<tr>
					<th scope="row"><label for="option_host_video">Host join start</label></th>
					<td>
						<p class="description" id="option_host_video-description"><input type="checkbox" name="option_host_video" id="option_host_video" value="1" class="regular-text">Start video when host join meeting.</p>
					</td>
				</tr>
				<tr>
					<th scope="row"><label for="option_participants_video">Participants Video</label></th>
					<td>
						<p class="description" id="option_participants_video-description"><input type="checkbox" name="option_participants_video" id="participants_video" value="1" class="regular-text">Start video when participants join meeting.</p>
					</td>
				</tr>
				<tr>
					<th scope="row"><label for="option_mute_participants_upon_entry">Mute Participants upon entry</label></th>
					<td>
						<p class="description" id="option_mute_participants_upon_entry"><input type="checkbox" name="option_mute_participants" id="mute_participants" value="1" checked="checked" class="regular-text">Mutes Participants when entering the meeting.</p>
					</td>
				</tr>
				<tr>
