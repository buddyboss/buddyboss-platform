...
if ( class_exists( 'BP_Group_Extension' ) ) {
    ...
    class LearnDash_BuddyPress_Groups_Reports_Extension extends BP_Group_Extension {
        ...
        function display( $group_id = null ) {
            ...
            include bp_learndash_reports_path('templates/report-filters.php');
            include bp_learndash_reports_path('templates/report-courses.php');
            include bp_learndash_reports_path('templates/report-links.php');

            if ( method_exists( $this, $display ) ) {
                $this->$display();
            }

            include bp_learndash_reports_path('templates/report-export.php');
        }
