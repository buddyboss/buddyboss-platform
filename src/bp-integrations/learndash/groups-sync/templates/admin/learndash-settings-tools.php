...
<div class="sfwd sfwd_options">
    <div id="learndash-buddypress-groups-sync-tools">
        ...
        <p><?php _e('Scan for unassociated LearnDash groups. This tool is useful if you already have LearnDash groups on your site and want to associate them with new or existing social groups.', 'buddyboss'); ?></p>
	</div>
