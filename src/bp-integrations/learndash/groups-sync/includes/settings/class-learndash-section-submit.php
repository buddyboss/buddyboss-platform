...
class LearnDash_Settings_Section_BuddyPress_Groups_Sync_Submit extends LearnDash_Settings_Section
{
    ...
    public function show_meta_box()
    {
        printf('
            ...
            get_submit_button(__('Save', 'learndash'), 'primary', 'submit', false)
        );
    }
