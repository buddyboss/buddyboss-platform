...
// Add filter for add oembed to message.
add_filter( 'bp_get_the_thread_message_content', 'bbp_message_autoembed', 99999, 1 );
/**
...
/**
 * Add oembed to message.
 *
 * @param $content
 *
 * @return string
 */
function bbp_message_autoembed( $content ) {
