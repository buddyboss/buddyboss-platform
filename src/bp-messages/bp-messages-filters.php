...
/**
 * Filter only those message recipients to whom the sender is allowed to send message.
 *
 ...
 * @return array
 */
function bb_members_suggestions_allowed_messaging( $sql, BP_User_Query $query ) {
	if (
