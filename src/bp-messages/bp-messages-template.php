...
function bp_get_message_thread_excerpt() {
	 ...
	 */
	return apply_filters( 'bp_get_message_thread_excerpt', wp_strip_all_tags( str_replace('><', '> <', bp_create_excerpt( $messages_template->thread->last_message_content, 75 ) ) ) );
}
...
function bp_get_the_thread_message_excerpt() {
	 ...
	 */
	return apply_filters( 'bp_get_the_thread_message_excerpt', str_replace( '><', '> <', $content ) );
}
