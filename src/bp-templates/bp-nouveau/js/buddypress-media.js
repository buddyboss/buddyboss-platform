...
( function (exports, $) {
	...
	bp.Nouveau.Media = {
		...
		addListeners: function () {
			...
			$(document).on('click', '.bb-activity-media-elem.media-activity .media-action-wrap .media-action_more, #media-stream.media .bb-photo-thumb .media-action-wrap .media-action_more, .bb-activity-media-elem.document-activity .document-action-wrap .document-action_more, .bb-activity-media-elem.document-activity .document-action-wrap .document-action_list li a, #video-stream.video .bb-video-thumb .video-action-wrap .video-action_more', this.fileActivityActionButton.bind(this));
