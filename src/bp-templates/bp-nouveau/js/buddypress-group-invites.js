...
( function( exports, $ ) {
	...
	bp.Nouveau.GroupInvites = {
		...
		start: function() {
			...
			$( document ).on( 'click', '#group-invites-container .bb-groups-invites-right #send_group_invite_form .bb-groups-invites-right-top .select2-container .selection .select2-selection--multiple .select2-selection__rendered .select2-search--inline .select2-search__field', function() {
			...
			if ( isPendingInvitePageSelector.length ) {
				...
				$( document ).on( 'click', '#group-invites-container .last #bp-group-invites-next-page', function() {
				...
				$( document ).on( 'search', '.pending-invites #group-invites-container #group_invites_search', function( e ) {
					e.preventDefault();
					if ( '' === this.value ) {
			...
			$( document ).on( 'search', '.send-invites #group-invites-container #group_invites_search', function( e ) {
				e.preventDefault();
			...
			$( document ).on( 'search', '.group-create.group-invites.create #group-invites-container #group_invites_search', function( e ) {
				e.preventDefault();
			...
			$( '#bp-group-send-invite-switch-checkbox' ).on( 'change', function () {
			...
			$( document ).on( 'click', '#group-invites-container .bb-groups-invites-right #send_group_invite_form .bb-groups-invites-right-bottom #send_group_invite_button', function( e ) {
				e.preventDefault();
				var users_list = [];
				var newData = $.grep( $group_invites_select.select2('data'), function (value) {
			...
			$( document ).on( 'click', '.send-invites #group-invites-container #group_invites_search_submit', function( e ) {
				e.preventDefault();
			...
			$( document ).on( 'click', '.group-create.group-invites.create #group-invites-container #group_invites_search_submit', function( e ) {
				e.preventDefault();
