			...
			$( '#bb-report-content' ).submit( function () {
				...
				$.post( BP_Nouveau.ajaxurl, data, function ( response ) {
					...
					if ( result.success ) {
						...
						if ( '' !== result.message.errors.bp_moderation_missing_data ) {
							$( '.bp-report-form-err' ).append( result.message.errors.bp_moderation_missing_data );
						} else if ( '' !== result.message.errors.bp_moderation_already_reported ) {
							$( '.bp-report-form-err' ).append( result.message.errors.bp_moderation_already_reported );
						} else if ( '' !== result.message.errors.bp_moderation_missing_error ) {
							$( '.bp-report-form-err' ).append( result.message.errors.bp_moderation_missing_error );
						}
					}
				} );
			} );
