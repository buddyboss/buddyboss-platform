	...
	bp.Nouveau = {
		...
		reportPopUp: function () {
			$( document ).on( 'click', '.report-activity', function ( e ) {
				...
				$( 'form#bb-report-content' ).find( '.bp-content-id' ).val( $( this ).attr( 'data-bp-id' ) );
				$( 'form#bb-report-content' ).find( '.bp-content-type' ).val( $( this ).attr( 'data-bp-type' ) );
				$( 'form#bb-report-content' ).find( '.bp-nonce' ).val( $( this ).attr( 'data-bp-nonce' ) );
			} );
