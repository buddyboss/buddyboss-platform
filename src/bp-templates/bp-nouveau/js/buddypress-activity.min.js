window.bp=window.bp||{},function(e,t){"undefined"!=typeof BP_Nouveau&&(bp.Nouveau=bp.Nouveau||{},bp.Models=bp.Models||{},bp.Models.ACReply=Backbone.Model.extend({defaults:{gif_data:{}}}),bp.Nouveau.Activity={start:function(){this.setupGlobals(),this.addListeners()},setupGlobals:function(){this.just_posted=[],this.current_page=1,this.mentions_count=Number(t(bp.Nouveau.objectNavParent+' [data-bp-scope="mentions"]').find("a span").html())||0,this.heartbeat_data={newest:"",highlights:{},last_recorded:0,first_recorded:0,document_title:t(document).prop("title")},void 0!==window.Dropzone&&void 0!==BP_Nouveau.media&&(window.Dropzone.autoDiscover=!1,this.dropzone_options={url:BP_Nouveau.ajaxurl,timeout:108e5,dictFileTooBig:BP_Nouveau.media.dictFileTooBig,dictDefaultMessage:BP_Nouveau.media.dropzone_media_message,acceptedFiles:"image/*",autoProcessQueue:!0,addRemoveLinks:!0,uploadMultiple:!1,maxFiles:void 0!==BP_Nouveau.media.maxFiles?BP_Nouveau.media.maxFiles:10,maxFilesize:void 0!==BP_Nouveau.media.max_upload_size?BP_Nouveau.media.max_upload_size:2,dictMaxFilesExceeded:BP_Nouveau.media.media_dict_file_exceeded,dictCancelUploadConfirmation:BP_Nouveau.media.dictCancelUploadConfirmation,maxThumbnailFilesize:void 0!==BP_Nouveau.media.max_upload_size?BP_Nouveau.media.max_upload_size:2},void 0!==BP_Nouveau.media.dropzone_options&&Object.assign(this.dropzone_options,BP_Nouveau.media.dropzone_options)),this.dropzone_obj=null,this.dropzone_media=[],this.dropzone_document_obj=null,this.dropzone_document=[],this.dropzone_video_obj=null,this.dropzone_video=[],this.models=[],this.InitiatedCommentForms=[]},addListeners:function(){t("body").hasClass("activity-singular")||t("#buddypress").on("bp_heartbeat_send",this.heartbeatSend.bind(this)),t("#buddypress").on("bp_heartbeat_tick",this.heartbeatTick.bind(this)),t('#buddypress [data-bp-list="activity"]').on("click","li.load-newest, li.load-more",this.injectActivities.bind(this)),t("#buddypress").on("bp_ajax_request",'[data-bp-list="activity"]',this.scopeLoaded.bind(this)),t('#buddypress [data-bp-list="activity"]').on("bp_ajax_append",this.hideComments),t('#buddypress [data-bp-list="activity"]').on("click",".show-all",this.showComments),t('#buddypress [data-bp-list="activity"]').on("click",".activity-item",bp.Nouveau,this.activityActions.bind(this)),t('#buddypress [data-bp-list="activity"]').on("click",".activity-privacy>li.bb-edit-privacy a",bp.Nouveau,this.activityPrivacyRedirect.bind(this)),t('#buddypress [data-bp-list="activity"]').on("click",".activity-privacy>li:not(.bb-edit-privacy)",bp.Nouveau,this.activityPrivacyChange.bind(this)),t('#buddypress [data-bp-list="activity"], #bb-media-model-container .activity-list').on("click","span.privacy",bp.Nouveau,this.togglePrivacyDropdown.bind(this)),t("#bb-media-model-container .activity-list").on("click",".activity-item",bp.Nouveau,this.activityActions.bind(this)),t(document).keydown(this.commentFormAction),t(document).click(this.togglePopupDropdown),t('#buddypress .activity-list, #buddypress [data-bp-list="activity"], #bb-media-model-container .activity-list').on("click",".ac-reply-media-button",this.openCommentsMediaUploader.bind(this)),t('#buddypress .activity-list, #buddypress [data-bp-list="activity"], #bb-media-model-container .activity-list').on("click",".ac-reply-document-button",this.openCommentsDocumentUploader.bind(this)),t('#buddypress .activity-list, #buddypress [data-bp-list="activity"], #bb-media-model-container .activity-list').on("click",".ac-reply-video-button",this.openCommentsVideoUploader.bind(this)),t('#buddypress .activity-list, #buddypress [data-bp-list="activity"], #bb-media-model-container .activity-list').on("click",".ac-reply-gif-button",this.openGifPicker.bind(this)),t(document).on("click",this.toggleActivityOption.bind(this)),_.isUndefined(BP_Nouveau.activity.params.autoload)||t(window).scroll(this.loadMoreActivities)},heartbeatSend:function(e,a){this.heartbeat_data.first_recorded=t("#buddypress [data-bp-list] [data-bp-activity-id]").first().data("bp-timestamp")||0,(0===this.heartbeat_data.last_recorded||this.heartbeat_data.first_recorded>this.heartbeat_data.last_recorded)&&(this.heartbeat_data.last_recorded=this.heartbeat_data.first_recorded),a.bp_activity_last_recorded=this.heartbeat_data.last_recorded,t("#buddypress .dir-search input[type=search]").length&&(a.bp_activity_last_recorded_search_terms=t("#buddypress .dir-search input[type=search]").val()),t.extend(a,{bp_heartbeat:bp.Nouveau.getStorage("bp-activity")})},heartbeatTick:function(e,a){var i,o,d=bp.Nouveau.objects,s=bp.Nouveau.getStorage("bp-activity","scope"),n=this;if(void 0!==a&&a.bp_activity_newest_activities){if(this.heartbeat_data.newest=t.trim(a.bp_activity_newest_activities.activities)+this.heartbeat_data.newest,this.heartbeat_data.last_recorded=Number(a.bp_activity_newest_activities.last_recorded),o=t(this.heartbeat_data.newest).filter(".activity-item"),i=Number(o.length),d.push("mentions"),"all"===s){t.each(o,function(e,a){a=t(a),t.each(d,function(e,i){-1!==t.inArray("bp-my-"+i,a.get(0).classList)&&(void 0===n.heartbeat_data.highlights[i]?n.heartbeat_data.highlights[i]=[a.data("bp-activity-id")]:-1===t.inArray(a.data("bp-activity-id"),n.heartbeat_data.highlights[i])&&n.heartbeat_data.highlights[i].push(a.data("bp-activity-id")))})});var r=new RegExp("bp-my-("+d.join("|")+")","g");this.heartbeat_data.newest=this.heartbeat_data.newest.replace(r,""),t(bp.Nouveau.objectNavParent+' [data-bp-scope="all"]').find("a span").html(i)}else this.heartbeat_data.highlights[s]=[],t.each(o,function(e,a){n.heartbeat_data.highlights[s].push(t(a).data("bp-activity-id"))});if(t.each(d,function(e,a){if(void 0!==n.heartbeat_data.highlights[a]&&n.heartbeat_data.highlights[a].length){var i=0;"mentions"===a&&(i=n.mentions_count),t(bp.Nouveau.objectNavParent+' [data-bp-scope="'+a+'"]').find("a span").html(Number(n.heartbeat_data.highlights[a].length)+i)}}),d.pop(),t(document).prop("title","("+i+") "+this.heartbeat_data.document_title),t('#buddypress [data-bp-list="activity"] li').first().hasClass("load-newest")){var l=t('#buddypress [data-bp-list="activity"] .load-newest a').html();t('#buddypress [data-bp-list="activity"] .load-newest a').html(l.replace(/([0-9]+)/,i))}else t('#buddypress [data-bp-list="activity"] ul.activity-list').prepend('<li class="load-newest"><a href="#newest">'+BP_Nouveau.newest+" ("+i+")</a></li>");t('#buddypress [data-bp-list="activity"] li.load-newest').trigger("click"),t('#buddypress [data-bp-list="activity"]').trigger("bp_heartbeat_pending",this.heartbeat_data),void 0!==bp.Nouveau&&bp.Nouveau.reportPopUp()}},injectActivities:function(e){var a=bp.Nouveau.getStorage("bp-activity"),i=a.scope||null,o=a.filter||null;if(t(e.currentTarget).hasClass("load-newest")){e.preventDefault(),t(e.currentTarget).remove();var d=t.parseHTML(this.heartbeat_data.newest),s=!1;if(t.each(d,function(e,a){"LI"===a.nodeName&&t(a).hasClass("just-posted")&&t("#"+t(a).prop("id")).length&&t("#"+t(a).prop("id")).remove(),t(a).hasClass("bb-pinned")&&(s=!0)}),!0===s){var n=t(e.delegateTarget).find(".activity-list").find(".bb-pinned");n.each(function(){var e=t(this).find(".unpin-activity"),a=!1;e.removeClass("unpin-activity").addClass("pin-activity"),t(this).hasClass("groups")&&(a=!0),a?e.find("span").html(BP_Nouveau.activity.strings.pinGroupPost):e.find("span").html(BP_Nouveau.activity.strings.pinPost)}),n.removeClass("bb-pinned")}t(e.delegateTarget).find(".activity-list").prepend(this.heartbeat_data.newest).find("li.activity-item").each(bp.Nouveau.hideSingleUrl).trigger("bp_heartbeat_prepend",this.heartbeat_data),this.heartbeat_data.newest="","all"===i&&t(bp.Nouveau.objectNavParent+' [data-bp-scope="all"]').find("a span").html(""),"mentions"===i&&(bp.Nouveau.ajax({action:"activity_clear_new_mentions"},"activity"),this.mentions_count=0),t(bp.Nouveau.objectNavParent+' [data-bp-scope="'+i+'"]').find("a span").html(""),void 0!==this.heartbeat_data.highlights[i]&&(this.heartbeat_data.highlights[i]=[]),setTimeout(function(){t(e.delegateTarget).find("[data-bp-activity-id]").removeClass("newest_"+i+"_activity")},3e3),t(document).prop("title",this.heartbeat_data.document_title),jQuery(window).scroll()}else if(t(e.currentTarget).hasClass("load-more")){var r=1*Number(this.current_page)+1,l=this,c="";e.preventDefault();var p=t(e.currentTarget);p.find("a").first().addClass("loading"),this.just_posted=[],t(e.delegateTarget).children(".just-posted").each(function(){l.just_posted.push(t(this).data("bp-activity-id"))}),t("#buddypress .dir-search input[type=search]").length&&(c=t("#buddypress .dir-search input[type=search]").val()),bp.Nouveau.objectRequest({object:"activity",scope:i,filter:o,search_terms:c,page:r,method:"append",exclude_just_posted:this.just_posted.join(","),target:"#buddypress [data-bp-list] ul.bp-list"}).done(function(e){!0===e.success&&(p.remove(),l.current_page=r,jQuery(window).scroll())})}},hideComments:function(e){var a,i,o,d=t(e.target).find(".activity-comments");d.length&&d.each(function(e,d){o=t(d).children("ul").not(".conflict-activity-ul-li-comment"),i=t(o).find("li").not(t(".document-action-class, .media-action-class, .video-action-class")),i.length&&(t("body").hasClass("activity-singular")&&""!==window.location.hash&&t(window.location.hash).length&&0!==t(window.location.hash).closest(".activity-comments").length||(a=t(d).closest(".activity-item"),t("#acomment-comment-"+a.data("bp-activity-id")+" span.comment-count").html()||" ",i.each(function(e,o){if(e<i.length-4){if(e||t(o).before('<li class="show-all"><button class="text-button" type="button" data-bp-show-comments-id="#'+a.prop("id")+'/show-all/">'+BP_Nouveau.show_x_comments+"</button></li>"),window.location.hash&&"#"+t(o).attr("id")===window.location.hash)return t(o).parents("li.comment-item").show(),!1;t(o).addClass("bp-hidden").hide()}}),t(o).children(".bp-hidden").length===t(o).children("li").length-1&&t(o).find("li.show-all").length&&t(o).children("li:not(.show-all)").removeClass("bp-hidden").toggle()))})},showComments:function(e){e.preventDefault(),t(e.target).addClass("loading"),setTimeout(function(){t(e.target).closest("ul").find("li").removeClass("bp-hidden").fadeIn(300,function(){t(e.target).parent("li").remove()})},600)},scopeLoaded:function(e,a){this.hideComments(e),this.current_page=1,"mentions"===a.scope&&void 0!==a.response.new_mentions?(t.each(a.response.new_mentions,function(e,a){t("#buddypress #activity-stream").find('[data-bp-activity-id="'+a+'"]').addClass("newest_mentions_activity")}),this.mentions_count=0):void 0!==this.heartbeat_data.highlights[a.scope]&&this.heartbeat_data.highlights[a.scope].length&&t.each(this.heartbeat_data.highlights[a.scope],function(e,i){t("#buddypress #activity-stream").find('[data-bp-activity-id="'+i+'"]').length&&t("#buddypress #activity-stream").find('[data-bp-activity-id="'+i+'"]').addClass("newest_"+a.scope+"_activity")}),this.heartbeat_data.newest="",t.each(t(bp.Nouveau.objectNavParent+" [data-bp-scope]").find("a span"),function(e,a){0===parseInt(t(a).html(),10)&&t(a).html("")}),void 0!==this.heartbeat_data.highlights[a.scope]&&(this.heartbeat_data.highlights[a.scope]=[]),t(document).prop("title",this.heartbeat_data.document_title),setTimeout(function(){t("#buddypress #activity-stream .activity-item").removeClass("newest_"+a.scope+"_activity")},3e3),void 0!==window.instgrm&&window.instgrm.Embeds.process(),void 0!==window.FB&&void 0!==window.FB.XFBML&&window.FB.XFBML.parse(),this.fixAtWhoActivity(),this.openEditActivityPopup(),this.navigateToSpecificComment(),setTimeout(function(){jQuery(window).scroll()},200)},openEditActivityPopup:function(){if(!_.isUndefined(BP_Nouveau.activity.params.is_activity_edit)&&0<BP_Nouveau.activity.params.is_activity_edit){var e=t("#activity-"+BP_Nouveau.activity.params.is_activity_edit);if(e.length){var a=e.data("bp-activity"),i=""!==e.data("link-url")?e.data("link-url"):null;_.isUndefined(a)||bp.Nouveau.Activity.postForm.displayEditActivityForm(a,i)}}},activityPrivacyChange:function(e){var a=e.data,i=t(e.target),o=t(e.currentTarget).closest(".activity-item"),d=o.data("bp-activity-id");if(e.preventDefault(),void 0===i.data("value")||""==t.trim(i.data("value")))return!1;o.find(".privacy").addClass("loading"),a.ajax({action:"activity_update_privacy",id:d,privacy:i.data("value")},"activity").done(function(e){if(o.find(".privacy").removeClass("loading"),!0===e.success&&(o.find(".activity-privacy li").removeClass("selected"),o.find(".privacy-wrap").attr("data-bp-tooltip",i.text()),i.addClass("selected"),o.find(".privacy").removeClass("public").removeClass("loggedin").removeClass("onlyme").removeClass("friends"),o.find(".privacy").addClass(i.data("value")),void 0!==e&&void 0!==e.data&&void 0!==e.data.video_symlink)){t(".document-description-wrap").length&&t(".document-description-wrap .bb-open-document-theatre").length&&(t(".document-description-wrap .bb-open-document-theatre").attr("data-video-preview",e.data.video_symlink),t(".document-description-wrap .bb-open-document-theatre").attr("data-extension",e.data.extension)),t(".document-description-wrap").length&&t(".document-detail-wrap.document-detail-wrap-description-popup").length&&(t(".document-detail-wrap.document-detail-wrap-description-popup").attr("data-video-preview",e.data.video_symlink),t(".document-detail-wrap.document-detail-wrap-description-popup").attr("data-extension",e.data.extension));var a=videojs(e.data.video_js_id);a.src({type:e.data.video_extension,src:e.data.video_symlink})}})},activityPrivacyRedirect:function(e){var a=t(e.target);if(e.preventDefault(),void 0===a.data("value")||""==t.trim(a.data("value")))return!1;window.location.href=a.data("value")},togglePrivacyDropdown:function(e){e.data,t(e.target);var a=t(e.currentTarget).closest(".activity-item");a.data("bp-activity-id");e.preventDefault(),t("ul.activity-privacy").not(a.find(".activity-privacy")).removeClass("bb-open"),a.find(".activity-privacy").toggleClass("bb-open")},activityActions:function(e){var a,i,o=e.data,d=t(e.target),s=t(e.currentTarget),n=s.data("bp-activity-id"),r=t(e.delegateTarget),l=s.find(".activity-state"),c=s.find(".comments-count"),p=this;t(d).is("span")&&(d=t(d).closest("a"));var m=0;if(d.parents(".ac-emotion_item")&&t(d).is("img")&&(d=t(d).closest("a"),m=d.parent(".ac-emotion_item").attr("data-reaction-id")),d.hasClass("fav")||d.hasClass("unfav")||m>0){e.preventDefault();var u,v=d.hasClass("fav")?"fav":"unfav",b=!0,f="activity",h=d.parents(".acomment-display").first(),y=0;m>0&&(v="fav"),0<h.length&&(b=!1,f="activity_comment"),b?(u=d.parents(".activity-item"),y=u.data("bp-activity-id")):(u=d.parents(".activity-comment").first(),y=u.data("bp-activity-comment-id")),d.addClass("loading");var g={action:"activity_mark_"+v,reaction_id:m,item_id:y,item_type:f};o.ajax(g,"activity").done(function(e){if(d.removeClass("loading"),!1!==e.success)if(d.fadeOut(200,function(){"false"===t(this).attr("aria-pressed")?t(this).attr("aria-pressed","true"):t(this).attr("aria-pressed","false"),void 0!==e.data.reaction_count&&(b?0<u.find(".activity-content .activity-state-reactions").length?u.find(".activity-content  .activity-state-reactions").replaceWith(e.data.reaction_count):u.find(".activity-content .activity-state").prepend(e.data.reaction_count):0<u.find("#acomment-display-"+y+" .comment-reactions").length&&u.find("#acomment-display-"+y+" .comment-reactions").html(e.data.reaction_count)),e.data.reaction_button&&(b?u.find(".bp-generic-meta a.bp-like-button:first").replaceWith(e.data.reaction_button):u.find("#acomment-display-"+y+" .bp-generic-meta a.bp-like-button").replaceWith(e.data.reaction_button)),t(this).fadeIn(200)}),"fav"===v)void 0===e.data.directory_tab||""===e.data.directory_tab||t(o.objectNavParent+' [data-bp-scope="favorites"]').length||t(o.objectNavParent+' [data-bp-scope="all"]').after(e.data.directory_tab);else if("unfav"===v){var a=t('[data-bp-user-scope="favorites"]').hasClass("selected")||t(o.objectNavParent+' [data-bp-scope="favorites"]').hasClass("selected");a&&s.remove(),void 0!==e.data.no_favorite&&(t(o.objectNavParent+' [data-bp-scope="all"]').length&&t(o.objectNavParent+' [data-bp-scope="all"]').hasClass("selected")?t(o.objectNavParent+' [data-bp-scope="favorites"]').remove():a&&r.append(e.data.no_favorite))}})}if(d.hasClass("delete-activity")||d.hasClass("acomment-delete")||d.hasClass("spam-activity")||d.hasClass("spam-activity-comment")){var C,w,z,N,j=d.closest("[data-bp-activity-comment-id]"),P=j.data("bp-activity-comment-id"),B=0;if(e.preventDefault(),void 0!==BP_Nouveau.confirm&&!1===window.confirm(BP_Nouveau.confirm))return!1;d.addClass("loading");var x={action:"delete_activity",id:n,_wpnonce:o.getLinkParams(d.prop("href"),"_wpnonce"),is_single:d.closest("[data-bp-single]").length};(d.hasClass("spam-activity")||d.hasClass("spam-activity-comment"))&&(x.action="bp_spam_activity"),C=s,P&&(delete x.is_single,x.id=P,x.is_comment=!0,C=j),o.ajax(x,"activity").done(function(e){if(d.removeClass("loading"),!1===e.success)C.prepend(e.data.feedback),C.find(".bp-feedback").hide().fadeIn(300);else{if(e.data.redirect)return window.location.href=e.data.redirect;if(e.data.parent_activity_id&&e.data.activity&&t("#buddypress #activity-stream ul.activity-list li#activity-"+e.data.parent_activity_id).replaceWith(e.data.activity),P){if(B=1,s.append(j.find("form")),t.each(j.find("li.comment-item"),function(){B+=1}),w=l.find("span.comments-count"),z=w.text().length?w.text().match(/\d+/)[0]:0,z=Number(z-B),c.length){var a=z>1?BP_Nouveau.activity.strings.commentsLabel:BP_Nouveau.activity.strings.commentLabel;c.text(a.replace("%d",z))}N=s.find("li.show-all a"),N.length&&N.html(BP_Nouveau.show_x_comments.replace("%d",z)),0===z&&(s.removeClass("has-comments"),l.removeClass("has-comments"),c.empty())}C.slideUp(300,function(){C.remove()}),P||s.data("bp-timestamp")!==o.Activity.heartbeat_data.last_recorded||(o.Activity.heartbeat_data.newest="",o.Activity.heartbeat_data.last_recorded=0),t(document).trigger("bp_activity_ajax_delete_request",t.extend(x,{response:e})),t(document).trigger("bp_activity_ajax_delete_request_video",t.extend(x,{response:e}))}})}if(d.closest("span").hasClass("activity-read-more")){var k=d.closest("div"),T=d.closest("span");if(y=null,t(k).hasClass("activity-inner")?y=n:t(k).hasClass("acomment-content")&&(y=d.closest("li").data("bp-activity-comment-id")),!y)return e;e.preventDefault(),t(T).addClass("loading"),o.ajax({action:"get_single_activity_content",id:y},"activity").done(function(e){"object"!=typeof e&&d.closest("div").find(".bb-activity-media-wrap").length>0&&(e=JSON.parse(e)),t(T).removeClass("loading"),k.parent().find(".bp-feedback").length&&k.parent().find(".bp-feedback").remove(),!1===e.success?(k.after(e.data.feedback),k.parent().find(".bp-feedback").hide().fadeIn(300)):(t(k).html(e.data.contents).slideDown(300),jQuery(window).scroll(),s.hasClass("wp-link-embed")&&(void 0!==window.instgrm&&window.instgrm.Embeds.process(),void 0!==window.FB&&void 0!==window.FB.XFBML&&window.FB.XFBML.parse(document.getElementById("activity-"+y))))})}if(d.hasClass("activity-state-comments")||d.hasClass("acomment-reply")||d.parent().hasClass("acomment-reply")||d.hasClass("acomment-edit")){y=n,a=t("#ac-form-"+n);var F=t('[data-bp-activity-id="'+y+'"] .activity-comments'),U=!1;if(d.closest(".bb-media-model-container").length&&(a=d.closest(".bb-media-model-container").find("#ac-form-"+n),F=d.closest(".bb-media-model-container").find('[data-bp-activity-id="'+y+'"] .activity-comments')),e.preventDefault(),p.resetActivityCommentForm(a),d.parent().hasClass("acomment-reply")&&d.parent(),d.closest("li").data("bp-activity-comment-id")&&(y=d.closest("li").data("bp-activity-comment-id")),d.hasClass("acomment-edit")&&d.closest("li").data("bp-activity-comment")&&(U=d.closest("li").data("bp-activity-comment")),this.toggleMultiMediaOptions(a,d),a.removeClass("root"),t(".ac-form").hide(),t.each(a.children("div"),function(e,a){t(a).hasClass("error")&&t(a).remove()}),d.hasClass("acomment-edit")&&!_.isNull(U)){var E=t('[data-bp-activity-comment-id="'+y+'"]');E.find("#acomment-display-"+y).addClass("bp-hide"),E.find("#acomment-edit-form-"+y).append(a),a.addClass("acomment-edit").attr("data-item-id",y),p.editActivityCommentForm(a,U)}else y===n?(F.append(a),a.addClass("root")):t('[data-bp-activity-comment-id="'+y+'"]').append(a);a.slideDown(200);var D=a.find(".post-elements-buttons-item.post-emoji").prevAll().not(":hidden").length+1;a.find(".post-elements-buttons-item.post-emoji").attr("data-nth-child",D);var M=a.find(".post-elements-buttons-item.post-gif").prevAll().not(":hidden").length+1;a.find(".post-elements-buttons-item.post-gif").attr("data-nth-child",M);var A=a.find(".ac-input[contenteditable]");if(A.length>0){var L=A.get(0),I=t(L).attr("id")+(t(L).closest(".bb-media-model-inner").length?"-theater":"");if(-1!==t.inArray(I,p.InitiatedCommentForms)&&!t(L).closest("form").hasClass("events-initiated")){var Q=p.InitiatedCommentForms.indexOf(I);p.InitiatedCommentForms.splice(Q,1)}-1!=t.inArray(I,p.InitiatedCommentForms)||t(L).closest("form").hasClass("events-initiated")||(L.addEventListener("paste",function(e){e.preventDefault();var t=e.clipboardData.getData("text/plain");document.execCommand("insertText",!1,t)}),L.addEventListener("input",function(e){var a=jQuery(e.currentTarget).html();k=t.trim(a.replace(/<div>/gi,"\n").replace(/<\/div>/gi,"")),k=k.replace(/&nbsp;/g," ");var i=jQuery(e.currentTarget).text().trim();""!==i||k.indexOf("emojioneemoji")>=0?jQuery(e.currentTarget).closest("form").addClass("has-content"):jQuery(e.currentTarget).closest("form").removeClass("has-content")}),t(L).closest("form").addClass("events-initiated"),p.InitiatedCommentForms.push(I))}d.attr("aria-expanded","true");var G=t(window).height()/2-75;if(jQuery("body").hasClass("bb-is-mobile")?setTimeout(function(){var e=jQuery(window).height()>300?200:100;jQuery("html, body").animate({scrollTop:jQuery(L).offset().top-e},500)},500):t.scrollTo(a,500,{offset:-G,easing:"swing"}),t("#ac-form-"+n+" #ac-input-"+n).focus(),!_.isUndefined(BP_Nouveau.media)&&!_.isUndefined(BP_Nouveau.media.emoji)&&void 0===t("#ac-input-"+n).data("emojioneArea")){var R=t("#ac-input-"+n).html();t("#ac-input-"+n).emojioneArea({standalone:!0,hideSource:!1,container:"#ac-reply-emoji-button-"+n,autocomplete:!1,pickerPosition:"bottom",hidePickerOnBlur:!0,useInternalCDN:!1,events:{emojibtn_click:function(){t("#ac-input-"+n)[0].emojioneArea.hidePicker();var e=t("#ac-form-"+n+" #ac-input-"+n),a=e.html();k=t.trim(a.replace(/<div>/gi,"\n").replace(/<\/div>/gi,"")),k=k.replace(/&nbsp;/g," ");var i=e.text();""!==i||k.indexOf("emojioneemoji")>=0?e.closest("form").addClass("has-content"):e.closest("form").removeClass("has-content")},picker_show:function(){t(this.button[0]).closest(".post-emoji").addClass("active")},picker_hide:function(){t(this.button[0]).closest(".post-emoji").removeClass("active")}}}),d.hasClass("acomment-edit")&&!_.isNull(U)&&t("#ac-input-"+n).html(R)}if(void 0!==window.getSelection&&void 0!==document.createRange&&d.hasClass("acomment-edit")&&!_.isNull(U)){var V=document.createRange();V.selectNodeContents(t("#ac-input-"+n)[0]),V.collapse(!1);var S=window.getSelection();S.removeAllRanges(),S.addRange(V)}_.isUndefined(window.MediumEditor)||t("#ac-input-"+n).hasClass("medium-editor-element")||(window.activity_comment_editor=new window.MediumEditor(t("#ac-input-"+n)[0],{placeholder:!1,toolbar:!1,paste:{forcePlainText:!1,cleanPastedHTML:!1},keyboardCommands:!1,imageDragging:!1,anchorPreview:!1}))}if(d.hasClass("activity-state-no-comments")&&e.preventDefault(),d.hasClass("ac-reply-cancel")){var O=t(d).closest(".ac-form");O.slideUp(200),t(".acomment-reply").attr("aria-expanded","false"),p.destroyCommentMediaUploader(n),p.destroyCommentDocumentUploader(n),p.resetActivityCommentForm(O),e.preventDefault()}if("ac_form_submit"===d.prop("name")){var W,q;a=d.closest("form"),y=n,e.preventDefault(),d.closest("li").data("bp-activity-comment-id")&&(y=d.closest("li").data("bp-activity-comment-id")),W=t(a).find(".ac-input").first();for(var H=W.find("span.atwho-query"),K=0;K<H.length;K++)t(H[K]).replaceWith(H[K].innerText);W.find("img.emoji").each(function(e,a){t(a).addClass("emojioneemoji");var i=t(a).attr("alt");t(a).attr("data-emoji-char",i),t(a).removeClass("emoji")}),W.find("img.emojioneemoji").replaceWith(function(){return this.dataset.emojiChar}),d.addClass("loading").prop("disabled",!0),W.addClass("loading").prop("disabled",!0);var X=W[0].innerHTML.replace(/<div>/gi,"\n").replace(/<\/div>/gi,"");q={action:"new_activity_comment",_wpnonce_new_activity_comment:t("#_wpnonce_new_activity_comment").val(),comment_id:y,form_id:n,content:X},t("#_bp_as_nonce_"+n).val()&&(q["_bp_as_nonce_"+n]=t("#_bp_as_nonce_"+n).val()),this.dropzone_media.length&&(q.media=this.dropzone_media),this.dropzone_document.length&&(q.document=this.dropzone_document),this.dropzone_video.length&&(q.video=this.dropzone_video,_.isEmpty(q.content)&&(q.content="&#8203;")),_.isUndefined(this.models[n])||(i=this.models[n],q.gif_data=this.models[n].get("gif_data")),q.content=q.content.replace(/&nbsp;/g," "),a.hasClass("acomment-edit")&&(q.edit_comment=!0),o.ajax(q,"activity").done(function(e){if(d.removeClass("loading"),W.removeClass("loading"),t(".acomment-reply").attr("aria-expanded","false"),!1===e.success)a.append(t(e.data.feedback).hide().fadeIn(200));else{var o=a.parent(),r=t.trim(e.data.contents);if(a.fadeOut(200,function(){if(a.hasClass("acomment-edit")){var e=a.attr("data-item-id");a.closest(".activity-comments").append(a),t("li#acomment-"+e).replaceWith(r)}else 0===o.children("ul").length&&(o.hasClass("activity-comments")?o.prepend("<ul></ul>"):o.append("<ul></ul>")),o.children("ul").append(t(r).hide().fadeIn(200)),t(a).find(".ac-input").first().html(""),o.parent().addClass("has-comments"),o.parent().addClass("comments-loaded"),l.addClass("has-comments");var i=a.find(".ac-reply-content");i.find(".ac-reply-toolbar .ac-reply-media-button").length>0&&i.find(".ac-reply-toolbar .ac-reply-media-button").parents(".post-elements-buttons-item").removeClass("disable no-click"),i.find(".ac-reply-toolbar .ac-reply-document-button").length>0&&i.find(".ac-reply-toolbar .ac-reply-document-button").parents(".post-elements-buttons-item").removeClass("disable no-click"),i.find(".ac-reply-toolbar .ac-reply-video-button").length>0&&i.find(".ac-reply-toolbar .ac-reply-video-button").parents(".post-elements-buttons-item").removeClass("disable no-click"),i.find(".ac-reply-toolbar .ac-reply-gif-button").length>0&&(i.find(".ac-reply-toolbar .ac-reply-gif-button").removeClass("active "),i.find(".ac-reply-toolbar .ac-reply-gif-button").parents(".post-elements-buttons-item").removeClass("disable no-click")),jQuery(window).scroll()}),!a.hasClass("acomment-edit")){if(w=l.find("span.comments-count"),z=w.text().length?w.text().match(/\d+/)[0]:0,z=Number(z)+1,c.length){var m=z>1?BP_Nouveau.activity.strings.commentsLabel:BP_Nouveau.activity.strings.commentLabel;c.text(m.replace("%d",z||1))}N=t(s).find(".show-all a"),N&&N.html(BP_Nouveau.show_x_comments.replace("%d",z))}if(p.dropzone_media.length)for(var u=0;u<p.dropzone_media.length;u++)p.dropzone_media[u].saved=!0;if(p.dropzone_document.length)for(var v=0;v<p.dropzone_document.length;v++)p.dropzone_document[v].saved=!0;if(p.dropzone_video.length)for(var b=0;b<p.dropzone_video.length;b++)p.dropzone_video[b].saved=!0}_.isUndefined(i)||(i.set("gif_data",{}),t("#ac-reply-post-gif-"+n).find(".activity-attached-gif-container").removeAttr("style")),p.destroyCommentMediaUploader(n),p.destroyCommentDocumentUploader(n),p.destroyCommentVideoUploader(n),d.prop("disabled",!1),W.prop("disabled",!1)})}if(d.hasClass("edit")&&d.hasClass("edit-activity")){e.preventDefault();var $=s.data("bp-activity"),J=""!==s.data("link-url")?s.data("link-url"):null;void 0!==$&&(bp.Nouveau.Activity.postForm.displayEditActivityForm($,J),d.closest("li").hasClass("groups")?t("#bp-nouveau-activity-form").addClass("group-activity"):t("#bp-nouveau-activity-form").removeClass("group-activity"),void 0!==bp.Nouveau.Media&&void 0!==bp.Nouveau.Media.Theatre&&(bp.Nouveau.Media.Theatre.is_open_media||bp.Nouveau.Media.Theatre.is_open_document)&&(t(document).find(".bb-close-media-theatre").trigger("click"),t(document).find(".bb-close-document-theatre").trigger("click")))}if(d.hasClass("pin-activity")||d.hasClass("unpin-activity")){if(e.preventDefault(),!n)return e;d.closest(".activity-item").addClass("loading-pin");var Y="pin";d.hasClass("unpin-activity")&&(Y="unpin"),o.ajax({action:"activity_update_pinned_post",id:n,pin_action:Y},"activity").done(function(e){if(d.closest(".activity-item").removeClass("loading-pin"),"object"!=typeof e&&(e=JSON.parse(e)),void 0!==e.data&&void 0!==e.data.feedback){var a=d.closest("#activity-stream > ul"),i=d.closest("#activity-stream");if(e.success){var o=bp.Nouveau.getStorage("bp-activity","scope"),s=!1,n=!1,r="";if(d.closest("li.activity-item").hasClass("groups")&&(n=!0,r=d.closest("li.activity-item").attr("class").match(/group-\d+/),r=r[0].replace("group-","")),i.hasClass("single-user")?s=!1:i.hasClass("activity")&&"all"===o&&!n?s=!0:i.hasClass("single-group")&&(s=!0),"pin"===Y){s&&a.find("li.activity-item").removeClass("bb-pinned");var l="li.activity-item:not(.groups)";n&&!i.hasClass("single-group")?l="li.activity-item.group-"+r:n&&i.hasClass("single-group")&&(l="li.activity-item"),a.find(l).each(function(){var e=t(this).find(".unpin-activity");e.removeClass("unpin-activity").addClass("pin-activity"),n?e.find("span").html(BP_Nouveau.activity.strings.pinGroupPost):e.find("span").html(BP_Nouveau.activity.strings.pinPost)}),s&&d.closest("li.activity-item").addClass("bb-pinned"),d.addClass("unpin-activity"),d.removeClass("pin-activity"),d.closest("li.activity-item").hasClass("groups")?d.find("span").html(BP_Nouveau.activity.strings.unpinGroupPost):d.find("span").html(BP_Nouveau.activity.strings.unpinPost)}else"unpin"===Y&&(d.closest("li.activity-item").removeClass("bb-pinned"),d.addClass("pin-activity"),d.removeClass("unpin-activity"),d.closest("li.activity-item").hasClass("groups")?d.find("span").html(BP_Nouveau.activity.strings.pinGroupPost):d.find("span").html(BP_Nouveau.activity.strings.pinPost))}t(document).trigger("bb_trigger_toast_message",["","<div>"+e.data.feedback+"</div>","success",null,!0])}}).fail(function(){d.closest(".activity-item").removeClass("loading-pin"),t(document).trigger("bb_trigger_toast_message",["","<div>"+BP_Nouveau.activity.strings.pinPostError+"</div>","error",null,!0])})}(d.hasClass("activity-state-likes")||d.parents(".activity-state-likes").length>0)&&(e.preventDefault(),d.closest(".activity-content ").find(".activity-state-popup").addClass("active")),(d.hasClass("comment-reactions")||d.parents(".comment-reactions").length>0)&&(e.preventDefault(),d.closest(".acomment-display").find(".activity-state-popup").addClass("active"))},commentFormAction:function(e){var a,i;return e=e||window.event,e.target?a=e.target:e.srcElement&&(a=e.srcElement),3===a.nodeType&&(a=a.parentNode),!0===e.altKey||!0===e.metaKey?e:"TEXTAREA"===a.tagName&&t(a).hasClass("ac-input")?(i=e.keyCode?e.keyCode:e.which,void(27===i&&!1===e.ctrlKey?"TEXTAREA"===a.tagName&&t(a).closest("form").slideUp(200):e.ctrlKey&&13===i&&t(a).val()&&t(a).closest("form").find("[type=submit]").first().trigger("click"))):e},togglePopupDropdown:function(e){var a;return e=e||window.event,e.target?a=e.target:e.srcElement&&(a=e.srcElement),3===a.nodeType&&(a=a.parentNode),!0===e.altKey||!0===e.metaKey?e:t(a).hasClass("privacy-wrap")||t(a).parent().hasClass("privacy-wrap")?e:void t("ul.activity-privacy").removeClass("bb-open")},loadMoreActivities:function(){var e=t(".load-more:visible").last(),a=t(window);if(e.closest(".activity-list").length&&e.get(0)&&!e.data("bp-autoloaded")){var i=e.offset(),o=i.top-50;a.scrollTop()+a.height()>o&&(e.data("bp-autoloaded",1),e.find("a").text(BP_Nouveau.activity.strings.loadingMore),e.find("a").trigger("click"))}},destroyCommentMediaUploader:function(e){var a=this
