<script type="text/html" id="tmpl-whats-new-toolbar">
	...
	<?php endif; ?>
	<?php if ( bp_is_active( 'media' ) && bp_media_user_can_upload( bp_loggedin_user_id(), ( bp_is_active( 'groups' ) ? bp_get_current_group_id() : 0 ) ) ) : ?>
	...
	if ( bp_is_active( 'media' ) && ! empty( $extensions ) && bp_document_user_can_upload( bp_loggedin_user_id(), ( bp_is_active( 'groups' ) ? bp_get_current_group_id() : 0 ) ) ) :
		?>
