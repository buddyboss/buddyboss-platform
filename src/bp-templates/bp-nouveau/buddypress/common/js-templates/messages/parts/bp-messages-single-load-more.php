<?php
/**
 * BP Nouveau messages single load more template
 *
 * This template can be overridden by copying it to yourtheme/buddypress/messages/parts/bp-messages-single-load-more.php.
 *
 * @since   1.0.0
 * @version 1.0.0
 */
