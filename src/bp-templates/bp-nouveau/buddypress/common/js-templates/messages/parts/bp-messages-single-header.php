<script type="text/html" id="tmpl-bp-messages-single-header">
	...
	<header class="single-message-thread-header">
		...
		<div class="actions">
			<button type="button" class="message-action-delete bp-icons" data-bp-action="delete" data-bp-tooltip-pos="up" data-bp-tooltip="<?php esc_attr_e( 'Delete conversation', 'buddyboss' ); ?>">
