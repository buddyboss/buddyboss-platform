        ...
        <dl class="thread-participants">
            <dt>
                ...
                <span class="participants-name">
							...
							<# } else { #><a
                            href="{{other_recipients[i].user_link}}">{{other_recipients[i].user_name}}</a><# } #><# if ( i != other_recipients.length -1 || ( i == other_recipients.length -1 ) && data.toOthers ) { #><?php _e( ',', 'buddyboss' ); ?><# } #>
		                </span>
                <# } #>
			...
			if ( bp_current_user_can( 'bp_moderate' ) ) {
                ...
                <div class="message_actions">
                    ...
                    <div class="message_action__list">
                        <ul>
                            <li class="unread"><a data-bp-action="unread"
                                                  href="#"><?php esc_html_e( 'Mark unread', 'buddyboss' ); ?></a></li>
