 ...
 *
 * The "show in the Type filter" and "hide from Members Directory" settings are
 * resolved per language rather than matched with a meta_query, so a translated
 * profile type is offered according to its own settings.
 */
