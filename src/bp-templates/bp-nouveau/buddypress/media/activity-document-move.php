...
<div class="bp-media-move-file" id="<?php echo 'bp-media-move-file'.bp_get_media_attachment_id();?>" style="display: none;">
                ...
                <div id="boss-media-create-album-popup" class="modal-container">
                    ...
                    <footer class="bb-model-footer">
                        <?php if ( ! bp_is_group() ) : 
	                        ...
	                        ?>
                        <?php endif; ?>
                        <a class="button" id="bp-media-create-album-submit" href="#"><?php _e( 'Move', 'buddyboss' ); ?></a>
                    </footer>
