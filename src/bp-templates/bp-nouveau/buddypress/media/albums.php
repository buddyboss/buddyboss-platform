...
<?php if ( ( bp_is_my_profile() || ( bp_is_group() && groups_can_user_manage_albums( bp_loggedin_user_id(), bp_get_current_group_id() ) ) ) && apply_filters( 'bp_user_can_create_media', true ) ) : ?>
