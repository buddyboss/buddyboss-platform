...
echo $media_template->media->attachment_data->meta['width'] > $media_template->media->attachment_data->meta['height'] ? 'bb-horizontal-layout' : '';
echo $media_template->media->attachment_data->meta['height'] > $media_template->media->attachment_data->meta['width'] || $media_template->media->attachment_data->meta['width'] === $media_template->media->attachment_data->meta['height'] ? 'bb-vertical-layout' : '';
?>
">
	<a href="#"
