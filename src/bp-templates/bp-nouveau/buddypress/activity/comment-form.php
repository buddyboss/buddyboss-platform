...
<form action="<?php bp_activity_comment_form_action(); ?>" method="post" id="ac-form-<?php bp_activity_id(); ?>" class="ac-form not-initialized"<?php bp_activity_comment_form_nojs_display(); ?>>
	...
	<div class="bp-ac-form-cotainer">
		...
		<div class="ac-reply-content">
			<div class="ac-textarea">
				...
				<div contenteditable="true" id="ac-input-<?php bp_activity_id(); ?>" class="ac-input bp-suggestions" name="ac_input_<?php bp_activity_id(); ?>" data-placeholder="<?php esc_attr_e( 'Write a comment...', 'buddyboss' ); ?>"></div>
