	...
	<div class="bp-ac-form-container">
		...
		<div class="ac-reply-content">
			<div class="ac-textarea">
				...
				<div contenteditable="true" id="ac-input-<?php echo esc_attr( $activity_id ); ?>" class="ac-input bp-suggestions" name="ac_input_<?php echo esc_attr( $activity_id ); ?>" data-placeholder="<?php esc_attr_e( 'Write a comment...', 'buddyboss-platform' ); ?>" <?php echo bp_is_group() ? 'data-suggestions-group-id="' . esc_attr( bp_get_current_group_id() ) . '"' : ''; ?>></div>
					...
					<div id="ac-reply-toolbar-<?php echo esc_attr( $activity_id ); ?>" class="ac-reply-toolbar">
						...
						if ( bp_is_active( 'media' ) ) :
							...
							<div class="post-elements-buttons-item post-media media-support">
								<a href="#" id="ac-reply-media-button-<?php echo esc_attr( $activity_id ); ?>" class="toolbar-button bp-tooltip ac-reply-media-button" data-bp-tooltip-pos="up" data-bp-tooltip="<?php esc_attr_e( 'Attach photo', 'buddyboss-platform' ); ?>" data-ac-id="<?php echo esc_attr( $activity_id ); ?>" aria-label="<?php esc_attr_e( 'Attach photo', 'buddyboss-platform' ); ?>">
							...
							<div class="post-elements-buttons-item post-gif">
								<div class="gif-media-search">
									<a href="#" id="ac-reply-gif-button-<?php echo esc_attr( $activity_id ); ?>" class="toolbar-button bp-tooltip ac-reply-gif-button" data-bp-tooltip-pos="up" data-bp-tooltip="<?php esc_attr_e( 'Choose a GIF', 'buddyboss-platform' ); ?>" aria-label="<?php esc_attr_e( 'Choose a GIF', 'buddyboss-platform' ); ?>">
							...
							<div class="post-elements-buttons-item post-emoji bp-tooltip" data-bp-tooltip-pos="up" data-bp-tooltip="<?php esc_attr_e( 'Emoji', 'buddyboss-platform' ); ?>" id="ac-reply-emoji-button-<?php echo esc_attr( $activity_id ); ?>"></div>
						...
						<div class="dz-preview">
							...
							<div class="dz-error-mark">
								<svg width="54px" height="54px" viewBox="0 0 54 54" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
									<title><?php esc_html_e( 'Error', 'buddyboss-platform' ); ?></title>
					...
					<div class="ac-reply-post-video-template" style="display:none;">
						<div class="dz-preview dz-file-preview well" id="dz-preview-template">
							...
							<div class="dz-success-mark">
								<svg width="54px" height="54px" viewBox="0 0 54 54" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
									<title><?php esc_html_e( 'Check', 'buddyboss-platform' ); ?></title>
									<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
