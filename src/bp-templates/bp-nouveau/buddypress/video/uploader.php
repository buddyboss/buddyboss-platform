            ...
            <div class="modal-wrapper">
                <div class="modal-container">
                    ...
                    <header class="bb-model-header">
                        <a href="#" class="bp-video-upload-tab selected" data-content="bp-dropzone-content" id="bp-video-uploader-modal-title"><?php _e( 'Upload', 'buddyboss' ); ?></a>

                        <?php if ( bp_is_single_album() ) : ?>
                            <a href="#" class="bp-video-upload-tab" data-content="bp-existing-video-content" id="bp-video-select-from-existing"><?php _e( 'Select Videos', 'buddyboss' ); ?></a>
                        <?php endif; ?>
                    ...
                    <div class="bb-dropzone-wrap bp-video-upload-tab-content" id="bp-dropzone-content">
                        <?php if ( bp_is_active('forums') && ! bbp_is_single_forum() && ! bbp_is_single_topic() && ! bp_is_messages_component() && bp_is_active( 'activity' ) ) : ?>
							<div class="video-uploader-post-content">
								<textarea name="bp-video-post-content" id="bp-video-post-content" placeholder="<?php bp_is_group() ? _e( 'Write something about your videos, to be shown on the group feed', 'buddyboss' ) : _e( 'Write something about your videos, to be shown on your timeline', 'buddyboss' ); ?>"></textarea>
							</div>
                        <?php endif; ?>
                    ...
                    <footer class="bb-model-footer flex align-items-center">
                        ...
                        <a class="button push-right" id="bp-video-submit" style="display: none;" href="#"><?php _e( 'Done', 'buddyboss' ); ?></a>
                    </footer>
