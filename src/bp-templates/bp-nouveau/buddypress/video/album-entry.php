	...
	<div class="bb-album-cover-wrap">
		<a class="bs-cover-wrap" href="<?php bp_video_album_link(); ?>">
			...
			<div class="bb-album-content-wrap">
				...
				<span><?php echo bp_core_format_date( $video_album_template->album->date_created ); // phpcs:ignore ?></span> <span>&middot;</span> <span><?php printf( _n( '%s video', '%s videos', $video_album_template->album->video['total'], 'buddyboss' ), number_format_i18n( $video_album_template->album->video['total'] ) ); ?></span>
			</div>
		</a>
	</div>
</li>
