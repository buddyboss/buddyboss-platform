        ...
        <div class="video-action-wrap item-action-wrap">
            ...
            <div class="video-action_list item-action_list">
                <ul>
					<!--
                    <li class="edit_video">
                        <a href="#" data-action="video" data-video-id="<?php /*bp_video_id(); */?>" data-parent-activity-id="<?php /*bp_video_parent_activity_id(); */?>" data-item-activity-id="<?php /*bp_video_activity_id(); */?>" data-type="<?php /*echo esc_attr( $move_type ); */?>" id="<?php /*echo esc_attr( $move_id ); */?>" class="ac-video-edit"><?php /*esc_html_e( 'Edit', 'buddyboss' ); */?></a>
                    </li>
-->
                    <li class="move_video">
                    ...
                    <li class="delete_file">
                        <a class="video-file-delete" data-video-id="<?php bp_video_id(); ?>" data-parent-activity-id="<?php bp_video_parent_activity_id(); ?>" data-item-activity-id="<?php bp_video_activity_id(); ?>" data-item-from="media" data-item-id="<?php bp_video_id(); ?>" data-type="video" href="#"><?php esc_html_e( 'Delete', 'buddyboss' ); ?></a>
                    </li>
