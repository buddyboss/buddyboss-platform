...
if ( is_user_logged_in() && ! empty( $active_extensions ) && ( bp_is_my_profile() || ( bp_is_active( 'groups' ) && bp_is_group() && groups_can_user_manage_document( bp_loggedin_user_id(), bp_get_current_group_id() ) ) ) && apply_filters( 'bp_user_can_create_document', true ) ) : ?>
