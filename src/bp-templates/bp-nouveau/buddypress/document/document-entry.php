...
?>
<div class="media-folder_items <?php echo $listing_class; ?>" data-activity-id="<?php bp_document_activity_id(); ?>"
    ...
    <div class="media-folder_details">
		...
		<?php if ( $attachment_id ) {
           ...
           data-text-preview="<?php echo $text_attachment_url ? $text_attachment_url : ''; ?>">
            ...
            <i class="media-document-id" data-item-id="<?php echo base64_encode( bp_get_document_id() ); ?>"
               style="display: none;"></i>
            <i class="media-document-attachment-id"
               data-item-id="<?php echo base64_encode( bp_get_document_attachment_id() ); ?>"
               style="display: none;"></i>
        ...
        <div class="media-folder_action__list">
            <ul>
				...
				if ( $attachment_id && $can_download_btn ) { ?>
                    <li class="download_file"><a
                                href="<?php echo esc_url( $link ); ?>"><?php esc_html_e( 'Download', 'buddyboss' ); ?></a>
                    </li>
                    <li class="copy_download_file_url"><a
                                href="<?php echo esc_url( $link ); ?>"><?php esc_html_e( 'Copy Download Link', 'buddyboss' ); ?></a>
                    </li>
					<?php
				}
				if ( $can_manage_btn ) {
					?>
                    <li class="rename_file"><a href="#" data-type="<?php echo esc_attr( $type ); ?>"
                                               class="ac-document-rename"><?php esc_html_e( 'Rename', 'buddyboss' ); ?></a>
                    </li>
                    <li class="move_file"><a href="#"
                                             class="<?php echo $move_class; ?>"><?php esc_html_e( 'Move', 'buddyboss' ); ?></a>
                    </li>
					<?php
					...
					?>
                    <li class="delete_file"><a class="document-file-delete"
                                               ...
                                               href="#"><?php esc_html_e( 'Delete', 'buddyboss' ); ?></a></li>
					<?php
				}
				?>
            </ul>
