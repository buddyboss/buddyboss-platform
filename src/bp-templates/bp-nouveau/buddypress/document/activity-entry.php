...
<div class="bb-activity-media-elem document-activity <?php esc_attr_e( $document_id ); ?> <?php echo wp_is_mobile() ? 'is-mobile' : ''; ?>" data-id="<?php esc_attr_e( $document_id ); ?>" data-parent-id="<?php bp_document_parent_id(); ?>" >
	...
	<div class="document-description-wrap">
		<a
				...
				data-id="<?php esc_attr_e( $document_id ); ?>"
				data-attachment-full=""
				data-attachment-id="<?php echo esc_attr( $attachment_id ); ?>"
				data-privacy="<?php esc_attr_e( $db_privacy ); ?>"
				data-extension="<?php echo $extension ? esc_attr( $extension ) : ''; ?>"
				data-parent-activity-id="<?php esc_attr_e( $doc_parent_activity_id ); ?>"
				data-activity-id="<?php esc_attr_e( $doc_activity_id ); ?>"
				data-author="<?php esc_attr_e( $doc_user_id ); ?>"
				...
				data-album-id="<?php esc_attr_e( $doc_folder_id ); ?>"
				data-group-id="<?php esc_attr_e( $doc_group_id ); ?>"
