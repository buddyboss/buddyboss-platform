                ...
                <div class="modal-container">
                    ...
                    <div class="bb-dropzone-wrap bp-media-upload-tab-content" id="bp-dropzone-content">
                        ...
                        <div class="media-uploader-post-content">
                            <textarea name="bp-media-post-content" id="bp-media-post-content" placeholder="<?php bp_is_group() ? _e( 'Write something about your documents, to be shown on the group feed', 'buddyboss' ) : _e( 'Write something about your photos, to be shown on your timeline', 'buddyboss' ); ?>"></textarea>
                        </div>
                        <?php endif; ?>
	                ...
	                <?php if ( bp_is_single_album() ) : ?>
                        <div class="bp-existing-media-wrap bp-media-upload-tab-content" id="bp-existing-media-content" style="display: none;">
                            ...
                            <?php else : ?>
                                ...
                                <?php bp_nouveau_user_feedback( 'document-loop-none' ); ?>
                    ...
                    <footer class="flex align-items-center bb-model-footer">
                        <a class="button outline" id="bp-media-add-more" style="display: none;" href="#">+ <?php _e( 'Add more photos', 'buddyboss' ); ?></a>
