...
<li class="lg-grid-1-5 md-grid-1-3 sm-grid-1-3" data-id="<?php echo esc_attr( $document_id ); ?>" data-date-created="<?php bp_document_date_created(); ?>">
	<div class="bb-photo-thumb">
		...
		<?php if ( bp_is_my_profile() || ( bp_is_group() && ( ( bp_is_group_media() && groups_can_user_manage_media( $loggedin_user_id, bp_get_current_group_id() ) ) || ( bp_is_group_albums() && groups_can_user_manage_albums( $loggedin_user_id, bp_get_current_group_id() ) ) ) ) ) : ?>
