...
<li class="lg-grid-1-5 md-grid-1-3 sm-grid-1-3" data-id="<?php bp_document_id(); ?>" data-date-created="<?php bp_document_date_created(); ?>">
	<div class="bb-photo-thumb">
		<a class="bb-open-media-theatre bb-photo-cover-wrap" data-id="<?php bp_document_id(); ?>" data-attachment-full="<?php bp_document_attachment_image(); ?>" data-activity-id="<?php bp_document_activity_id(); ?>" href="#">
