...
<div class="document-action-wrap">
	<a href="#" class="document-action_collapse" data-balloon-pos="down" data-balloon="<?php esc_attr_e( 'Collapse', 'buddyboss' ); ?>"><i class="bb-icon-arrow-up bb-icons-l document-icon-collapse"></i></a>
