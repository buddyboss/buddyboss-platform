...
<div class="document-action-wrap">
	<a href="#" class="document-action_collapse" data-balloon-pos="up" data-balloon="<?php esc_attr_e( 'Collapse', 'buddyboss' ); ?>"><i class="bb-icon-merge bb-icon-l document-icon-collapse"></i></a>
