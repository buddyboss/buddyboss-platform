...
?>
    ...
    <form action="" name="signup_form" id="signup-form" class="standard-form signup-form clearfix" method="post"
        ...
        <div class="layout-wrap">
			...
			<?php if ( bp_get_blog_signup_allowed() ) : ?>
                ...
                <div class="register-section blog-details" id="blog-details-section">
                    ...
                    <p>
                        <input type="checkbox" name="signup_with_blog" id="signup_with_blog" class="bs-styled-checkbox"
                               value="1" <?php checked( (int) bp_get_signup_with_blog_value(), 1 ); ?> />
		...
		<?php } // request-details signup step ?>
