	...
	if ( false === bb_enabled_legacy_email_preference() && ( $is_web_enabled || $is_app_enabled ) ) {
		...
		<div class="notification_info">
			...
			<div class="notification_type email_notification">
				<span class="notification_type_icon" aria-label="<?php esc_html_e( 'Email', 'buddyboss' ); ?>">
			...
			<div class="notification_type web_notification">
				<span class="notification_type_icon" aria-label="<?php esc_html_e( 'Web', 'buddyboss' ); ?>">
			...
			<div class="notification_type app_notification">
				<span class="notification_type_icon" aria-label="<?php esc_html_e( 'App', 'buddyboss' ); ?>">
