...
switch ( bp_current_action() ) :
	...
	case 'my-friends':
		...
		?>
		<div class="members friends" data-bp-list="members" data-ajax="<?php echo ( $is_send_ajax_request ) ? 'true' : 'false'; ?>">
			<?php
	...
	case 'mutual':
		bp_nouveau_member_hook( 'before', 'friends_content' );
		?>
		<div class="members mutual-friends" data-bp-list="members" data-ajax="<?php echo ( $is_send_ajax_request ) ? 'true' : 'false'; ?>">
			<?php
			if ( $is_send_ajax_request ) {
				echo '<div id="bp-ajax-loader">';
