...
<script id="tmpl-bp-avatar-webcam" type="text/html">
	<# if ( ! data.user_media ) { #>
		<div id="bp-webcam-message">
			<p class="warning"><?php esc_html_e( 'Your browser does not support this feature.', 'buddyboss-platform' ); ?></p>
		</div>
	<# } else { #>
		...
		<div class="avatar-crop-management">
			...
			<div id="avatar-crop-actions">
				<button type="button" class="button avatar-webcam-capture"><?php esc_html_e( 'Capture', 'buddyboss-platform' ); ?></button>
				<button type="button" class="button avatar-webcam-save"><?php esc_html_e( 'Save', 'buddyboss-platform' ); ?></button>
			</div>
		</div>
	<# } #>
</script>
