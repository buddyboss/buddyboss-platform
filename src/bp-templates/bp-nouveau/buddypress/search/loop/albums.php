		...
		<div class="item">
			...
			<div class="media-album_items ac-album-list">
				...
				<div class="media-album_details">
					...
					<span class="media-photo_count"><?php printf( _n( '%s photo', '%s photos', $media_album_template->album->media['total'], 'buddyboss' ), number_format_i18n( $media_album_template->album->media['total'] ) ); ?></span>
				</div>
