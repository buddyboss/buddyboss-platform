		...
		<div class="media-folder_items ac-folder-list">
			...
			<div class="media-folder_modified">
				<div class="media-folder_details__bottom">
					<span class="media-folder_author"><?php esc_html_e( 'By ', 'buddyboss-platform' ); ?><a href="<?php echo trailingslashit( bp_core_get_user_domain( bp_get_document_folder_user_id() ) . bp_get_document_slug() ); ?>" data-bb-hp-profile="<?php echo esc_attr( bp_get_document_folder_user_id() ); ?>"><?php bp_folder_author(); ?></a></span>
