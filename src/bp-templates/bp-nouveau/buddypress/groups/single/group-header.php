					...
					if ( 0 !== $parent_id ) {
						...
						<div class="bp-group-parent-wrap flex align-items-center">
							...
							<div class="bp-parent-group-title-wrap">
								<a class="bp-parent-group-title" href="<?php echo esc_url( bp_get_group_permalink( groups_get_group( $parent_id ) ) ); ?>"><?php echo esc_attr( bp_get_group_name( groups_get_group( $parent_id ) ) ); ?></a>
