 ...
 */
function bb_nouveau_ajax_recipient_list_for_blocks() {
	$post_data = filter_input( INPUT_POST, 'post_data', FILTER_REQUIRE_ARRAY );
	$post_data = bb_filter_input_string( INPUT_POST, 'post_data' );
	...
	if ( isset( $post_data['member_action'] ) ) {
		$member_action = bb_filter_input_string( $post_data['member_action'] );
	}
