...
function bp_nouveau_messages_localize_scripts( $params = array() ) {
	...
	$params['messages'] = array(
		...
		'doingAction'                => array(
			'read'        => __( 'Marking conversation as read. Please wait.', 'buddyboss' ),
			'unread'      => __( 'Marking conversation as unread. Please wait.', 'buddyboss' ),
			...
			'hide_thread' => __( 'Hiding conversation. Please wait.', 'buddyboss' ),
		),
