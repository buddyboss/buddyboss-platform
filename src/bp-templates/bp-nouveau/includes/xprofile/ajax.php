...
function bp_nouveau_ajax_xprofile_get_field() {
	...
	$existing_fields           = filter_input( INPUT_GET, 'fields', FILTER_UNSAFE_RAW );
	$existing_fields_exclude   = filter_input( INPUT_GET, 'fields', FILTER_UNSAFE_RAW );
	$existing_fields_fixed_ids = filter_input( INPUT_GET, 'fixedIds', FILTER_UNSAFE_RAW );
	$prevId                    = filter_input( INPUT_GET, 'prevId', FILTER_UNSAFE_RAW );
