...
function bb_nouveau_activity_entry_bubble_buttons( $args = array() ) {
	...
	$output = sprintf( '<span class="bb-activity-more-options-action" data-balloon-pos="up" data-balloon="%s"><i class="bb-icon bb-icon-menu-dots-h"></i></span><div class="bb-activity-more-options">%s</div><div class="bb-activity-more-options_overlay"></div>', esc_html__( 'More Options', 'buddyboss' ), $output );
