...
function bp_nouveau_signup_form( $section = 'account_details' ) {
	...
	bp_nouveau_get_signup_form_html( $fields, $section );
...
/**
 * Function to get the signup form HTML.
 *
 * @since BuddyBoss X.X.X
 *
 * @param array  $fields  Signup fields array.
 * @param string $section Signup field section.
 */
function bp_nouveau_get_signup_form_html( $fields, $section ) {
