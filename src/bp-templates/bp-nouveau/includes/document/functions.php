...
function bp_nouveau_document_localize_scripts( $params = array() ) {
	...
	$document_params = array(
		...
		'document_dict_file_exceeded'     => sprintf( __( 'You are only allowed to upload %s documents at a time.', 'buddyboss' ), bp_core_number_format( bp_media_allowed_upload_document_per_batch() ) ),
