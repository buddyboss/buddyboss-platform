...
function bp_nouveau_ajax_document_update_file_name() {
	...
	$title                  = filter_input( INPUT_POST, 'name', FILTER_UNSAFE_RAW );
	$type                   = filter_input( INPUT_POST, 'document_type', FILTER_UNSAFE_RAW );
...
function bp_nouveau_ajax_document_save_privacy() {
	...
	$type    = filter_input( INPUT_POST, 'type', FILTER_UNSAFE_RAW );
	$privacy = filter_input( INPUT_POST, 'value', FILTER_UNSAFE_RAW );
