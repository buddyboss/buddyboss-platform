...
function bp_nouveau_ajax_video_save() {
	...
	$privacy = filter_input( INPUT_POST, 'privacy', FILTER_UNSAFE_RAW );
...
function bp_nouveau_ajax_video_delete() {
	...
	$from_where  = filter_input( INPUT_POST, 'from_where', FILTER_UNSAFE_RAW );
...
function bp_nouveau_ajax_video_get_activity() {
	...
	$reset_comment = filter_input( INPUT_POST, 'reset_comment', FILTER_UNSAFE_RAW );
...
function bp_nouveau_object_template_results_albums_existing_video_query( $querystring ) {
	...
	$caller = filter_input( INPUT_POST, 'caller', FILTER_UNSAFE_RAW );
