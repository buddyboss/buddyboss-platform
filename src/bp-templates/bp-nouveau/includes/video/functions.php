...
function bp_nouveau_video_localize_scripts( $params = array() ) {
	...
	$params['video'] = array(
		...
		'dropzone_video_message'             => sprintf( '<strong>%s</strong> %s', esc_html__( 'Add Videos', 'buddyboss-platform' ), esc_html__( 'Or drag and drop', 'buddyboss-platform' ) ),
		'dropzone_video_thumbnail_message'   => __( 'Upload thumbnail', 'buddyboss-platform' ),
		'video_select_error'                 => __( 'This file type is not supported for video uploads.', 'buddyboss-platform' ),
		'empty_video_type'                   => __( 'Empty video file will not be uploaded.', 'buddyboss-platform' ),
		'invalid_video_type'                 => __( 'Unable to upload the file', 'buddyboss-platform' ),
		'video_size_error_header'            => __( 'File too large ', 'buddyboss-platform' ),
		'video_size_error_description'       => __( 'This file type is too large.', 'buddyboss-platform' ),
		...
		'cover_video_size_error_header'      => __( 'Unable to reposition the image ', 'buddyboss-platform' ),
		'cover_video_size_error_description' => __( 'To reposition your cover video, please upload a larger image and then try again.', 'buddyboss-platform' ),
		'current_album'                      => $album_id,
		'current_type'                       => $type,
		'move_to_id_popup'                   => $move_to_id_popup,
		'video_dict_file_exceeded'           => sprintf( /* translators: 1: per batch */ __( 'You are allowed to upload only %s videos at a time.', 'buddyboss-platform' ), bp_core_number_format( bp_video_allowed_upload_video_per_batch() ) ),
		'thumb_dict_file_exceeded'           => __( 'You are allowed to upload only 1 thumb at a time.', 'buddyboss-platform' ),
		'dictInvalidFileType'                => __( 'Please upload only the following file types: ', 'buddyboss-platform' ) . '<br /><div class="bb-allowed-file-types">' . implode( ', ', array_unique( $allowed ) ) . '</div>',
		'is_ffmpeg_installed'                => bb_video_is_ffmpeg_installed(),
	...
	$params['video']['i18n_strings'] = array(
		...
		'no_videos_found'         => __( 'Sorry, no videos were found', 'buddyboss-platform' ),
		'upload'                  => __( 'Upload', 'buddyboss-platform' ),
		'upload_thumb'            => __( 'Change Thumbnail', 'buddyboss-platform' ),
		'uploading'               => __( 'Uploading', 'buddyboss-platform' ),
		'upload_status'           => __( '%1$d out of %2$d uploaded', 'buddyboss-platform' ), // phpcs:ignore
		'album_delete_confirm'    => __( 'Are you sure you want to delete this album? Videos in this album will also be deleted.', 'buddyboss-platform' ),
		'album_delete_error'      => __( 'There was a problem deleting the album.', 'buddyboss-platform' ),
		'video_delete_confirm'    => __( 'Are you sure you want to delete this video?', 'buddyboss-platform' ),
		'video_enlarge_text'      => __( 'Enlarge', 'buddyboss-platform' ),
		'video_fullscreen_text'   => __( 'Full screen', 'buddyboss-platform' ),
		'video_play_text'         => __( 'Play', 'buddyboss-platform' ),
		'video_pause_text'        => __( 'Pause', 'buddyboss-platform' ),
		'video_uploaded_text'     => __( 'Uploaded', 'buddyboss-platform' ),
		'video_volume_text'       => __( 'Volume', 'buddyboss-platform' ),
		'video_miniplayer_text'   => __( 'Miniplayer', 'buddyboss-platform' ),
		'video_speed_text'        => __( 'Speed', 'buddyboss-platform' ),
		'video_skip_back_text'    => __( 'Step Back (5)', 'buddyboss-platform' ),
		'video_skip_forward_text' => __( 'Step Forward (5)', 'buddyboss-platform' ),
		'video_picture_in_text'   => __( 'This video is playing in the miniplayer.', 'buddyboss-platform' ),
	);
...
function bp_nouveau_get_video_directory_nav_items() {
	...
	$nav_items['all'] = array(
		...
		'text'      => __( 'All Videos', 'buddyboss-platform' ),
		'count'     => false,
		'position'  => 5,
	);
	...
	if ( is_user_logged_in() && bp_is_profile_video_support_enabled() ) {
		$nav_items['personal'] = array(
			...
			'text'      => __( 'My Videos', 'buddyboss-platform' ),
			'count'     => false,
			'position'  => 15,
		);
	}
