...
?>
<div class="bb-rl-media-model-wrapper bb-rl-internal-model media media-theatre" style="display: none;" id="buddypress">
	...
	<div id="bb-rl-media-model-container" class="bb-rl-media-model-container">
		<div class="bb-rl-media-model-inner">
			<div class="bb-rl-media-section">
				<a class="theater-command bb-rl-prev-media" href="#previous">
				...
				<a class="theater-command bb-rl-next-media" href="#next">
					<svg xmlns="http://www.w3.org/2000/svg" width="16" height="30">
