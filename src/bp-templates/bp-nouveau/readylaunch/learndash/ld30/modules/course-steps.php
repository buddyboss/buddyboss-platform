...
// Debug: ReadyLaunch course-steps template is being used
echo '<!-- ReadyLaunch LearnDash course-steps template loaded -->';
...
?>
	...
	<div class="ld-content-actions 111">
		...
		if ( $parent_id && 'focus' !== $context ) :
			if ( $learndash_maybe_show_next_step_link ) :
				?>
				<div class="ld-content-action 222">
					<?php
