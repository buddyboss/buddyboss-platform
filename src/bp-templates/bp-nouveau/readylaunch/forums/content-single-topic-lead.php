...
<div class="bb-rl-topic-header">
	...
	<div class="bb-rl-topic-started-in">
		...
		printf( '<a href="%1$s">%2$s%3$s</a>', esc_url( bbp_get_forum_permalink( bbp_get_topic_forum_id() ) ), wp_kses_post( $group_avatar ), esc_html( bbp_get_forum_title( bbp_get_topic_forum_id() ) ) );
		?>
	</div>
