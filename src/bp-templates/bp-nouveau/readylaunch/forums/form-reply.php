		...
		<form id="new-post" class="bb-rl-forum-form" name="new-post" method="post" action="<?php bbp_is_reply_edit() ? bbp_reply_edit_url() : the_permalink(); ?>">
			...
			<fieldset class="bbp-form">
				<div class="bb-rl-forum-modal-header">
					<?php if ( ! bbp_is_reply_edit() ) : ?>
						<h3><?php esc_html_e( 'Replying to', 'buddyboss-platform' ); ?></h3>
					<?php else : ?>
						<h3><?php esc_html_e( 'Edit reply', 'buddyboss-platform' ); ?></h3>
					<?php endif; ?>
					...
					<?php if ( ! bbp_is_reply_edit() ) : ?>
						<div class="bb-rl-reply-header">
							<div class="bb-rl-reply-header-avatar">
								<img class="bb-rl-avatar" alt="<?php esc_attr_e( 'Reply author avatar', 'buddyboss-platform' ); ?>" />
							</div>
				...
				<div class="bb-rl-forum-modal-footer">
					...
					<div class="bbp-submit-wrapper">
						...
						<button type="button" tabindex="<?php bbp_tab_index(); ?>" id="bb_reply_discard_draft" name="bb_reply_discard_draft" class="bb-rl-button bb-rl-button--tertiaryText bb-rl-button--small discard small bb_discard_topic_reply_draft"><?php esc_html_e( 'Discard Draft', 'buddyboss-platform' ); ?></button>

						<button type="submit" tabindex="<?php bbp_tab_index(); ?>" id="bbp_reply_submit" name="bbp_reply_submit" class="bb-rl-button bb-rl-button--brandFill bb-rl-button--small submit"><?php esc_html_e( 'Post', 'buddyboss-platform' ); ?></button>
