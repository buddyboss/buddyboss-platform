		...
		<form id="new-post" name="new-post" method="post" action="<?php bbp_is_topic_edit() ? bbp_topic_edit_url() : the_permalink(); ?>">
			...
			<fieldset class="bbp-form">
				<header class="bb-rl-forum-modal-header">
					...
					<h3>
						<?php if ( bbp_is_topic_edit() ) {
							_e( 'Edit Discussion', 'buddyboss' );
						} else {
							_e( 'Start a new discussion', 'buddyboss' );
						} ?>
					</h3>
					...
					<?php if ( current_user_can( 'moderate' ) ) : ?>
						...
						<div class="bb-rl-forum-modal-type">
							...
							<label for="bbp_stick_topic" class="screen-reader-text"><?php _e( 'Type:', 'buddyboss' ); ?></label>
					...
					<button type="button" class="bb-rl-forum-modal-close">
						<span class="screen-reader-text"><?php _e( 'Close Modal', 'buddyboss' ); ?></span>
				...
				<div class="bb-rl-forum-modal-content">
					...
					<div class="bb-rl-forum-modal-title">
						<label for="bbp_topic_title" class="screen-reader-text"><?php _e( 'Discussion Title', 'buddyboss' ); ?></label>
						<input type="text" id="bbp_topic_title" placeholder="<?php _e( 'Title', 'buddyboss' ); ?>" value="<?php bbp_form_topic_title(); ?>" tabindex="<?php bbp_tab_index(); ?>" size="40" name="bbp_topic_title" maxlength="<?php bbp_title_max_length(); ?>" />
					</div>
					...
					<?php if ( bbp_allow_topic_tags() && current_user_can( 'assign_topic_tags' ) ) : ?>
						...
						<p class="bb-rl-forum-tags">
							...
							<select name="bbp_topic_tags_dropdown[]" class="bbp_topic_tags_dropdown" id="bbp_topic_tags_dropdown" placeholder="<?php esc_html_e( 'Enter tags, separated by commas (optional)', 'buddyboss' ); ?>" autocomplete="off" multiple="multiple" style="width: 100%" tabindex="<?php bbp_tab_index(); ?>">
								<?php
				...
				<div class="bb-rl-forum-modal-footer">
					...
					<div class="bbp-submit-wrapper">
						...
						<button type="submit" tabindex="<?php bbp_tab_index(); ?>" id="bbp_topic_submit" name="bbp_topic_submit" class="bb-rl-button bb-rl-button--brandFill submit"><?php _e( 'Post', 'buddyboss' ); ?></button>
