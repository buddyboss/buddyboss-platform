			...
			<form id="merge_topic" class="bb-rl-forum-form" name="merge_topic" method="post" action="<?php the_permalink(); ?>">
				...
				<div class="bb-rl-forum-modal-header">
					<h3>
						...
						printf( esc_html__( 'Merge discussion "%s"', 'buddyboss-platform' ), bbp_get_topic_title() ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- bbp_get_topic_title() is self-escaping (filtered).
						?>
					</h3>
				</div>
