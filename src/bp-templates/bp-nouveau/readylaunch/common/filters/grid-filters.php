...
if ( 'list_grid' === $current_value ) {
	...
	<div class="bb-rl-grid-filters flex items-center" data-object="<?php echo esc_attr( $component ); ?>">
		<a href="" class="layout-view layout-grid-view bp-tooltip <?php echo ( 'grid' === $default_current_value ) ? 'active' : ''; ?>" data-view="grid" data-bp-tooltip-pos="down" data-bp-tooltip="<?php esc_attr_e( 'Grid View', 'buddyboss-platform' ); ?>" aria-label="<?php esc_attr_e( 'Grid View', 'buddyboss-platform' ); ?>">
			<i class="bb-icons-rl-squares-four"></i>
		</a>
		<a href="" class="layout-view layout-list-view bp-tooltip <?php echo ( 'list' === $default_current_value ) ? 'active' : ''; ?>" data-view="list" data-bp-tooltip-pos="down" data-bp-tooltip="<?php esc_attr_e( 'List View', 'buddyboss-platform' ); ?>" aria-label="<?php esc_attr_e( 'List View', 'buddyboss-platform' ); ?>">
