...
<aside class="<?php bp_nouveau_template_message_classes(); ?>">
	...
	<?php if ( bp_nouveau_has_dismiss_button() ) : ?>
		...
		<button type="button" class="bp-tooltip" data-bp-tooltip-pos="up" data-bp-tooltip="<?php esc_attr_e( 'Close', 'buddyboss-platform' ); ?>" aria-label="<?php esc_attr_e( 'Close this notice', 'buddyboss-platform' ); ?>" data-bp-close="<?php bp_nouveau_dismiss_button_type(); ?>">
