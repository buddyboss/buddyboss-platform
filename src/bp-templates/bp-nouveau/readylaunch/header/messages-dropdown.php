...
<div id="header-messages-dropdown-elem" class="dropdown-passive dropdown-right notification-wrap messages-wrap bb-message-dropdown-notification menu-item-has-children">
	<a href="javascript:void(0);" ref="notification_bell" class="notification-link" aria-label="<?php esc_html_e( 'Messages', 'buddyboss-platform' ); ?>">
		<span data-balloon-pos="down" data-balloon="<?php esc_html_e( 'Messages', 'buddyboss-platform' ); ?>" class="bb-member-unread-count-span-<?php echo esc_attr( bp_loggedin_user_id() ); ?>">
	...
	<section class="notification-dropdown">
		<header class="notification-header flex items-center justify-between">
			<h2 class="title"><?php esc_html_e( 'Messages', 'buddyboss-platform' ); ?></h2>
			<div class="notification-header-actions">
				<a href="<?php echo esc_url( $menu_link ); ?>" class="bb-rl-button bb-rl-button--secondaryFill bb-rl-button--small bdelete-all delete-all">
					<?php esc_html_e( 'View All', 'buddyboss-platform' ); ?>
				</a>
			</div>
		</header>
