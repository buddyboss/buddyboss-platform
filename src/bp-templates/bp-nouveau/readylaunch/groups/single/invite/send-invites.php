			...
			<form id="send_group_invite_form" class="standard-form" data-select2-id="send_group_invite_form">
				<div class="bb-groups-invites-right-top">
					<div class="bb-title-wrap">
						<h2 class="bb-title"><?php esc_html_e( 'Selected Members', 'buddyboss-platform' ); ?></h2>
					...
					<select name="group_invites_send_to[]" class="send-to-input select2-hidden-accessible" id="group-invites-send-to-input" placeholder="<?php esc_attr_e( 'Type the names of one or more people', 'buddyboss-platform' ); ?>" autocomplete="off" multiple="" style="width: 100%" data-select2-id="group-invites-send-to-input" tabindex="-1" aria-hidden="true"></select>
				</div>
				<div class="bb-groups-invites-right-bottom">
					<div id="bp-group-invite-content">
						<h2 class="bb-title"><?php esc_html_e( 'Message (optional)', 'buddyboss-platform' ); ?></h2>
						<textarea class="bp-faux-placeholder-label" id="send-invites-control" name="group_invite_content" rows="120" cols="150" placeholder="<?php esc_attr_e( 'Write an invitation message...', 'buddyboss-platform' ); ?>"></textarea>
						...
						<div id="whats-new-toolbar">
							<div id="group-invites-new-submit" class="submit">
								...
								<input type="submit" name="bp_invites_reset" value="<?php esc_attr_e( 'Cancel', 'buddyboss-platform' ); ?>" id="bp_invites_reset" class="small">
								<input type="submit" name="send_group_invite_button" value="<?php esc_attr_e( 'Send Invite', 'buddyboss-platform' ); ?>" id="send_group_invite_button" class="small" disabled>
							</div>
						</div>
					</div>
				</div>
