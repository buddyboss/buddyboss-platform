...
<h2 class="bp-screen-title warn">
	<?php esc_html_e( 'Delete this group', 'buddyboss-platform' ); ?>
</h2>
...
<div class="bp-checkbox-wrap">
	...
	<label for="delete-group-understand" class="bp-label-text warn"><?php esc_html_e( 'I understand the consequences of deleting this group.', 'buddyboss-platform' ); ?></label>
</div>
...
<?php if ( bp_is_active( 'forums' ) && bbp_get_group_forum_ids( groups_get_current_group()->id ) ) : ?>
	<div class="bp-checkbox-wrap">
		...
		<label for="delete-group-forum-understand" class="bp-label-text warn"><?php esc_html_e( 'I also want to delete the discussion forum.', 'buddyboss-platform' ); ?></label>
	</div>
<?php endif; ?>
