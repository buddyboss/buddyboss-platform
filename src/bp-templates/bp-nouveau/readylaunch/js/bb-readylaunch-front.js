...
<div id="bp-media-create-folder" style="display: block;" className="open-popup group-media-error-popup">
	<transition name="modal">
		<div className="modal-mask bb-white bbm-model-wrap">
			<div className="modal-wrapper">
				<div id="boss-media-create-album-popup" className="modal-container has-folderlocationUI">
					<header className="bb-model-header"><h4>' + bbRlMedia.invalid_media_type + '</h4>
						<a className="bb-model-close-button errorPopup" href="#">
...
<div id="bp-media-create-folder" style="display: block;" class="open-popup group-' + subType + '-error-popup">
	<transition name="modal">
		<div class="modal-mask bb-white bbm-model-wrap">
			<div class="modal-wrapper">
				<div id="boss-media-create-album-popup" class="modal-container has-folderlocationUI">
					<header class="bb-model-header">
						<h4>' + bbRlMedia.invalid_file_type + '</h4>
						<a class="bb-model-close-button errorPopup" href="#">
...
<div id="bp-video-create-album" style="display: block;" class="open-popup">
	<transition name="modal">
		<div class="modal-mask bb-white bbm-model-wrap">
			<div class="modal-wrapper">
				<div id="boss-video-create-album-popup" class="modal-container has-folderlocationUI">
					<header class="bb-model-header">
						<h4>' + bbRlVideo.invalid_video_type + '</h4>
						<a class="bb-model-close-button errorPopup" href="#">
							<span class="dashicons dashicons-no-alt"></span>
						</a>
					</header>
