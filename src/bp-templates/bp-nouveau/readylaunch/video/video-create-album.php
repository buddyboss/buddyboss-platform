...
<div class="bb-rl-create-popup-album-wrap bb-rl-popup-on-fly-create-album" style="display: none;">
	<div class="bb-rl-field-wrap">
		<label for="bb_rl_new_album_name_input" class="bb-label"><?php esc_attr_e( 'Title', 'buddyboss-platform' ); ?></label>
	...
	<div class="bb-rl-footer-alt">
		...
		<div class="db-modal-buttons">
			...
			<a class="bb-rl-button bb-rl-button--brandFill bb-rl-button--small bb-rl-video-create-popup-album-submit" href="#"><?php esc_html_e( 'Create', 'buddyboss-platform' ); ?></a>
		</div>
	</div>
</div>
