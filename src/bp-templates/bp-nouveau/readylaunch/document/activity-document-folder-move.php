			...
			<div class="bb-rl-modal-wrapper">
				<div id="bb-rl-media-create-album-popup" class="bb-rl-modal-container bb-rl-has-folderlocationUI">
					...
					<footer class="bb-rl-model-footer">
						<a href="#" class="bb-rl-create-album bb-rl-document-open-create-popup-folder"><i class="bb-icons-rl-plus"></i><?php esc_html_e( 'Create Folder', 'buddyboss-platform' ); ?></a>
						<a class="bb-rl-button bb-rl-button--secondaryFill bb-rl-button--small bb-rl-ac-folder-close-button" href="#"><?php esc_html_e( 'Cancel', 'buddyboss-platform' ); ?></a>
						<a class="bb-rl-button bb-rl-button--brandFill bb-rl-button--small bb-rl-folder-move" id="" href="#"><?php esc_html_e( 'Move', 'buddyboss-platform' ); ?></a>
					</footer>
				</div>
			</div>
		</div>
