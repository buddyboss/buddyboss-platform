...
?>
<div class="bb-rl-media-edit-file bb-rl-modal-edit-file" style="display: none;" id="bb-rl-media-edit-file-<?php echo esc_attr( $document_id ); ?>" data-activity-id="">
			...
			<div class="bb-rl-modal-wrapper">
				<div id="bb-rl-media-create-album-popup" class="bb-rl-modal-container bb-rl-has-folderlocationUI">
					<header class="bb-model-header">
						...
						<a class="bb-model-close-button" id="bp-media-edit-document-close" href="#"><span class="bb-icon-l bb-icon-times"></span></a>
					</header>
					<div class="bb-rl-modal-body">
						<div class="bb-field-wrap">
							<label for="bb-album-title" class="bb-label"><?php esc_html_e( 'Title', 'buddyboss' ); ?></label>
							<input id="bb-album-title" value="" type="text" placeholder="<?php esc_html_e( 'Enter Document Title', 'buddyboss' ); ?>" />
