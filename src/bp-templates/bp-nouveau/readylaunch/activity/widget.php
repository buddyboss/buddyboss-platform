		...
		while ( bp_activities() ) :
			...
			<div class="activity-update">
				<div class="update-item">
					<cite>
						<a href="<?php bp_activity_user_link(); ?>" class="bp-tooltip" data-bp-tooltip-pos="up" data-bp-tooltip="<?php echo esc_attr( bp_get_activity_member_display_name() ); ?>"<?php echo bb_get_hover_card_profile_attr( bp_get_activity_user_id() ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Escaped in the helper. ?>>
							<?php
							bp_activity_avatar(
								array(
									'type'   => 'thumb',
