	...
	<div class="bb-rl-ac-form-container">
		<div class="bb-rl-ac-reply-content">
			...
			<div class="ac-textarea">
				<label for="ac-input-<?php echo esc_attr( $activity_id ); ?>" class="bp-screen-reader-text">
					<?php esc_html_e( 'Comment', 'buddyboss-platform' ); ?>
				</label>
				<div contenteditable="true" id="ac-input-<?php echo esc_attr( $activity_id ); ?>" class="ac-input bp-suggestions" name="ac_input_<?php echo esc_attr( $activity_id ); ?>" data-placeholder="<?php esc_attr_e( 'Write a comment...', 'buddyboss-platform' ); ?>"></div>
			</div>
		...
		<div class="bb-rl-ac-reply-footer">
					...
					if ( $media_active ) :
						?>
							<div class="bb-rl-post-elements-buttons-item bb-rl-post-media bb-rl-media-support">
								<a href="#" id="bb-rl-ac-reply-media-button-<?php echo esc_attr( $activity_id ); ?>" class="toolbar-button bp-tooltip bb-rl-ac-reply-media-button" data-bp-tooltip-pos="up" data-bp-tooltip="<?php esc_attr_e( 'Attach photo', 'buddyboss-platform' ); ?>" data-ac-id="<?php echo esc_attr( $activity_id ); ?>">
									<i class="bb-icons-rl-camera"></i>
								</a>
							</div>
							<div class="bb-rl-post-elements-buttons-item bb-rl-post-video bb-rl-video-support">
								<a href="#" id="bb-rl-ac-reply-video-button-<?php echo esc_attr( $activity_id ); ?>" class="toolbar-button bp-tooltip bb-rl-ac-reply-video-button" data-bp-tooltip-pos="up" data-bp-tooltip="<?php esc_attr_e( 'Attach video', 'buddyboss-platform' ); ?>" data-ac-id="<?php echo esc_attr( $activity_id ); ?>">
									<i class="bb-icons-rl-video-camera"></i>
								</a>
							</div>
							<div class="bb-rl-post-elements-buttons-item bb-rl-post-media bb-rl-document-support">
								<a href="#" id="bb-rl-ac-reply-document-button-<?php echo esc_attr( $activity_id ); ?>" class="toolbar-button bp-tooltip bb-rl-ac-reply-document-button" data-bp-tooltip-pos="up" data-bp-tooltip="<?php esc_attr_e( 'Attach document', 'buddyboss-platform' ); ?>" data-ac-id="<?php echo esc_attr( $activity_id ); ?>">
							...
							<div class="bb-rl-post-elements-buttons-item bb-rl-post-gif">
								<div class="bb-rl-gif-media-search">
									<a href="#" id="bb-rl-ac-reply-gif-button-<?php echo esc_attr( $activity_id ); ?>" class="toolbar-button bp-tooltip bb-rl-ac-reply-gif-button" data-bp-tooltip-pos="up" data-bp-tooltip="<?php esc_attr_e( 'Choose a GIF', 'buddyboss-platform' ); ?>">
							...
							<div class="bb-rl-post-elements-buttons-item bb-rl-post-emoji bp-tooltip" data-bp-tooltip-pos="up" data-bp-tooltip="<?php esc_attr_e( 'Emoji', 'buddyboss-platform' ); ?>" id="bb-rl-ac-reply-emoji-button-<?php echo esc_attr( $activity_id ); ?>"></div>
						<?php endif; ?>
					</div>
					<?php
			}
			...
			printf(
				...
				esc_html__( 'Cancel', 'buddyboss-platform' )
			);
			?>
