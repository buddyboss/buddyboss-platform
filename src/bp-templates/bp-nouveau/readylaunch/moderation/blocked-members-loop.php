...
if ( empty( $_POST['page'] ) || 1 === (int) bb_filter_input_string( INPUT_POST, 'page' ) ) {
	?>
	<div class="bp-feedback bp-messages error moderation_notice is_hidden bb-rl-notice bb-rl-notice--alt bb-rl-notice--error"><span class="bp-icon bb-icons" aria-hidden="true"></span><span><?php esc_html_e( 'Sorry, you were not able to report this member.', 'buddyboss-platform' ); ?></span></div>
