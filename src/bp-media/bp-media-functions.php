 ...
 */
function bb_get_album_counts( $album_id ) {
 ...
 */
function bb_validate_same_album( $media_objects, $type = 'media' ) {
 ...
 */
function bb_get_album_counts_for_operation( $media_ids, $type = 'media' ) {
	$result = array(
		'album_id'          => 0,
		'album_photo_count' => 0,
		'album_video_count' => 0,
	...
	// Validate same album
	$validation = bb_validate_same_album( $media_objects, $type );
 ...
 */
function bb_get_move_album_counts( $source_album_id, $destination_album_id ) {
	...
	if ( 0 < $source_album_id ) {
		$source_counts = bb_get_album_counts( $source_album_id );
	...
	if ( 0 < $destination_album_id ) {
		$dest_counts = bb_get_album_counts( $destination_album_id );
