...
class BP_Media {
	...
	protected static function get_media_data( $media_ids = array() ) {
		...
		foreach ( $media_ids as $media_id ) {
			...
			$media_album_cover_thumb                      = bp_media_get_preview_image_url( $media->id, $media->attachment_id, 'bb-media-photos-album-directory-image-new' );
	...
	protected static function attachment_meta( $attachment_id ) {
		...
		if ( isset( $metadata['sizes']['bb-media-photos-album-directory-image-new'] ) ) {
			$meta['sizes']['bb-media-photos-album-directory-image-new'] = $metadata['sizes']['bb-media-photos-album-directory-image-new'];
		}
