	...
	public static function delete( $args = array(), $from = false ) {
		...
		if ( ! empty( $attachment_ids ) ) {
			...
			foreach ( $attachment_ids as $attachment_id ) {
				...
				if ( isset($get_auto_generated_thumbnails['default_images']) && !empty($get_auto_generated_thumbnails['default_images'])) {
					foreach ( $get_auto_generated_thumbnails['default_images'] as $get_auto_generated_thumbnail ) {
						wp_delete_attachment( $get_auto_generated_thumbnail, true );
					}
				}

				// Delete poster image.
				$get_poster_thumbnails = isset($get_auto_generated_thumbnails['custom_image']) && !empty($get_auto_generated_thumbnails['custom_image']) ? $get_auto_generated_thumbnails['custom_image'] : '';
