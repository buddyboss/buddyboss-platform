				...
				<div class="avatar-block who-is-online-widget-parent-users">
					...
					while ( bp_members() ) :
						...
						<div class="item-avatar item-avatar-<?php echo esc_attr( bp_get_member_user_id() ); ?>">
							<a href="<?php bp_member_permalink(); ?>" class="bp-tooltip" data-bp-tooltip-pos="up" data-bp-tooltip="<?php echo esc_attr( bp_get_member_name() ); ?>" data-bb-hp-profile="<?php echo esc_attr( bp_get_member_user_id() ); ?>">
			...
			if ( bp_has_members( $connection_args ) && apply_filters( 'bb_show_online_users', true ) ) {
				...
				<div class="avatar-block who-is-online-widget-parent-connection">
					...
					while ( bp_members() ) :
						...
						<div class="item-avatar item-avatar-<?php echo esc_attr( bp_get_member_user_id() ); ?>">
							<a href="<?php bp_member_permalink(); ?>" class="bp-tooltip <?php echo esc_attr( $moderation_class ); ?>" data-bp-tooltip-pos="up" data-bp-tooltip="<?php echo esc_attr( bp_get_member_name() ); ?>" data-bb-hp-profile="<?php echo esc_attr( bp_get_member_user_id() ); ?>">
								<?php bp_member_avatar(); ?>
								<?php bb_user_presence_html( bp_get_member_user_id() ); ?>
							</a>
						</div>
