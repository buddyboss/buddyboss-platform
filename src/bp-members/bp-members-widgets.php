	...
	if ( bp_has_members( $members_args ) ) :
		...
		while ( bp_members() ) :
			...
			<li class="vcard">
				...
				<div class="item">
					<div class="item-title fn"><a href="<?php bp_member_permalink(); ?>"<?php echo bb_get_hover_card_profile_attr( $members_template->member->id ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Escaped in the helper. ?>><?php bp_member_name(); ?></a></div>
					<div class="item-meta">
