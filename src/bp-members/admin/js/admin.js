...
( function ( $ ) {
	...
	if ( $( '.bb_admin_repeater_group' ).length > 0 ) {
		...
		$( '.bb_admin_repeater_group' ).each( function () {
			...
			if ( repeater_set_count > 0 ) {
				...
				$parentContainer.find( '.repeater_group_outer' ).each( function () {
					var $set = $( this );
				...
				$parentContainer.find( '.repeater_sets_sortable' ).sortable( {
					...
					update: function () {
						var repeater_set_sequence = [];
						$( this ).find( '.repeater_group_outer' ).each( function () {
		...
		// Edit button
		$( '.bb_admin_repeater_group' ).on( 'click', '.repeater_group_outer .repeater_set_edit', function ( e ) {
			e.preventDefault();
		...
		$( '.bb_admin_repeater_group' ).on( 'click', '.repeater_group_outer .repeater_set_delete', function ( e ) {
			...
			if ( r ) {
				...
				var repeater_set_sequence = [];
				$( '#' + parentContainer + ' .repeater_group_outer' ).each( function () {
					repeater_set_sequence.push( $( this ).data( 'set_no' ) );
				} );
		...
		$( '.bb_admin_repeater_group #btn_add_repeater_set' ).click( function ( e ) {
			e.preventDefault();
			var $button = $( this );
		...
		$( '.bb_admin_repeater_group' ).on( 'click', '.repeater_group_outer .visibility-toggle-link', function ( e ) {
			e.preventDefault();
		...
		$( '.bb_admin_repeater_group' ).on( 'click', '.repeater_group_outer .field-visibility-settings-close', function ( e ) {
			e.preventDefault();
