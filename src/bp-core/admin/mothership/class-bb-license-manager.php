...
class BB_License_Manager extends LicenseManager
{
    ...
    public function generateActivationForm(): string
    {
        ...
        <form method="post" action="" name="<?php echo esc_attr($pluginId); ?>_activate_license_form">
            <div class="<?php echo esc_attr($pluginId); ?>-license-form">
                ...
                >
                <input type="hidden" name="activation_domain" id="activation_domain"
                ...
                <input type="submit" value="<?php esc_html_e('Activate License', 'buddyboss'); ?>"
    ...
    public function generateDisconnectForm(): string
    {
        ...
        <p><?php esc_html_e('Your license is currently active.', 'buddyboss'); ?></p>
        <form method="post" action="" name="<?php echo esc_attr($pluginId); ?>_deactivate_license_form">
            <div class="<?php echo esc_attr($pluginId); ?>-license-form">
                ...
                <input type="text" name="license_key" id="license_key"
                    ...
                    readonly
                >
                <input type="hidden" name="activation_domain" id="activation_domain" value="<?php echo esc_attr(Credentials::getActivationDomain()); ?>" readonly >
                ...
                <input type="submit"
                    value="<?php esc_html_e('Deactivate License', 'buddyboss'); ?>"
