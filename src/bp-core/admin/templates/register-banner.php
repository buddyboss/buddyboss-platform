...
<div class="bb-reg-banner-holder">
	<div class="bb-reg-banner" role="region" aria-label="<?php esc_attr_e( 'Register your email and get Memberships and Courses', 'buddyboss-platform' ); ?>">

		<div class="bb-reg-banner-image">
			<img src="<?php echo esc_url( buddypress()->plugin_url . 'bp-core/images/admin/register-banner.jpg' ); ?>" alt="<?php esc_attr_e( 'BuddyBoss Register Banner', 'buddyboss-platform' ); ?>" />
		</div>
		...
		<div class="bb-reg-content">
			<div class="bb-reg-notice" role="note" data-bb-reg-notice<?php echo $bb_reg_is_pitch ? ' hidden' : ''; ?>>
				...
				<span class="bb-reg-notice__text"><?php esc_html_e( 'Complete setup by activating your license', 'buddyboss-platform' ); ?></span>
				<a class="bb-reg-notice__link" href="<?php echo esc_url( $bb_reg_license_url ); ?>">
					<?php esc_html_e( 'Activate License', 'buddyboss-platform' ); ?>
			...
			<div class="bb-reg-heads">
				<h2 class="bb-reg-title"><?php esc_html_e( 'Register your email and get Memberships & Courses', 'buddyboss-platform' ); ?></h2>
				<p class="bb-reg-desc"><?php esc_html_e( 'Build courses and then connect them to memberships to start monetizing your community and grow your passive income.', 'buddyboss-platform' ); ?></p>
			</div>

			<div class="bb-reg-cta">
				<button type="button" class="bb-reg-btn" data-bb-reg-open>
					<?php esc_html_e( 'Register with Email', 'buddyboss-platform' ); ?>
				</button>
			</div>

			<p class="bb-reg-onus"><?php esc_html_e( 'Its On Us..!', 'buddyboss-platform' ); ?></p>
		</div>
	</div>
		...
		<div class="bb-reg-modal" data-bb-reg-modal hidden>
			...
			<div class="bb-reg-modal__dialog" role="dialog" aria-modal="true" aria-labelledby="bb-reg-modal-title">
				<div class="bb-reg-modal__header">
					<h3 class="bb-reg-modal__title" id="bb-reg-modal-title"><?php esc_html_e( 'Get BuddyBoss Platform License Key', 'buddyboss-platform' ); ?></h3>
					<button type="button" class="bb-reg-modal__close" data-bb-reg-close aria-label="<?php esc_attr_e( 'Close', 'buddyboss-platform' ); ?>">
				...
				<form class="bb-reg-modal__body" data-bb-reg-form novalidate>
					<div class="bb-reg-modal__field">
						<label for="bb-reg-first"><?php esc_html_e( 'First Name', 'buddyboss-platform' ); ?> <span class="bb-reg-modal__req">*</span></label>
						<input type="text" id="bb-reg-first" data-bb-reg-first placeholder="<?php esc_attr_e( 'Enter your first name', 'buddyboss-platform' ); ?>" required />
					</div>
					<div class="bb-reg-modal__field">
						<label for="bb-reg-last"><?php esc_html_e( 'Last Name', 'buddyboss-platform' ); ?> <span class="bb-reg-modal__req">*</span></label>
						<input type="text" id="bb-reg-last" data-bb-reg-last placeholder="<?php esc_attr_e( 'Enter your last name', 'buddyboss-platform' ); ?>" required />
					</div>
					<div class="bb-reg-modal__field">
						<label for="bb-reg-email"><?php esc_html_e( 'Email Address', 'buddyboss-platform' ); ?> <span class="bb-reg-modal__req">*</span></label>
						<input type="email" id="bb-reg-email" data-bb-reg-email placeholder="<?php esc_attr_e( 'Enter your email address', 'buddyboss-platform' ); ?>" required />
					</div>
					<p class="bb-reg-modal__error" data-bb-reg-inline-error role="alert" hidden></p>
					<div class="bb-reg-modal__footer">
						<button type="button" class="bb-reg-modal__btn bb-reg-modal__btn--ghost" data-bb-reg-close><?php esc_html_e( 'Cancel', 'buddyboss-platform' ); ?></button>
						<button type="submit" class="bb-reg-modal__btn bb-reg-modal__btn--primary"><?php esc_html_e( 'Register', 'buddyboss-platform' ); ?></button>
					</div>
				</form>
				...
				<div class="bb-reg-modal__state bb-reg-modal__state--loading" data-bb-reg-state="loading" hidden>
					...
					<p class="bb-reg-modal__loading-text">
						<span><?php esc_html_e( 'Getting Your License', 'buddyboss-platform' ); ?></span>
						<span class="bb-reg-modal__spinner bb-reg-modal__spinner--inline" aria-hidden="true"></span>
					</p>
					<div class="bb-reg-modal__footer">
						<button type="button" class="bb-reg-modal__btn bb-reg-modal__btn--primary" data-bb-reg-cancel-loading><?php esc_html_e( 'Cancel', 'buddyboss-platform' ); ?></button>
					</div>
				</div>
				...
				<div class="bb-reg-modal__state bb-reg-modal__state--result" data-bb-reg-state="success" hidden>
					...
					<p class="bb-reg-modal__result-title"><?php esc_html_e( 'Your license key has been sent successfully', 'buddyboss-platform' ); ?></p>
					<p class="bb-reg-modal__result-desc"><?php esc_html_e( 'Please check your inbox and verify your email to access your license key. If you don\'t see the email in your inbox, kindly check your spam or junk folder.', 'buddyboss-platform' ); ?></p>
					<div class="bb-reg-modal__footer">
						<button type="button" class="bb-reg-modal__btn bb-reg-modal__btn--primary" data-bb-reg-done><?php esc_html_e( 'Close', 'buddyboss-platform' ); ?></button>
					</div>
				</div>
				...
				<div class="bb-reg-modal__state bb-reg-modal__state--result" data-bb-reg-state="already" hidden>
					...
					<p class="bb-reg-modal__result-title"><?php esc_html_e( 'Your license has already been registered', 'buddyboss-platform' ); ?></p>
					<p class="bb-reg-modal__result-desc">
						<?php
						printf(
							/* translators: %s is a link to the user's BuddyBoss account area. */
							esc_html__( 'Please visit your %s area to view or retrieve your license key.', 'buddyboss-platform' ),
							'<a href="' . esc_url( 'https://buddyboss.com/my-account/' ) . '" target="_blank" rel="noopener noreferrer">' . esc_html__( 'account', 'buddyboss-platform' ) . '</a>'
						);
						?>
					</p>
					<div class="bb-reg-modal__footer">
