...
<div class="wrap bp_appboss_wrap">
	...
	<div class="appboss-featured">
			...
			<?php
			/*
			 * appboss-column-section
			 */
			?>
			<div class="appboss-column-section">
				 ...
				 */
				?>			
				<div class="appboss-column">
					
					<?php
					/*
					 * appboss-column-block
					 */
					?>
