                                    ...
                                    <div class="bb-notice-card">
                                        ...
                                        <div class="bb-notice-body">
                                            <div class="notice-content">
                                                <p>You must create access groups to apply restrictions to roles and view them listed here.</p>
                                            </div>
                                            <div class="notice-action">
                                                <a href="" class="button button-primary bb-notice-action-button">Activate License Now</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="bb-notice-block bb-notice-block--info">
                                    ...
                                    <div class="bb-notice-card">
                                        ...
                                        <div class="bb-notice-body">
                                            ...
                                            <div class="notice-action">
                                                <a href="" class="button button-primary bb-notice-action-button">Learn More</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="bb-notice-card">
                                        ...
                                        <div class="bb-notice-body">
                                            <div class="notice-content">
                                                <p>You must create access groups to apply restrictions to roles and view them listed here.</p>
                                                <ul>
                                                    <li>You must create access groups to apply restrictions to roles</li>
                                ...
                                <div class="bb-notice-block bb-notice-block--promo">
                                    ...
                                    <div class="bb-notice-card">
                                        ...
                                        <div class="bb-notice-body">
                                            ...
                                            <div class="notice-action">
                                                <a href="" class="button button-primary bb-notice-action-button">Grab the deal</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
