...
function bp_core_admin_get_directory_pages() {
	...
	if ( bp_is_active( 'media' ) && ( bp_is_profiles_document_support_enabled() || bp_is_forums_document_support_enabled() || bp_is_group_document_support_enabled() || bp_is_messages_document_support_enabled() ) ) {
