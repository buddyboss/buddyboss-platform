...
function bp_core_admin_get_directory_pages() {
	...
	if ( bp_is_active( 'media' ) && ( bp_is_profile_video_support_enabled() || bp_is_forums_video_support_enabled() || bp_is_group_video_support_enabled() || bp_is_messages_video_support_enabled() ) ) {
