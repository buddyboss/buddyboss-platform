...
function bp_admin_setting_callback_enable_relevant_feed() {
	...
	<p class="description">relevant activity are posts from logged-in member, posts from connections, members following, groups, subscribed forums discussions, mentions, etc.</p>
	<?php
}
