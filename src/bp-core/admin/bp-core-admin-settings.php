...
function bb_admin_setting_callback_enable_activity_pinned_posts() {
	...
	<input id="_bb_enable_activity_pinned_posts" name="_bb_enable_activity_pinned_posts" type="checkbox" value="1" <?php checked( bb_is_active_activity_pinned_posts( true ) ); ?> />
