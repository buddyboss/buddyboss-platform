 ...
 */
function bb_get_license_details( $license_key ) {

	$api_url     = "https://licenses.caseproof.com/api/v1/licenses/" . $license_key;
	...
	if ( empty( $body['license_key'] ) || empty( $body['product'] ) ) {
