...
class BP_Admin_Setting_Xprofile extends BP_Admin_Setting_tab {
	...
	public function settings_save() {
		...
		$bb_display_name_format = filter_input( INPUT_POST, 'bp-display-name-format', FILTER_UNSAFE_RAW );
		...
		$bb_profile_avatar_type           = filter_input( INPUT_POST, 'bp-profile-avatar-type', FILTER_UNSAFE_RAW );
		$bb_default_custom_profile_avatar = filter_input( INPUT_POST, 'bp-default-custom-profile-avatar', FILTER_UNSAFE_RAW );
		$bb_default_custom_profile_cover  = filter_input( INPUT_POST, 'bp-default-custom-profile-cover', FILTER_UNSAFE_RAW );
