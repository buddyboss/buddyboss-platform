...
class BP_Admin_Setting_Xprofile extends BP_Admin_Setting_tab {
	...
	public function settings_save() {
		...
		$bp_nouveau_appearance['user_front_page']          = filter_input( INPUT_POST, 'bp-enable-member-dashboard', FILTER_DEFAULT );
		$bp_nouveau_appearance['user_front_page']          = ! empty( $bp_nouveau_appearance['user_front_page'] ) ? $bp_nouveau_appearance['user_front_page'] : 0;
		$bp_nouveau_appearance['user_front_page_redirect'] = filter_input( INPUT_POST, 'bp-enable-member-dashboard-redirect', FILTER_DEFAULT );
		$bp_nouveau_appearance['user_front_page_redirect'] = ! empty( $bp_nouveau_appearance['user_front_page_redirect'] ) ? $bp_nouveau_appearance['user_front_page_redirect'] : 0;
