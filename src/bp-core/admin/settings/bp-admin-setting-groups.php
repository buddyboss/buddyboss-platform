...
class BP_Admin_Setting_Groups extends BP_Admin_Setting_tab {
	...
	public function settings_save() {
		...
		$bb_default_custom_group_avatar = filter_input( INPUT_POST, 'bp-default-custom-group-avatar', FILTER_UNSAFE_RAW );
		$bb_default_custom_group_cover  = filter_input( INPUT_POST, 'bp-default-custom-group-cover', FILTER_UNSAFE_RAW );
