	...
	bb_register_feature_field(
		...
		array(
			...
			'options'             => array(
				array(
					'value' => 'complete',
					'label' => __( 'Complete reporting', 'buddyboss' ),
				),
				array(
					'value' => 'anonymous',
					'label' => __( 'Anonymous reporting', 'buddyboss' ),
				),
				array(
					'value' => 'disable',
					'label' => __( 'Disable telemetry', 'buddyboss' ),
				),
			),
			'order'               => 10,
		)
