...
function bb_members_register_access_control_fields() {
	...
	bb_register_feature_section(
		...
		'connection_access',
		array(
			'title'       => __( 'Connection Access', 'buddyboss-platform' ),
			'description' => '',
			'order'       => 20,
			'help_url'    => '636002',
			'conditional' => array(
	...
	bb_register_feature_field(
		...
		array(
			...
			'label'              => __( 'Connection Request', 'buddyboss-platform' ),
			'type'               => 'access_control',
			'description'        => __( 'Select which members can send connection requests to others based on:', 'buddyboss-platform' ),
			'threaded'           => true,
			'threaded_sub_label' => __( 'can send connection request to', 'buddyboss-platform' ),
			'default'            => '',
			'pro_only'           => true,
			'order'              => 10,
