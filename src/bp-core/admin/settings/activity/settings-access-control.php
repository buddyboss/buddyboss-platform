...
// The enrichment filter may already be registered by Groups settings.
// Define it here too so Activity access controls work even when Groups is disabled.
...
// The sanitize callback may already be registered by Groups settings.
// Define it here too so Activity access controls work even when Groups is disabled.
