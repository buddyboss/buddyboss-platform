...
<div id="buddypress">
	...
	<div class="item-list-tabs no-ajax" id="subnav" role="navigation">
		<ul>
			...
			<li id="photos-all"><a href="<?php echo esc_url( $global_media_permalink );?>"><?php _e( 'All Photos', 'buddyboss' );?></a></li>
			<li class="selected" id="albums-personal"><a href="<?php echo esc_url( $global_media_permalink );?>albums/"><?php _e( 'All Albums', 'buddyboss' );?></a></li>
		</ul>
	</div>
