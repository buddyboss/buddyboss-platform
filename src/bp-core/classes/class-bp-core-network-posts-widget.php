	...
	public function widget( $args, $instance ) {
		...
		?>
			<!--<ul id="network-list" class="item-list" aria-live="polite" aria-relevant="all" aria-atomic="true">
                ...
                <li class="vcard">
					<div class="item-avatar">
						<a href="<?php /*bp_member_permalink() */?>" class="bp-tooltip" data-bp-tooltip="<?php /*bp_member_name(); */?>"><img src="http://www.gravatar.com/avatar/76175ea504c418a9f3fa8cabc625b6be?s=150&r=g&d=mm" class="avatar photo round" alt="lorem ipsum" /></a>
					</div>

					<div class="item">
						<div class="item-title">
                            <a href="<?php /*bp_member_permalink(); */?>">name </a>
                            <span class="netowrk-post-type">commented on a post:</span>
                        </div>
						<div class="item-data">
							<span class="netowrk-post-content">Welcome sign of a smart company</span>
                            <span class="netowrk-post-activity">5 minutes ago</span>
						</div>
					</div>
				</li>
				...
				<li class="vcard">
					...
					<div class="item">
						...
						<div class="item-data">
							<span class="netowrk-post-content">Welcome sign of a smart company</span>
                            <div class="data-photo"><a href="#" class="entry-img"><img src="https://boss-social.dev1.kemarise.com/wp-content/uploads/2011/07/dsc09114.jpg" class="no-round photo" alt="lorem ipsum" /></a></div>
                            <span class="netowrk-post-activity">5 minutes ago</span>
						</div>
					</div>
				</li>
                ...
                <li class="vcard">
					...
					<div class="item">
						<div class="item-title">
                            <a href="<?php /*bp_member_permalink(); */?>">name </a>
                            <span class="netowrk-post-type">liked a post:</span>
                        </div>
						<div class="item-data">
							<span class="netowrk-post-content">Welcome sign of a smart company</span>
                            <span class="netowrk-post-activity">5 minutes ago</span>
                ...
                <li class="vcard">
					...
					<div class="item">
						<div class="item-title">
                            <a href="<?php /*bp_member_permalink(); */?>">name </a>
                            <span class="netowrk-post-type">joined a group:</span>
                        </div>
						<div class="item-data">
							<span class="netowrk-post-content">Welcome sign of a smart company</span>
                            <span class="netowrk-post-activity">5 minutes ago</span>
