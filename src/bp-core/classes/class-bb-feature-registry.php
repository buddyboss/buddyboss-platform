...
class BB_Feature_Registry {
	 ...
	 * @return bool|WP_Error True on success, WP_Error on failure.
	 */
	public function bb_register_side_panel( $feature_id, $side_panel_id, $args = array() ) {
	 ...
	 * @return bool|WP_Error True on success, WP_Error on failure.
	 */
	public function bb_register_section( $feature_id, $side_panel_id, $section_id, $args = array() ) {
		// Validate feature exists.
		if ( ! isset( $this->features[ $feature_id ] ) ) {
			return new WP_Error(
				'feature_not_found',
	 ...
	 * @return bool|WP_Error True on success, WP_Error on failure.
	 */
	public function bb_register_field( $feature_id, $side_panel_id, $section_id, $args = array() ) {
		// Validate feature exists.
		if ( ! isset( $this->features[ $feature_id ] ) ) {
			return new WP_Error(
				'feature_not_found',
	 ...
	 * @return bool|WP_Error True on success, WP_Error on failure.
	 */
	public function bb_register_nav_item( $feature_id, $args = array() ) {
		// Validate feature exists.
		if ( ! isset( $this->features[ $feature_id ] ) ) {
			return new WP_Error(
				'feature_not_found',
	 ...
	 */
	public function bb_get_feature( $feature_id ) {
	 ...
	 */
	public function bb_get_side_panels( $feature_id ) {
	 ...
	 */
	public function bb_get_sections( $feature_id, $side_panel_id ) {
		if ( ! isset( $this->sections[ $feature_id ][ $side_panel_id ] ) ) {
			return array();
		}
	 ...
	 */
	public function bb_get_all_sections( $feature_id ) {
	 ...
	 */
	public function bb_get_fields( $feature_id, $side_panel_id, $section_id = null ) {
		if ( ! isset( $this->fields[ $feature_id ][ $side_panel_id ] ) ) {
			return array();
		}
	 ...
	 * @return array Array of fields.
	 */
	public function bb_get_all_fields( $feature_id ) {
	 ...
	 */
	public function bb_get_nav_items( $feature_id ) {
	 ...
	 */
	public function bb_is_feature_registered( $feature_id ) {
	 ...
	 * @return bool|WP_Error True on success, WP_Error on failure.
	 */
	public function bb_activate_feature( $feature_id ) {
		if ( ! isset( $this->features[ $feature_id ] ) ) {
			return new WP_Error(
				'feature_not_found',
				sprintf(
	 ...
	 * @return bool|WP_Error True on success, WP_Error on failure.
	 */
	public function bb_deactivate_feature( $feature_id ) {
		if ( ! isset( $this->features[ $feature_id ] ) ) {
			return new WP_Error(
				'feature_not_found',
				sprintf(
	 ...
	 */
	private function bb_has_circular_dependency( $feature_id ) {
		$visited         = array();
	 ...
	 */
	private function bb_dfs_detect_cycle( $node, &$visited, &$recursion_stack ) {
		$visited[ $node ]         = true;
		...
		if ( isset( $this->dependency_graph[ $node ] ) ) {
			foreach ( $this->dependency_graph[ $node ] as $neighbor ) {
				if ( ! isset( $visited[ $neighbor ] ) ) {
					if ( $this->bb_dfs_detect_cycle( $neighbor, $visited, $recursion_stack ) ) {
						return true;
					}
	 ...
	 */
	public function bb_sanitize_checkbox_list( $value ) {
		if ( ! is_array( $value ) ) {
			return array();
		}
	 ...
	 */
	public function bb_clear_feature_caches( $feature_id = null ) {
