...
class BP_Email_Tokens {
            ...
            <tr>
				<td align="center" style="vertical-align: middle;">
					<a style="display: block; width: 47px;" href="<?php echo esc_attr( bp_core_get_user_domain( $activity->user_id ) ); ?>" target="_blank" rel="nofollow">
						...
						?>
						<img alt="<?php echo bp_core_get_user_displayname( $activity->user_id ); ?>" src="<?php echo esc_attr( $avatar_url ); ?>" width="47" height="47" style="margin:0; padding:0; border:none; display:block; max-width: 47px; border-radius: 50%;" border="0" />
					</a>
					<div style="padding-left: 15px; color: <?php echo esc_attr( $settings['body_secondary_text_color'] ); ?>; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: <?php echo esc_attr( $settings['body_text_size'] . 'px' ); ?>; line-height: <?php echo esc_attr( $settings['body_text_size'] . 'px' ); ?>; letter-spacing: -0.24px;">
						<?php echo bp_core_get_user_displayname( $activity->user_id ); ?>
					</div>
				</td>
            </tr>
	...
	public function token__activity_reply( $bp_email, $formatted_tokens, $tokens ) {
        ...
        <table cellspacing="0" cellpadding="0" border="0" width="100%">			
			<tr>
				<td align="center" style="vertical-align: middle;">
					<a style="display: block; width: 47px;" href="<?php echo esc_attr( bp_core_get_user_domain( $activity_comment->user_id ) ); ?>" target="_blank" rel="nofollow">
						<?php
						$avatar_url = bp_core_fetch_avatar( array(
						...
						?>
						<img alt="<?php echo bp_core_get_user_displayname( $activity_comment->user_id ); ?>" src="<?php echo esc_attr( $avatar_url ); ?>" width="47" height="47" style="margin:0; padding:0; border:none; display:block; max-width: 47px; border-radius: 50%;" border="0" />
					</a>
					<div style="padding-left: 15px; color: <?php echo esc_attr( $settings['body_secondary_text_color'] ); ?>; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: <?php echo esc_attr( $settings['body_text_size'] . 'px' ); ?>; line-height: <?php echo esc_attr( $settings['body_text_size'] . 'px' ); ?>; letter-spacing: -0.24px;">
						<?php echo bp_core_get_user_displayname( $activity_comment->user_id ); ?>
					</div>
				</td>
            </tr>
	...
	public function token__message( $bp_email, $formatted_tokens, $tokens ) {
        ...
        <table cellspacing="0" cellpadding="0" border="0" width="100%">
			<?php if ( $this->_message_sender_id ): ?>
                <tr>
					<td align="center" style="vertical-align: middle;">
						<a style="display: block; width: 47px;" href="<?php echo esc_attr( bp_core_get_user_domain( $this->_message_sender_id ) ); ?>" target="_blank" rel="nofollow">
							<?php
							$avatar_url = bp_core_fetch_avatar( array(
						...
						<div style="padding-left: 15px; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: <?php echo esc_attr( $settings['body_text_size'] . 'px' ); ?>; line-height: <?php echo esc_attr( $settings['body_text_size'] . 'px' ); ?>; letter-spacing: -0.24px;">
