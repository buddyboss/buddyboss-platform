	...
	function widget( $args, $instance ) {
		...
		if ( bp_has_members(
			...
			<?php if ( $follower_count_number > $instance['max_users'] && $show_more ) { ?>
				<div class="more-block"><a href="<?php bp_members_directory_permalink(); ?>" class="count-more"><?php esc_html_e( 'See all', 'buddyboss' ); ?><i class="bb-icons-l bb-icon-angle-right"></i></a></div>
			<?php } ?>
