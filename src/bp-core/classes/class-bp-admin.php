			...
			<div class="wrap">
				<div class="advance-tab-header">
					...
					<div class="advance-actions">
						<a href="" class="advance-action-link"><?php _e( 'Contact', 'buddyboss' ); ?><i class="bb-icon-l bb-icon-arrow-up"></i></a>
						<a href="" class="advance-nav-action advance-nav-action--upgrade">
