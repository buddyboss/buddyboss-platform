			...
			<div class="wrap wrap--upgrade">
				<div class="advance-tab-header">
					...
					<div class="advance-actions">
						<a href="https://support.buddyboss.com/support/home/" target="_blank" class="advance-action-link"><?php _e( 'Contact', 'buddyboss' ); ?><i class="bb-icon-l bb-icon-arrow-up"></i></a>
						<a href="https://www.buddyboss.com/website-platform/#platform_pricing_box" target="_blank" class="advance-nav-action advance-nav-action--upgrade">
