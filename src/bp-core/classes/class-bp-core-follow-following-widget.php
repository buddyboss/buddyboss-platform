	...
	function widget( $args, $instance ) {
		...
		if ( bp_has_members(
			...
			<?php if ( $following_count_number > $instance['max_users'] && $show_more ) { ?>
				<div class="more-block more-following"><a href="<?php bp_members_directory_permalink(); ?>#following" class="count-more"><?php esc_html_e( 'See all', 'buddyboss' ); ?><i class="bb-icons-l bb-icon-angle-right"></i></a></div>
			<?php } ?>
