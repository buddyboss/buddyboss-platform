...
function bp_admin() {
	...
	_n_noop( 'Maintenance Release', 'Maintenance Releases', 'buddyboss-platform' );
	_n_noop( 'Security Release', 'Security Releases', 'buddyboss-platform' );
	_n_noop( 'Maintenance and Security Release', 'Maintenance and Security Releases', 'buddyboss-platform' );
	...
	__( 'For more information, see <a href="%s">the release notes</a>.', 'buddyboss-platform' );
}
