...
function bb_enabled_legacy_email_preference() {
	$retval = (bool) apply_filters_deprecated( 'bb_enabled_legacy_email_preference', ! bp_is_labs_notification_preferences_support_enabled(), '2.1.4', 'bb_enable_legacy_notification_preference' );
