...
function bb_get_cron_times() {
	...
	$delay_times = array(
		array(
			...
			'value'             => 5,
			'schedule_key'      => 'bb_every_five_minutes',
		...
		array(
			...
			'value'             => 15,
			'schedule_key'      => 'bb_every_fifteen_minutes',
		...
		array(
			...
			'value'             => 30,
			'schedule_key'      => 'bb_every_thirty_minutes',
		...
		array(
			...
			'value'             => 60,
			'schedule_key'      => 'bb_every_one_hour',
		...
		array(
			...
			'value'             => 180,
			'schedule_key'      => 'bb_every_three_hours',
		...
		array(
			...
			'value'             => 720,
			'schedule_key'      => 'bb_every_twelve_hours',
		...
		array(
			...
			'value'             => 1440,
			'schedule_key'      => 'bb_every_twenty_four_hours',
