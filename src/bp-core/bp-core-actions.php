...
function bb_in_plugin_notification() {
	if ( class_exists( 'BB_Grd_Lvl_Ctrl' ) ) {
		// Load GroundLevel classes.
		new BB_Grd_Lvl_Ctrl();
	}
}
add_action( 'init', 'bb_in_plugin_notification', 4 );

// add header actions for bb_admin_notification_header function of BB_Grd_Lvl_Ctrl.
add_action( 'in_admin_header', 'bb_admin_notification_header', 0 );
// add enqueues for bb_admin_notification_enqueues function of BB_Grd_Lvl_Ctrl.
add_action( 'bp_admin_enqueue_scripts', 'bb_admin_notification_enqueues' );
 ...
 * @return void
 */
function bb_admin_notification_header() {
	global $bp;
 ...
 * @since BuddyBoss [BBVERSION]
 */
function bb_admin_notification_enqueues() {
