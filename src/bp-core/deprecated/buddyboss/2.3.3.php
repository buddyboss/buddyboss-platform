...
function bp_activity_media_sideload_attachment( $file ) {
	...
	_deprecated_function( __FUNCTION__, '2.3.3', 'bb_media_sideload_attachment' );
...
function bp_activity_media_handle_sideload( $file_array, $post_data = array() ) {
	...
	_deprecated_function( __FUNCTION__, '2.3.3', 'bb_media_handle_sideload' );
