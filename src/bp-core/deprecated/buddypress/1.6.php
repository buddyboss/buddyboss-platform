...
function bp_friends_header_tabs() {
	...
	if ( ! bp_action_variable( 0 ) || bp_is_action_variable( 'recently-active', 0 ) ) :
		?>
		 class="current"<?php endif; ?>><a href="<?php echo esc_url( trailingslashit( bp_displayed_user_domain() . bp_get_friends_slug() . '/my-friends/recently-active' ) ); ?>"><?php esc_html_e( 'Recently Active', 'buddyboss-platform' ); ?></a></li>
	<li
	<?php
	if ( bp_is_action_variable( 'newest', 0 ) ) :
		?>
		 class="current"<?php endif; ?>><a href="<?php echo esc_url( trailingslashit( bp_displayed_user_domain() . bp_get_friends_slug() . '/my-friends/newest' ) ); ?>"><?php esc_html_e( 'Newest', 'buddyboss-platform' ); ?></a></li>
	<li
	<?php
	if ( bp_is_action_variable( 'alphabetically', 0 ) ) :
		?>
		 class="current"<?php endif; ?>><a href="<?php echo esc_url( trailingslashit( bp_displayed_user_domain() . bp_get_friends_slug() . '/my-friends/alphabetically' ) ); ?>"><?php esc_html_e( 'Alphabetically', 'buddyboss-platform' ); ?></a></li>
...
function bp_friends_filter_title() {
	...
	switch ( $current_filter ) {
		...
		default:
			...
			break;
		case 'newest':
			esc_html_e( 'Newest', 'buddyboss-platform' );
			break;
		case 'alphabetically':
