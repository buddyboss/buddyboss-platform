...
function bbp_admin_repair_list() {
	$repair_list = array(
		...
		95  => array( 'bbp-migrate-buddyboss-forum-topic-subscription', __( 'Update forum and discussion to new BuddyBoss subscription api', 'buddyboss' ), 'bbp_migrate_forum_topic_subscription' ),
		100 => array( 'bbp-migrate-bbpress-forum-topic-subscription', __( 'Migrate BBPress forum and discussion subscriptions to BuddyBoss', 'buddyboss' ), 'bbp_migrate_forum_topic_subscription' ),
	);
	ksort( $repair_list );
