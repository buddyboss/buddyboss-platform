...
class vBulletin extends BBP_Converter_Base {
	...
	public function callback_reply_title( $title = '' ) {
		$title = ! empty( $title ) ? __( 'Re: ', 'buddyboss-platform' ) . html_entity_decode( $title, ENT_QUOTES | ENT_SUBSTITUTE | ENT_HTML401 ) : '';
		return $title;
	}
	...
	protected function callback_html( $field ) {
		...
		$vbulletin_markup = html_entity_decode( $vbulletin_markup, ENT_QUOTES | ENT_SUBSTITUTE | ENT_HTML401 );
