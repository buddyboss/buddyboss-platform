...
function bbp_save_forum_extras( $forum_id = 0 ) {
	...
	/** Forum Visibility */
	if ( ! bb_get_child_forum_group_ids( $forum_id ) && ! empty( $_POST['bbp_forum_visibility'] ) && in_array( $_POST['bbp_forum_visibility'], array( bbp_get_public_status_id(), bbp_get_private_status_id(), bbp_get_hidden_status_id() ) ) ) {
