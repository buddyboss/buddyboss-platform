...
function bbp_get_forum_content_excerpt_view_more( $forum_id = 0 ) {
	...
	$forum_link = '... <a href="#single-forum-description-popup" class="bb-more-link show-action-popup">' . esc_html__( 'View more', 'buddyboss' ) . '</a>';

	return bp_create_excerpt( $forum_content, 120, array( 'ending' => $forum_link ) );
}
