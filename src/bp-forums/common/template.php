...
function bbp_get_the_content( $args = array() ) {
	...
	if ( bbp_use_wp_editor() ) :
		...
		?>
			<div id="bbp_editor_<?php echo esc_attr( $r['context'] ); ?>_content_<?php echo $editor_unique_id; ?>" class="<?php echo esc_attr( $r['editor_class'] ); ?> bbp_editor_<?php echo esc_attr( $r['context'] ); ?>_content" tabindex="<?php echo esc_attr( $r['tabindex'] ); ?>" data-key="<?php echo $editor_unique_id; ?>">
