...
/**
 * Function to allow specific notification on notification screen.
 *
 ...
 * @return bool
 */
function bb_notification_allow_specific_notification_read( $retval, $notification ) {

	if ( 'forums' !== $notification->component_name &&
	     ! in_array( $notification->component_action, array(
	...
	if ( bp_is_active( 'groups' ) && ! empty( $forum_id ) ) {
...
add_filter( 'bb_notification_is_read_only', 'bb_notification_allow_specific_notification_read', 10, 2 );
