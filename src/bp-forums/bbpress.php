...
/**
 * The BuddyBoss Forums
 *
 * BuddyBoss Forums is forum software with a twist from the creators of WordPress.
 *
 * @package BuddyBoss
 * @subpackage Main
 */
...
/**
 * Plugin Name: BuddyBoss Forums
 * Plugin URI:  https://buddyboss.com
 * Description: BuddyBoss Forums is forum software with a twist from the creators of WordPress.
 * Author:      BuddyBoss
 ...
 *
 * We're not using 'is_plugin_active' functions becauses you need to include the
...
if ( $is_bp_active ) {
     ...
     * @return void
     */
    function bb_duplicate_buddypress_notice() {
        ...
        <div id="message" class="error notice">
            <p><strong><?php esc_html_e( 'BuddyBoss Forums is disabled.', 'buddyboss' ); ?></strong></p>
            <p><?php printf( esc_html__( 'BuddyBoss Forums can\'t work while BuddyPress plugin is active. Please %s BuddyPress to re-enable BuddyBoss Forums.', 'buddyboss' ), $link_plugins ); ?></p>
        </div>
     ...
     */
    add_action( 'admin_notices',            'bb_duplicate_buddypress_notice' );
	add_action( 'network_admin_notices',    'bb_duplicate_buddypress_notice' );
...
if ( $is_bb_active ) {
     ...
     * @return void
     */
    function bb_duplicate_bbpress_notice() {
        if ( !current_user_can( 'activate_plugins' ) ) {
            return;
        }
        ...
        <div id="message" class="error notice">
            <p><strong><?php esc_html_e( 'BuddyBoss Forums is disabled.', 'buddyboss' ); ?></strong></p>
            <p><?php printf( esc_html__( 'BuddyBoss Forums can\'t work while bbPress plugin is active. Please %s bbPress to re-enable BuddyBoss Forums.', 'buddyboss' ), $link_plugins ); ?></p>
        </div>
     ...
     */
    add_action( 'admin_notices',            'bb_duplicate_bbpress_notice' );
	add_action( 'network_admin_notices',    'bb_duplicate_bbpress_notice' );
...
if ( !$is_bp_active && !$is_bb_active ) {
        ...
        public static function register_post_types() {
            ...
            register_post_type(
                ...
                apply_filters( 'bbp_register_forum_post_type', array(
                    ...
                    'description'         => __( 'Forums Forums', 'buddyboss' ),
            ...
            register_post_type(
                ...
                apply_filters( 'bbp_register_topic_post_type', array(
                    ...
                    'description'         => __( 'Forums Discussions', 'buddyboss' ),
            ...
            register_post_type(
                ...
                apply_filters( 'bbp_register_reply_post_type', array(
                    ...
                    'description'         => __( 'Forums Replies', 'buddyboss' ),
    ...
    /**
     * The main function responsible for returning the one true Forums Instance
     ...
     *
     * @return The one true Forums Instance
     */
    function bbpress() {
    ...
    /**
     * Hook Forums early onto the 'plugins_loaded' action.
     *
     * This gives all other plugins the chance to load before Forums, to get their
     * actions, filters, and overrides setup without Forums being in the way.
     */
