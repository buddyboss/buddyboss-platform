...
<div id="whats-new-attachments">
	...
	<?php if ( bp_is_active( 'media' ) && bp_user_has_access_upload_media( $group_id, bp_loggedin_user_id(), $forum_id, 0 ) ) : ?>
...
<div id="whats-new-toolbar" class="<?php echo ( ! bp_is_active( 'media' ) ) ? esc_attr( 'media-off' ) : ''; ?> ">
	...
	if ( bp_is_active( 'media' ) && bp_is_forums_emoji_support_enabled() ) :
		?>
