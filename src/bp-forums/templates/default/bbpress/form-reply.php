				...
				<div>
					...
					<?php if ( bbp_allow_revisions() && bbp_is_reply_edit() ) : ?>
						...
						<fieldset class="bbp-form">
							...
							<div>
								<label for="bbp_reply_edit_reason"><?php printf( __( 'Optional reason for editing:', 'buddyboss-platform' ), bbp_get_current_user_name() ); ?></label><br />
...
<?php elseif ( bbp_is_topic_closed() ) : ?>
	...
	<div id="no-reply-<?php bbp_topic_id(); ?>" class="bbp-no-reply">
		<div class="bp-feedback info">
			<span class="bp-icon" aria-hidden="true"></span>
			<p><?php /* translators: %s: discussion title. */ printf( __( 'The discussion "%s" is closed to new replies.', 'buddyboss-platform' ), bbp_get_topic_title() ); ?></p>
		</div>
	</div>
...
<?php elseif ( bbp_is_forum_closed( bbp_get_topic_forum_id() ) ) : ?>
	...
	<div id="no-reply-<?php bbp_topic_id(); ?>" class="bbp-no-reply">
		<div class="bp-feedback info">
			<span class="bp-icon" aria-hidden="true"></span>
			<p><?php /* translators: %s: forum title. */ printf( __( 'The forum "%s" is closed to new discussions and replies.', 'buddyboss-platform' ), bbp_get_forum_title( bbp_get_topic_forum_id() ) ); ?></p>
		</div>
	</div>
