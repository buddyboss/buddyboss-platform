...
<div id="bbpress-forums">
				...
				<fieldset class="bbp-form">
					...
					<div>
						...
						<div class="bp-feedback info">
							...
							<p><?php _e( 'You can either make this reply a new discussion with a new title, or merge it into an existing discussion.', 'buddyboss-platform' ); ?></p>
						</div>

						<div class="bp-feedback info">
							<span class="bp-icon" aria-hidden="true"></span>
							<p><?php _e( 'If you choose an existing discussion, replies will be ordered by the time and date they were created.', 'buddyboss-platform' ); ?></p>
						</div>

						<fieldset class="bbp-form">
							<legend><?php _e( 'Move Method', 'buddyboss-platform' ); ?></legend>
							...
							if ( bbp_has_topics(
								...
								<div>
									<div class="bp-radio-wrap">
										...
										<label for="bbp_reply_move_option_existing"><?php _e( 'Use an existing discussion in this forum:', 'buddyboss-platform' ); ?></label>
									</div>
						...
						<div class="bbp-submit-wrapper">
							<button type="submit" tabindex="<?php bbp_tab_index(); ?>" id="bbp_move_reply_submit" name="bbp_move_reply_submit" class="button submit"><?php _e( 'Submit', 'buddyboss-platform' ); ?></button>
						</div>
					</div>
	...
	<?php else : ?>
		...
		<div id="no-reply-<?php bbp_reply_id(); ?>" class="bbp-no-reply">
			<div class="entry-content"><?php is_user_logged_in() ? _e( 'You do not have the permissions to edit this reply!', 'buddyboss-platform' ) : _e( 'You cannot edit this reply.', 'buddyboss-platform' ); ?></div>
		</div>
