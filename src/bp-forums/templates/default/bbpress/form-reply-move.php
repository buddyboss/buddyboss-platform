		...
		<div id="move-reply-<?php bbp_topic_id(); ?>" class="bbp-reply-move">
			...
			<form id="move_reply" name="move_reply" method="post" action="<?php the_permalink(); ?>">
				...
				<fieldset class="bbp-form">
					...
					<legend><?php /* translators: %s: reply title. */ printf( __( 'Move reply "%s"', 'buddyboss' ), bbp_get_reply_title() ); ?></legend>
						...
						<fieldset class="bbp-form">
							...
							<div>
								<div class="bp-radio-wrap">
									...
									<label for="bbp_reply_move_option_reply"><?php /* translators: %s: forum title. */ printf( __( 'New discussion in <strong>%s</strong> titled:', 'buddyboss' ), bbp_get_forum_title( bbp_get_reply_forum_id( bbp_get_reply_id() ) ) ); ?></label>
								</div>
								<input type="text" id="bbp_reply_move_destination_title" value="<?php /* translators: %s: reply title. */ printf( __( 'Moved: %s', 'buddyboss' ), bbp_get_reply_title() ); ?>" tabindex="<?php bbp_tab_index(); ?>" size="35" name="bbp_reply_move_destination_title" />
							</div>
