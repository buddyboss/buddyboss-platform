						...
						<fieldset class="bbp-form">
							...
							<div>
								<div class="bp-radio-wrap">
									...
									<label for="bbp_reply_move_option_reply"><?php /* translators: %s: forum title. */ printf( __( 'New discussion in <strong>%s</strong> titled:', 'buddyboss-platform' ), esc_html( bbp_get_forum_title( bbp_get_reply_forum_id( bbp_get_reply_id() ) ) ) ); ?></label>
								</div>
