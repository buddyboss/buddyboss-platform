...
<?php if ( bbp_current_user_can_access_anonymous_user_form() ) : ?>
	...
	<fieldset class="bbp-form">
		<legend><?php ( bbp_is_topic_edit() || bbp_is_reply_edit() ) ? _e( 'Author Information', 'buddyboss-platform' ) : _e( 'Your information:', 'buddyboss-platform' ); ?></legend>

		<?php do_action( 'bbp_theme_anonymous_form_extras_top' ); ?>

		<p>
			<label for="bbp_anonymous_author"><?php _e( 'Name (required):', 'buddyboss-platform' ); ?></label><br />
		...
		<p>
			<label for="bbp_anonymous_email"><?php _e( 'Email (will not be published) (required):', 'buddyboss-platform' ); ?></label><br />
		...
		<p>
			<label for="bbp_anonymous_website"><?php _e( 'Website:', 'buddyboss-platform' ); ?></label><br />
