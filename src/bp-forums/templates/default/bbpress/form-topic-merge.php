				...
				<fieldset class="bbp-form">
					...
					<div>
						...
						<div class="bp-feedback info">
							...
							<p><?php _e( 'Select the discussion to merge this one into. The destination topic will remain the lead discussion, and this one will change into a reply.', 'buddyboss-platform' ); ?><br/>
							<?php _e( 'To keep this discussion as the lead, go to the other discussion and use the merge tool from there instead.', 'buddyboss-platform' ); ?></p>
						</div>

						<div class="bp-feedback info">
							<span class="bp-icon" aria-hidden="true"></span>
							<p><?php _e( 'All replies within both discussions will be merged chronologically. The order of the merged replies is based on the time and date they were posted. If the destination discussion was created after this one, it\'s post date will be updated to second earlier than this one.', 'buddyboss-platform' ); ?></p>
						</div>

						<fieldset class="bbp-form">
							<legend><?php _e( 'Destination', 'buddyboss-platform' ); ?></legend>
							<div>
								<?php
								if ( bbp_has_topics(
									array(
									...
									<label for="bbp_destination_topic"><?php _e( 'Merge with this topic:', 'buddyboss-platform' ); ?></label>
								...
								<?php else : ?>
									...
									<label><?php _e( 'There are no other discussions in this forum to merge with.', 'buddyboss-platform' ); ?></label>
							...
							<div>
								<?php if ( bb_is_enabled_subscription( 'topic' ) ) : ?>
									<div class="bp-checkbox-wrap">
										...
										<label for="bbp_topic_subscribers"><?php _e( 'Merge discussion subscribers', 'buddyboss-platform' ); ?></label>
									</div>
								<?php endif; ?>
								...
								<div class="bp-checkbox-wrap">
									...
									<label for="bbp_topic_favoriters"><?php _e( 'Merge discussion favoriters', 'buddyboss-platform' ); ?></label>
								</div>
								...
								<?php if ( bbp_allow_topic_tags() ) : ?>
									<div class="bp-checkbox-wrap">
										...
										<label for="bbp_topic_tags"><?php _e( 'Merge discussion tags', 'buddyboss-platform' ); ?></label>
									</div>
								<?php endif; ?>
							</div>
						</fieldset>
