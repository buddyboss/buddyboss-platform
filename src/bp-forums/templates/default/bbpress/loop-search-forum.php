...
<div class="bbp-forum-header">
	...
	<div class="bbp-meta">
		...
		<span class="bbp-forum-post-date"><?php /* translators: %s: time since the forum was last active. */ printf( __( 'Last updated %s', 'buddyboss' ), bbp_get_forum_last_active_time() ); ?></span>
