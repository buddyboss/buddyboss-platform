			...
			$components['buddyboss'] = array(
				...
				'settings'  => array(
					'cache_bb_activity_feeds'     => array(
						...
						'label_checkbox' => __( 'Cache Activity Feeds', 'buddyboss-platform' ),
					...
					'cache_bb_members'            => array(
						...
						'label_checkbox' => __( 'Cache Member Profiles', 'buddyboss-platform' ),
						'purge_url'      => $purge_url . '&group=bbplatform&component=bp-members&nonce=' . $purge_nonce,
						'type'           => 'checkbox',
						'value'          => true,
					),
					'cache_bb_member_connections' => array(
						'label'          => __( 'Member Connections', 'buddyboss-platform' ),
						'label_checkbox' => __( 'Cache Member Connections', 'buddyboss-platform' ),
					...
					'cache_bb_social_groups'      => array(
						...
						'label_checkbox' => __( 'Cache Social Groups', 'buddyboss-platform' ),
					...
					'cache_bb_private_messaging'  => array(
						...
						'label_checkbox' => __( 'Cache Private Messaging', 'buddyboss-platform' ),
						'purge_url'      => $purge_url . '&group=bbplatform&component=bp-messages&nonce=' . $purge_nonce,
						'type'           => 'checkbox',
						'value'          => true,
					),
					'cache_bb_forum_discussions'  => array(
						'label'          => __( 'Forum Discussions', 'buddyboss-platform' ),
						'label_checkbox' => __( 'Cache Forum Discussions', 'buddyboss-platform' ),
					...
					'cache_bb_notifications'      => array(
						...
						'label_checkbox' => __( 'Cache Notifications', 'buddyboss-platform' ),
					...
					'cache_bb_media'              => array(
						...
						'label_checkbox' => __( 'Cache Photos/Albums', 'buddyboss-platform' ),
					...
					'cache_bb_document'           => array(
						...
						'label_checkbox' => __( 'Cache Document Files/Folders', 'buddyboss-platform' ),
					...
					'cache_bb_video'              => array(
						...
						'label_checkbox' => __( 'Cache Videos', 'buddyboss-platform' ),
					...
					'cache_bb_subscription'       => array(
						...
						'label_checkbox' => __( 'Cache Subscriptions', 'buddyboss-platform' ),
