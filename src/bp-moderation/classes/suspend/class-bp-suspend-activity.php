...
//			$bb_background_updater->save()->schedule_event();
			...
			$action_id = as_schedule_single_action( time(), 'bb_as_hide_related_content', array( $activity_id, $hide_sitewide, $args ), $group_name );
...
//			$bb_background_updater->save()->schedule_event();
			...
			$action_id = as_schedule_single_action( time(), 'bb_as_unhide_related_content', array( $activity_id, $hide_sitewide, $force_all, $args ), $group_name );
			bb_insert_as_meta( $action_id, $this->item_type, $group_name, $activity_id, $args['parent_id'] );
		}
	}
