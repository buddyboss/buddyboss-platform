	...
	public function update_button_sub_items( $item_id ) {
		...
		switch ( $activity->type ) {
			...
			case 'bbp_topic_create':
				$updated = true;
				if ( bp_is_active( 'forum' ) && bp_is_moderation_content_reporting_enable( 0, BP_Moderation_Forum_Topics::$moderation_type ) ) {
			...
			case 'bbp_reply_create':
				$updated = true;
				if ( bp_is_active( 'forum' ) && bp_is_moderation_content_reporting_enable( 0, BP_Moderation_Forum_Replies::$moderation_type ) ) {
					$sub_items['id']   = ( 'groups' === $activity->component ) ? $activity->secondary_item_id : $activity->item_id;
