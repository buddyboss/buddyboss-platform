								...
								<div class="report-header">
									...
									if ( ! bp_moderation_is_user_suspended( $user_id ) ) {
										?>
											...
											class="button report-header_button bp-hide-request single-report-btn <?php echo ( 'unhide' === $action_type ) ? 'green' : ''; ?>"
									...
									if ( ! is_array( $user_id ) && ! in_array( $user_id, $admins, true ) ) {
										...
										?>
											<a href="javascript:void(0);"
												class="button report-header_button bp-block-user single-report-btn content-author <?php echo ( 'unsuspend' === $user_action_type ) ? 'green' : ''; ?>"
								...
								<div class="report-header">
									...
									<div class="report-header_action">
										...
										if ( ! is_array( $user_id ) && ! in_array( $user_id, $admins, true ) ) {
											...
											?>
											<a href="javascript:void(0);"
												class="button report-header_button <?php echo ( 'unsuspend' === $user_action_type ) ? 'green' : ''; ?> bp-block-user single-report-btn123 content-author123"
												data-id="<?php echo esc_attr( $user_id ); ?>" data-type="user"
												data-nonce="<?php echo esc_attr( wp_create_nonce( 'bp-hide-unhide-moderation' ) ); ?>"
												data-action="<?php echo esc_attr( $user_action_type ); ?>"
												title="<?php echo esc_attr( $user_action_text ); ?>">
