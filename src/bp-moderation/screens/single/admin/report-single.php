								...
								<table class="form-table">
									...
									<?php if ( $is_content_screen ) { ?>
										...
										<tr>
											...
											<td>
												<?php
												$user_id = bp_moderation_get_content_owner_id( $moderation_request_data->item_id,
										...
										<tr>
											...
											<td>
												...
												echo wp_kses_post( sprintf( '<a href="%s" title="%s"> %s </a>',
														esc_url( bp_moderation_get_Permalink( $moderation_request_data->item_id,
																$moderation_request_data->item_type ) ),
										...
										<tr>
											...
											<td>
												...
												printf( _n( '%s time',
														'%s times',
														$moderation_request_data->count,
														'buddyboss' ),
														esc_html( number_format_i18n( $moderation_request_data->count ) ) );
												?>
											</td>
										</tr>
									<?php } else { ?>
								...
								<div class="bp-moderation-actions">
									...
									if ( $is_content_screen ) {
										...
										if ( ! empty( $user_data ) ) {
											...
											$user_action_text = ( 'unhide' === $user_action_type ) ? esc_html__( 'Unsuspend Content Author',
													'buddyboss' ) : esc_html__( 'Suspend Content Author', 'buddyboss' );
										}
										?>
										...
										$member_action_text = ( 'unhide' === $action_type ) ? esc_html__( 'Unsuspend Member',
												'buddyboss' ) : esc_html__( 'Suspend Member', 'buddyboss' );
										?>
