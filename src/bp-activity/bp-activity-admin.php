...
function bp_activity_admin_edit() {
	...
	<div class="wrap">
		<h1><?php printf( __( 'Editing %1$s (ID #%2$s)', 'buddyboss' ), bb_get_component_label( 'activity' ), bp_core_number_format( (int) $_REQUEST['aid'] ) ); ?></h1>
		...
		<div id="minor-publishing">
			<div id="minor-publishing-actions">
				<div id="preview-action">
					<a class="button preview" href="<?php echo esc_attr( bp_activity_get_permalink( $item->id, $item ) ); ?>" target="_blank"><?php
					printf(
						// translators: placeholder: Activity.
						__( 'View %s', 'buddyboss' ),
						bb_get_component_label( 'activity' )
					);
					?></a>
...
function bp_activity_admin_edit_metabox_link( $item ) {
	...
	<p id="bp-activities-link-description"><?php printf( __( '%s generated by posts and comments uses the link field for a permalink back to the content item.', 'buddyboss' ), bb_get_component_label( 'activity' ) ); ?></p>
	...
	<div class="wrap">
		<h1>
			<?php if ( ! empty( $_REQUEST['aid'] ) ) : ?>
				<?php printf( __( '%s related to ID #%s', 'buddyboss' ), bb_get_component_label( 'activity' ), bp_core_number_format( (int) $_REQUEST['aid'] ) ); ?>
			<?php else : ?>
				<?php printf( __( '%s', 'buddyboss' ), bb_get_component_label( 'activity' ) ); ?>
			<?php endif; ?>
		...
		<form id="bp-activities-form" action="" method="get">
			<?php $bp_activity_list_table->search_box( sprintf( __( 'Search all %s', 'buddyboss' ), bb_get_component_label( 'activity' ) ), 'bp-activity' ); ?>
			...
			<tr id="bp-activities-container" style="display: none;">
				<td colspan="4">
					<form method="get" action="">
						...
						<h3 id="bp-replyhead"><?php printf( __( 'Reply to %s', 'buddyboss' ), bb_get_component_label( 'activity' ) ); ?></h3>
