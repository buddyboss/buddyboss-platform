...
add_action( 'bp_activity_add_user_favorite', 'bp_activity_reset_cache_incrementor' );
add_action( 'bp_activity_remove_user_favorite', 'bp_activity_reset_cache_incrementor' );
