 ...
 * @return string
 */
function bp_activity_new_at_mention_permalink( $link, $item_id, $secondary_item_id, $total_items ) {
...
add_filter( 'bp_activity_new_at_mention_permalink', 'bp_activity_new_at_mention_permalink', 11, 4 );
