<?php
/**
 * BuddyPress XProfile Checkbox Field Classes.
 *
...
class BP_XProfile_Field_Type_Checkbox extends BP_XProfile_Field_Type {
	...
	public function __construct() {
		...
		$this->name     = __( 'Checkboxes', 'buddyboss' );
	...
	public function edit_field_options_html( array $args = array() ) {
		...
		if ( isset( $_POST[ 'field_' . $this->field_obj->id ] ) && maybe_serialize( $_POST[ 'field_' . $this->field_obj->id ] ) !== $option_values ) {
