...
class BP_XProfile_Data_Template {
	...
	public function __construct( $args = '' ) {
		...
		if ( ! is_array( $args ) || count( $function_args ) > 1 ) {
			...
			_deprecated_argument( __METHOD__, '2.3.0', sprintf( __( 'Arguments passed to %1$s should be in an associative array. See the inline documentation at %2$s for more details.', 'buddyboss-platform' ), __METHOD__, __FILE__ ) );
