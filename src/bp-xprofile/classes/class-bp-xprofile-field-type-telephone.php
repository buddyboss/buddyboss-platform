...
class BP_XProfile_Field_Type_Telephone extends BP_XProfile_Field_Type {
	...
	public function edit_field_html( array $raw_properties = array() ) {
		...
		$r = bp_parse_args(
			...
			array(
				'type'        => 'tel',
				'value'       => wp_strip_all_tags( html_entity_decode( bp_get_the_profile_field_edit_value(), ENT_QUOTES ) ),
	...
	public static function display_filter( $field_value, $field_id = '' ) {
		$url   = wp_strip_all_tags( html_entity_decode( $field_value, ENT_QUOTES ) );
		$parts = parse_url( $url );
