...
function bp_print_add_repeater_set_button() {
	...
	if ( $is_repeater_enabled ) {
		echo "<button id='btn_add_repeater_set' class='button outline' data-nonce='" . wp_create_nonce( 'bp_xprofile_add_repeater_set' ) . "' data-group='{$group_id}' disabled='disabled'>";
