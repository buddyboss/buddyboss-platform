...
function bp_get_xprofile_field_ajax() {
	...
	$bp                        = buddypress();
	$member_type_id            = filter_input( INPUT_POST, 'type', FILTER_VALIDATE_INT );
	$existing_fields           = filter_input( INPUT_POST, 'fields', FILTER_SANITIZE_STRING );
	$existing_fields_exclude   = filter_input( INPUT_POST, 'fields', FILTER_SANITIZE_STRING );
	$existing_fields_fixed_ids = filter_input( INPUT_POST, 'fixedIds', FILTER_SANITIZE_STRING );
	$member_type_key           = bp_get_member_type_key( $member_type_id );
	$existing_fields_arr       = explode( ',', $existing_fields );
	$tinymce_added             = filter_input( INPUT_POST, 'tinymce', FILTER_VALIDATE_INT );
