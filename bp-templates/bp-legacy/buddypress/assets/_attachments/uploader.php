		...
		<div id="{{data.container}}">
			<div id="{{data.drop_element}}">
				<div class="drag-drop-inside">
					...
					<p><?php _ex( 'or', 'Uploader: Drop your file here - or - Select your File', 'buddyboss' ); ?></p>
					<p class="drag-drop-buttons"><label for="{{data.browse_button}}" class="<?php echo is_admin() ? 'screen-reader-text' : 'bp-screen-reader-text' ;?>"><?php
						...
						esc_html_e( 'Select your File', 'buddyboss' );
					?></label><input id="{{data.browse_button}}" type="button" value="<?php esc_attr_e( 'Select your File', 'buddyboss' ); ?>" class="button" /></p>
				</div>
			</div>
		</div>
	<?php endif; ?>
