...
<h2 class="bp-screen-reader-text"><?php _e( 'Manage Members', 'buddyboss' ); ?></h2>
...
<div aria-live="polite" aria-relevant="all" aria-atomic="true">
	...
	<div class="bp-widget group-members-list group-admins-list">
		...
		<div id="message" class="info">
			<p><?php _e( 'No group administrators were found.', 'buddyboss' ); ?></p>
		</div>
	...
	<div class="bp-widget group-members-list group-mods-list">
		<h3 class="section-header"><?php _e( 'Moderators', 'buddyboss' ); ?></h3>
		...
		<?php else: ?>
			...
			<div id="message" class="info">
				<p><?php _e( 'No group moderators were found.', 'buddyboss' ); ?></p>
			</div>
	...
	<div class="bp-widget group-members-list">
		<h3 class="section-header"><?php _e( "Members", 'buddyboss' ); ?></h3>
					...
					<li class="<?php bp_group_member_css_class(); ?>">
						...
						<div class="action">
							<?php if ( bp_get_group_member_is_banned() ) : ?>
								...
								<a href="<?php bp_group_member_unban_link(); ?>" class="button confirm member-unban"><?php _e( 'Remove Ban', 'buddyboss' ); ?></a>
							...
							<a href="<?php bp_group_member_remove_link(); ?>" class="button confirm"><?php _e( 'Remove from group', 'buddyboss' ); ?></a>
		...
		<?php else: ?>
			...
			<div id="message" class="info">
				<p><?php _e( 'No group members were found.', 'buddyboss' ); ?></p>
			</div>
