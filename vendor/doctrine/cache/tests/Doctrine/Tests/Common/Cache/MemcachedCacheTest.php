...
use BuddyBossPlatform\Doctrine\Common\Cache\InvalidCacheId;
use BuddyBossPlatform\Doctrine\Common\Cache\MemcachedCache;
use Generator;
use Memcached;
use ReflectionClass;
...
class MemcachedCacheTest extends CacheTest
{
    ...
    public function testContainsWithKeyOnNonReachableCache()
    {
        ...
        $memcached->addServer('0.0.0.1', 11211);
        // fake server is not available
