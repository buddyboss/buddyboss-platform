...
use BuddyBossPlatform\Doctrine\Common\Cache\RedisCache;
use Redis;
...
class RedisCacheTest extends CacheTest
{
    ...
    public function testSerializerOptionWithOutIgbinaryExtension() : void
    {
        ...
        self::assertEquals(Redis::SERIALIZER_PHP, $this->getCacheDriver()->getRedis()->getOption(Redis::OPT_SERIALIZER));
    }
