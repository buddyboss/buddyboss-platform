...
use BuddyBossPlatform\Doctrine\Common\Cache\LegacyMongoDBCache;
use BuddyBossPlatform\Doctrine\Common\Cache\MongoDBCache;
use MongoClient;
use MongoCollection;
use MongoConnectionException;
use MongoCursorException;
use BuddyBossPlatform\PHPUnit_Framework_MockObject_MockObject;
use function assert;
use function sleep;
/**
...
class LegacyMongoDBCacheTest extends CacheTest
{
    ...
    {
        $collection = $this->getMockBuilder(MongoCollection::class)->disableOriginalConstructor()->getMock();
