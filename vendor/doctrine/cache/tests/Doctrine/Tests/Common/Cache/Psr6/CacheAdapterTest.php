...
namespace BuddyBossPlatform\Doctrine\Tests\Common\Cache\Psr6;

use BuddyBossPlatform\Cache\IntegrationTests\CachePoolTest;
use BuddyBossPlatform\Doctrine\Common\Cache\ArrayCache;
use BuddyBossPlatform\Doctrine\Common\Cache\Cache;
use BuddyBossPlatform\Doctrine\Common\Cache\Psr6\CacheAdapter;
use BuddyBossPlatform\Doctrine\Common\Cache\Psr6\DoctrineProvider;
use BuddyBossPlatform\Psr\Cache\CacheItemInterface;
use BuddyBossPlatform\Psr\Cache\CacheItemPoolInterface;
use BuddyBossPlatform\Symfony\Component\Cache\Adapter\ArrayAdapter;
use BuddyBossPlatform\Symfony\Component\Cache\DoctrineProvider as SymfonyDoctrineProvider;
...
final class CacheAdapterTest extends CachePoolTest
{
    ...
    public function testItemsAreFlushedToTheUnderlyingCacheOnce() : void
    {
        ...
        $wrapped->expects(self::once())->method('save')->willReturn(\true);
        $adapter->commit();
        $adapter->commit();
    }
