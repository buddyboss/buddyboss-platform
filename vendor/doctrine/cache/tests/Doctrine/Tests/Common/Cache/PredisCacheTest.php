...
use BuddyBossPlatform\Doctrine\Common\Cache\PredisCache;
use BuddyBossPlatform\Predis\Client;
use BuddyBossPlatform\Predis\ClientInterface;
use BuddyBossPlatform\Predis\Connection\ConnectionException;
use function assert;
