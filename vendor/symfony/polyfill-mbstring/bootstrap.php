 ...
 */
use BuddyBossPlatform\Symfony\Polyfill\Mbstring as p;
...
if (!\function_exists('BuddyBossPlatform\\mb_ltrim')) {
...
if (!\function_exists('BuddyBossPlatform\\mb_rtrim')) {
