...
class PathTest extends TestCase
{
    ...
    public static function provideGetDirectoryTests() : \Generator
    {
        ...
        (yield ['', '']);
        (yield ['\\webmozart\\symfony\\style.css', '/webmozart/symfony']);
        (yield ['BuddyBossPlatform\\webmozart\\symfony', '/webmozart']);
        (yield ['\\webmozart', '/']);
        (yield ['\\', '/']);
        ...
        (yield ['C:', 'C:/']);
        (yield ['C:\\webmozart\\symfony\\style.css', 'C:/webmozart/symfony']);
        (yield ['BuddyBossPlatform\\C:\\webmozart\\symfony', 'C:/webmozart']);
        (yield ['C:\\webmozart', 'C:/']);
        (yield ['C:\\', 'C:/']);
    ...
    public static function provideGetExtensionTests() : \Generator
    {
        ...
        (yield ['', \false, '']);
        (yield ['/webmozart/symfony/style.CSS', \false, 'CSS']);
        (yield ['/webmozart/symfony/style.CSS', \true, 'css']);
        (yield ['/webmozart/symfony/style.ÄÖÜ', \false, 'ÄÖÜ']);
        (yield ['/webmozart/symfony/style.ÄÖÜ', \true, 'äöü']);
    }
    /**
    ...
    {
        (yield [\true, '/webmozart/symfony/style.css.twig', null, \false]);
        (yield [\true, '/webmozart/symfony/style.css', null, \false]);
        (yield [\false, '/webmozart/symfony/style.css.', null, \false]);
        (yield [\false, '/webmozart/symfony/', null, \false]);
        (yield [\false, '/webmozart/symfony', null, \false]);
        (yield [\false, '/', null, \false]);
        (yield [\false, '', null, \false]);
        (yield [\true, '/webmozart/symfony/style.css.twig', 'twig', \false]);
        (yield [\false, '/webmozart/symfony/style.css.twig', 'css', \false]);
        (yield [\true, '/webmozart/symfony/style.css', 'css', \false]);
        (yield [\true, '/webmozart/symfony/style.css', '.css', \false]);
        (yield [\true, '/webmozart/symfony/style.css.', '', \false]);
        (yield [\false, '/webmozart/symfony/', 'ext', \false]);
        (yield [\false, '/webmozart/symfony', 'ext', \false]);
        (yield [\false, '/', 'ext', \false]);
        (yield [\false, '', 'ext', \false]);
        (yield [\false, '/webmozart/symfony/style.css', 'CSS', \false]);
        (yield [\true, '/webmozart/symfony/style.css', 'CSS', \true]);
        (yield [\false, '/webmozart/symfony/style.CSS', 'css', \false]);
        (yield [\true, '/webmozart/symfony/style.CSS', 'css', \true]);
        (yield [\true, '/webmozart/symfony/style.ÄÖÜ', 'ÄÖÜ', \false]);
        (yield [\true, '/webmozart/symfony/style.css', ['ext', 'css'], \false]);
        (yield [\true, '/webmozart/symfony/style.css', ['.ext', '.css'], \false]);
        (yield [\true, '/webmozart/symfony/style.css.', ['ext', ''], \false]);
        (yield [\false, '/webmozart/symfony/style.css', ['foo', 'bar', ''], \false]);
        (yield [\false, '/webmozart/symfony/style.css', ['.foo', '.bar', ''], \false]);
        // This can only be tested, when mbstring is installed
        (yield [\true, '/webmozart/symfony/style.ÄÖÜ', 'äöü', \true]);
        (yield [\true, '/webmozart/symfony/style.ÄÖÜ', ['äöü'], \true]);
    }
    /**
    ...
    public static function provideIsAbsolutePathTests() : \Generator
    {
        ...
        (yield ['\\', \true]);
        (yield ['css\\style.css', \false]);
        (yield ['C:/css/style.css', \true]);
        (yield ['D:/', \true]);
        (yield ['C:///windows', \true]);
        (yield ['C://test', \true]);
        (yield ['E:\\css\\style.css', \true]);
        (yield ['F:\\', \true]);
        (yield ['phar:///css/style.css', \true]);
        (yield ['phar:///', \true]);
        // Windows special case
        (yield ['C:', \true]);
    ...
    public static function provideMakeAbsoluteTests() : \Generator
    {
        ...
        (yield ['css/.././style.css', '/webmozart/symfony', '/webmozart/symfony/style.css']);
        (yield ['./css/style.css', '/webmozart/symfony', '/webmozart/symfony/css/style.css']);
        (yield ['css\\.\\style.css', 'BuddyBossPlatform\\webmozart\\symfony', '/webmozart/symfony/css/style.css']);
        (yield ['css\\..\\style.css', 'BuddyBossPlatform\\webmozart\\symfony', '/webmozart/symfony/style.css']);
        (yield ['css\\.\\..\\style.css', 'BuddyBossPlatform\\webmozart\\symfony', '/webmozart/symfony/style.css']);
        (yield ['css\\..\\.\\style.css', 'BuddyBossPlatform\\webmozart\\symfony', '/webmozart/symfony/style.css']);
        (yield ['.\\css\\style.css', 'BuddyBossPlatform\\webmozart\\symfony', '/webmozart/symfony/css/style.css']);
    ...
    public static function provideAbsolutePathsWithDifferentRoots() : \Generator
    {
        ...
        (yield ['C:/css/style.css', 'BuddyBossPlatform\\webmozart\\symfony']);
        (yield ['C:\\css\\style.css', '/webmozart/symfony']);
        (yield ['C:\\css\\style.css', 'BuddyBossPlatform\\webmozart\\symfony']);
        (yield ['/css/style.css', 'C:/webmozart/symfony']);
        (yield ['/css/style.css', 'BuddyBossPlatform\\C:\\webmozart\\symfony']);
        (yield ['\\css\\style.css', 'C:/webmozart/symfony']);
        (yield ['\\css\\style.css', 'BuddyBossPlatform\\C:\\webmozart\\symfony']);
        (yield ['D:/css/style.css', 'C:/webmozart/symfony']);
        (yield ['D:/css/style.css', 'BuddyBossPlatform\\C:\\webmozart\\symfony']);
        (yield ['D:\\css\\style.css', 'C:/webmozart/symfony']);
        (yield ['D:\\css\\style.css', 'BuddyBossPlatform\\C:\\webmozart\\symfony']);
        ...
        (yield ['phar://C:/css/style.css', 'BuddyBossPlatform\\C:\\webmozart\\symfony']);
        (yield ['phar://C:\\css\\style.css', 'C:/webmozart/symfony']);
        (yield ['phar://C:\\css\\style.css', 'BuddyBossPlatform\\C:\\webmozart\\symfony']);
    }
    /**
    ...
    public static function provideMakeRelativeTests() : \Generator
    {
        ...
        (yield ['/webmozart/symfony', '/css', '../webmozart/symfony']);
        (yield ['\\webmozart\\symfony\\css\\style.css', 'BuddyBossPlatform\\webmozart\\symfony', 'css/style.css']);
        (yield ['\\webmozart\\css\\style.css', 'BuddyBossPlatform\\webmozart\\symfony', '../css/style.css']);
        (yield ['\\css\\style.css', 'BuddyBossPlatform\\webmozart\\symfony', '../../css/style.css']);
        ...
        (yield ['C:\\webmozart\\symfony\\css\\style.css', 'BuddyBossPlatform\\C:\\webmozart\\symfony', 'css/style.css']);
        (yield ['C:\\webmozart\\css\\style.css', 'BuddyBossPlatform\\C:\\webmozart\\symfony', '../css/style.css']);
        (yield ['C:\\css\\style.css', 'BuddyBossPlatform\\C:\\webmozart\\symfony', '../../css/style.css']);
    ...
    public static function provideGetLongestCommonBasePathTests() : \Generator
    {
        ...
        (yield [['BuddyBossPlatform\\C:\\base\\path', 'BuddyBossPlatform\\C:\\base\\path'], 'C:/base/path']);
        (yield [['C:/base/path', 'BuddyBossPlatform\\C:\\base\\path'], 'C:/base/path']);
        ...
        (yield [['/base/path', '/base/path/'], '/base/path']);
        (yield [['C:/base/path', 'C:/base/path/'], 'C:/base/path']);
        (yield [['BuddyBossPlatform\\C:\\base\\path', 'C:\\base\\path\\'], 'C:/base/path']);
        (yield [['C:/base/path', 'C:\\base\\path\\'], 'C:/base/path']);
        (yield [['phar:///base/path', 'phar:///base/path/'], 'phar:///base/path']);
        (yield [['phar://C:/base/path', 'phar://C:/base/path/'], 'phar://C:/base/path']);
        // first in second
        ...
        (yield [['BuddyBossPlatform\\C:\\base\\path\\sub', 'BuddyBossPlatform\\C:\\base\\path'], 'C:/base/path']);
        (yield [['C:/base/path/sub', 'BuddyBossPlatform\\C:\\base\\path'], 'C:/base/path']);
        ...
        (yield [['BuddyBossPlatform\\C:\\base\\path', 'BuddyBossPlatform\\C:\\base\\path\\sub'], 'C:/base/path']);
        (yield [['C:/base/path', 'BuddyBossPlatform\\C:\\base\\path\\sub'], 'C:/base/path']);
        ...
        (yield [['BuddyBossPlatform\\C:\\base\\path\\di', 'BuddyBossPlatform\\C:\\base\\path\\dir'], 'C:/base/path']);
        (yield [['C:/base/path/di', 'BuddyBossPlatform\\C:\\base\\path\\dir'], 'C:/base/path']);
        ...
        (yield [['BuddyBossPlatform\\C:\\base\\path\\dir', 'BuddyBossPlatform\\C:\\base\\path\\di'], 'C:/base/path']);
        (yield [['C:/base/path/dir', 'BuddyBossPlatform\\C:\\base\\path\\di'], 'C:/base/path']);
        ...
        (yield [['/base/path', 'BuddyBossPlatform\\C:\\base\\path'], null]);
        (yield [['phar:///base/path', 'phar://C:/base/path'], null]);
        // different partitions
        (yield [['C:/base/path', 'D:/base/path'], null]);
        (yield [['C:/base/path', 'BuddyBossPlatform\\D:\\base\\path'], null]);
        (yield [['BuddyBossPlatform\\C:\\base\\path', 'BuddyBossPlatform\\D:\\base\\path'], null]);
        ...
        (yield [['BuddyBossPlatform\\C:\\base\\path\\foo', 'BuddyBossPlatform\\C:\\base\\path', 'BuddyBossPlatform\\C:\\base\\path\\bar'], 'C:/base/path']);
        (yield [['C:/base/path//foo', 'C:/base/path', 'BuddyBossPlatform\\C:\\base\\path\\bar'], 'C:/base/path']);
        ...
        (yield [['BuddyBossPlatform\\C:\\base\\path\\foo', 'C:\\', 'BuddyBossPlatform\\C:\\base\\path\\bar'], 'C:/']);
        (yield [['C:/base/path//foo', 'C:/', 'BuddyBossPlatform\\C:\\base\\path\\bar'], 'C:/']);
        ...
        (yield [['/base/path/foo', 'BuddyBossPlatform\\C:\\base\\path', '/base/path/bar'], null]);
        (yield [['C:/base/path/foo', 'D:/base/path', 'C:/base/path/bar'], null]);
        (yield [['BuddyBossPlatform\\C:\\base\\path\\foo', 'BuddyBossPlatform\\D:\\base\\path', 'BuddyBossPlatform\\C:\\base\\path\\bar'], null]);
        (yield [['C:/base/path//foo', 'D:/base/path', 'BuddyBossPlatform\\C:\\base\\path\\bar'], null]);
        ...
        (yield [['BuddyBossPlatform\\C:\\base\\path'], 'C:/base/path']);
    ...
    {
        // same paths
        (yield ['/base/path', '/base/path', \true]);
        (yield ['C:/base/path', 'C:/base/path', \true]);
        (yield ['BuddyBossPlatform\\C:\\base\\path', 'BuddyBossPlatform\\C:\\base\\path', \true]);
        (yield ['C:/base/path', 'BuddyBossPlatform\\C:\\base\\path', \true]);
        (yield ['phar:///base/path', 'phar:///base/path', \true]);
        (yield ['phar://C:/base/path', 'phar://C:/base/path', \true]);
        // trailing slash
        (yield ['/base/path/', '/base/path', \true]);
        (yield ['C:/base/path/', 'C:/base/path', \true]);
        (yield ['C:\\base\\path\\', 'BuddyBossPlatform\\C:\\base\\path', \true]);
        ...
        (yield ['/base/path', '/base/path/', \true]);
        (yield ['C:/base/path', 'C:/base/path/', \true]);
        (yield ['BuddyBossPlatform\\C:\\base\\path', 'C:\\base\\path\\', \true]);
        (yield ['C:/base/path', 'C:\\base\\path\\', \true]);
        (yield ['phar:///base/path', 'phar:///base/path/', \true]);
        (yield ['phar://C:/base/path', 'phar://C:/base/path/', \true]);
        // first in second
        ...
        (yield ['BuddyBossPlatform\\C:\\base\\path\\sub', 'BuddyBossPlatform\\C:\\base\\path', \false]);
        (yield ['C:/base/path/sub', 'BuddyBossPlatform\\C:\\base\\path', \false]);
        (yield ['phar:///base/path/sub', 'phar:///base/path', \false]);
        (yield ['phar://C:/base/path/sub', 'phar://C:/base/path', \false]);
        // second in first
        (yield ['/base/path', '/base/path/sub', \true]);
        (yield ['C:/base/path', 'C:/base/path/sub', \true]);
        (yield ['BuddyBossPlatform\\C:\\base\\path', 'BuddyBossPlatform\\C:\\base\\path\\sub', \true]);
        (yield ['C:/base/path', 'BuddyBossPlatform\\C:\\base\\path\\sub', \true]);
        (yield ['phar:///base/path', 'phar:///base/path/sub', \true]);
        (yield ['phar://C:/base/path', 'phar://C:/base/path/sub', \true]);
        // first is prefix
        (yield ['/base/path/di', '/base/path/dir', \false]);
        (yield ['C:/base/path/di', 'C:/base/path/dir', \false]);
        (yield ['BuddyBossPlatform\\C:\\base\\path\\di', 'BuddyBossPlatform\\C:\\base\\path\\dir', \false]);
        (yield ['C:/base/path/di', 'BuddyBossPlatform\\C:\\base\\path\\dir', \false]);
        ...
        (yield ['BuddyBossPlatform\\C:\\base\\path\\dir', 'BuddyBossPlatform\\C:\\base\\path\\di', \false]);
        (yield ['C:/base/path/dir', 'BuddyBossPlatform\\C:\\base\\path\\di', \false]);
        (yield ['phar:///base/path/dir', 'phar:///base/path/di', \false]);
        (yield ['phar://C:/base/path/dir', 'phar://C:/base/path/di', \false]);
        // root
        (yield ['/', '/second', \true]);
        (yield ['C:/', 'C:/second', \true]);
        (yield ['C:', 'C:/second', \true]);
        (yield ['C:\\', 'C:\\second', \true]);
        (yield ['C:/', 'C:\\second', \true]);
        (yield ['phar:///', 'phar:///second', \true]);
        (yield ['phar://C:/', 'phar://C:/second', \true]);
        // windows vs unix
        (yield ['/base/path', 'C:/base/path', \false]);
        (yield ['C:/base/path', '/base/path', \false]);
        (yield ['/base/path', 'BuddyBossPlatform\\C:\\base\\path', \false]);
        (yield ['/base/path', 'phar:///base/path', \false]);
        (yield ['phar:///base/path', 'phar://C:/base/path', \false]);
        // different partitions
        (yield ['C:/base/path', 'D:/base/path', \false]);
        (yield ['C:/base/path', 'BuddyBossPlatform\\D:\\base\\path', \false]);
        (yield ['BuddyBossPlatform\\C:\\base\\path', 'BuddyBossPlatform\\D:\\base\\path', \false]);
    ...
    public static function provideJoinTests() : \Generator
    {
        ...
        (yield [['BuddyBossPlatform\\C:\\path\\to\\test', 'subdir'], 'C:/path/to/test/subdir']);
        ...
        (yield [['phar://', 'BuddyBossPlatform\\C:\\path\\to\\test'], 'phar://C:/path/to/test']);
