 ...
 */
namespace BuddyBossPlatform\Symfony\Component\Filesystem\Tests;
...
use BuddyBossPlatform\Symfony\Component\Filesystem\Path;
...
class FilesystemTest extends FilesystemTestCase
{
    ...
    public function testChownRecursiveById()
    {
        ...
        \touch($file);
        $ownerId = $this->getFileOwnerId($dir);
        $this->filesystem->chown($dir, $ownerId, \true);
    ...
    public function testReadBrokenLink()
    {
        ...
        \touch($file);
        $this->assertEquals($file, Path::normalize($this->filesystem->readlink($link, \true)));
    }
    ...
    {
        return [['/var/lib', \true], ['BuddyBossPlatform\\c:\\var\\lib', \true], ['BuddyBossPlatform\\var\\lib', \true], ['var/lib', \false], ['../var/lib', \false], ['', \false]];
    }
    ...
    {
        \stream_wrapper_register('mock', 'BuddyBossPlatform\\Symfony\\Component\\Filesystem\\Tests\\Fixtures\\MockStream\\MockStream');
        $scheme = 'mock://';
        $dirname = $scheme . $this->workspace;
        $filename = $this->filesystem->tempnam($dirname, 'foo');
        $this->assertStringStartsWith($scheme, $filename);
