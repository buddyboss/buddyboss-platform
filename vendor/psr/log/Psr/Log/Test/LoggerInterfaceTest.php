...
namespace BuddyBossPlatform\Psr\Log\Test;

use BuddyBossPlatform\Psr\Log\LoggerInterface;
use BuddyBossPlatform\Psr\Log\LogLevel;
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('BuddyBossPlatform\\Psr\\Log\\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (\method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('BuddyBossPlatform\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('BuddyBossPlatform\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        }
