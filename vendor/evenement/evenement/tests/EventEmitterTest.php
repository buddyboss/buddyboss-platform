 ...
 */
namespace BuddyBossPlatform\Evenement\Tests;
...
class EventEmitterTest extends TestCase
{
    ...
    {
        $this->emitter->on('bar', ['BuddyBossPlatform\\Evenement\\Tests\\Listener', 'onBar']);
    ...
    {
        $this->emitter->on('foo', 'BuddyBossPlatform\\Evenement\\Tests\\setGlobalTestData');
        $this->emitter->emit('foo', ['bar']);
