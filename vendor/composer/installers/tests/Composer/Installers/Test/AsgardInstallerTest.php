...
class AsgardInstallerTest extends TestCase
{
    ...
    public function packageNameInflectionProvider()
    {
        return array(
            ...
            array('asgard-module', 'user-profile', 'UserProfile'),
            array('asgard-module', 'asgard-module', 'Asgard'),
            array('asgard-module', 'blog', 'Blog'),
            // tests that exactly one '-module' is cut off
            array('asgard-module', 'some-module-module', 'SomeModule'),
            // tests that exactly one '-theme' is cut off
            array('asgard-theme', 'some-theme-theme', 'SomeTheme'),
            // tests that names without '-theme' suffix stay valid
            array('asgard-theme', 'someothertheme', 'Someothertheme'),
            // Should keep theme name StudlyCase
            array('asgard-theme', 'adminlte-advanced', 'AdminlteAdvanced'),
        );
    }
}
