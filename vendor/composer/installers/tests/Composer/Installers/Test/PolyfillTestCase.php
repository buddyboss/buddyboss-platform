...
use BuddyBossPlatform\PHPUnit\Framework\Constraint\LogicalNot;
use BuddyBossPlatform\PHPUnit\Framework\Constraint\StringContains;
if (\method_exists('BuddyBossPlatform\\PHPUnit\\Framework\\TestCase', 'assertStringContainsString')) {
...
foreach (array('BuddyBossPlatform\\PHPUnit\\Framework\\Constraint\\IsEqual', 'BuddyBossPlatform\\PHPUnit\\Framework\\Constraint\\StringContains', 'BuddyBossPlatform\\PHPUnit\\Framework\\Constraint\\TraversableContains') as $class) {
    if (!\class_exists($class) && \class_exists(\str_replace('\\', '_', $class))) {
        \class_alias(\str_replace('\\', '_', $class), $class);
    }
}
foreach (array('BuddyBossPlatform\\PHPUnit\\Framework\\SelfDescribing') as $interface) {
    if (!\interface_exists($interface) && \interface_exists(\str_replace('\\', '_', $interface))) {
        \class_alias(\str_replace('\\', '_', $interface), $interface);
    }
}
if (!\class_exists('BuddyBossPlatform\\PHPUnit\\Framework\\Constraint\\Constraint')) {
    \class_alias('BuddyBossPlatform\\PHPUnit_Framework_Constraint', 'BuddyBossPlatform\\PHPUnit\\Framework\\Constraint\\Constraint');
}
 ...
 * file that was distributed with this source code.
 */
namespace BuddyBossPlatform\PHPUnit\Framework\Constraint;

use BuddyBossPlatform\PHPUnit\Framework\ExpectationFailedException;
if (!\class_exists('BuddyBossPlatform\\PHPUnit\\Framework\\Constraint\\RegularExpression')) {
    /**
...
if (!\class_exists('BuddyBossPlatform\\PHPUnit\\Framework\\Constraint\\LogicalNot')) {
    /**
     * Logical NOT.
     */
    class LogicalNot extends Constraint
    {
        ...
        {
            $positives = array('contains ', 'exists', 'has ', 'is ', 'are ', 'matches ', 'starts with ', 'ends with ', 'reference ', 'not not ');
            $negatives = array('does not contain ', 'does not exist', 'does not have ', 'is not ', 'are not ', 'does not match ', 'starts not with ', 'ends not with ', 'don\'t reference ', 'not ');
