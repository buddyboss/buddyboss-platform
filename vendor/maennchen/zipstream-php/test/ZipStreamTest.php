...
namespace BuddyBossPlatform\ZipStreamTest;

use BuddyBossPlatform\GuzzleHttp\Psr7\Response;
use BuddyBossPlatform\org\bovigo\vfs\vfsStream;
use BuddyBossPlatform\PHPUnit\Framework\TestCase;
use RecursiveDirectoryIterator;
use RecursiveIteratorIterator;
use ReflectionClass;
use ZipArchive;
use BuddyBossPlatform\ZipStream\File;
use BuddyBossPlatform\ZipStream\Option\Archive as ArchiveOptions;
use BuddyBossPlatform\ZipStream\Option\File as FileOptions;
use BuddyBossPlatform\ZipStream\Option\Method;
use BuddyBossPlatform\ZipStream\Stream;
...
class ZipStreamTest extends TestCase
{
    ...
    {
        $this->expectException(\BuddyBossPlatform\ZipStream\Exception\FileNotFoundException::class);
    ...
    public function testFileNotReadableException() : void
    {
        ...
        $zip = new ZipStream();
        $this->expectException(\BuddyBossPlatform\ZipStream\Exception\FileNotReadableException::class);
    ...
    public function testAddFileFromPsr7StreamWithFileSizeSet() : void
    {
        ...
        // Add fake padding
        $fakePadding = "\x00\x00\x00\x00\x00\x00";
    ...
    {
        $tmp = \tempnam(\sys_get_temp_dir(), 'zipstreamtest');
        $stream = \fopen($tmp, 'wb+');
        return [$tmp, $stream];
    }
    /**
